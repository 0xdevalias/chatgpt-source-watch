    ...
    24395: function (e, t, n) {
      ...
      t.attachListeners = function (e, t, n, r, c, a) {
        ...
        return (
          ...
          (p = f(e, n, b, r, c)),
          function () {
            b(u.ReadyState.CLOSING), v(), p(), e.close(), d && clearInterval(d);
          }
        );
      };
    },
    ...
    45324: function (e, t, n) {
      ...
      t.createOrJoinSocket = function (e, t, n, s, i, l, f, d) {
        ...
        if (s.current.share) {
          ...
          return (
            (0, a.addSubscriber)(t, S),
            (v = p),
            function () {
              if (((0, a.removeSubscriber)(t, S), !(0, a.hasSubscribers)(t))) {
                try {
...
//# sourceMappingURL=3584.f611a13ece41f7a2.js.map
