(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [7007],
  {
          ...
          typeof (n = function () {
            ...
            function f(e, r) {
              ...
              "string" == typeof e
                ...
                (f.rebuild = function () {
                  if ((i !== f && (c = h(i.getLevel())), u.call(f), i === f))
                    for (var e in o) o[e].rebuild();
                }),
                (c = h(i ? i.getLevel() : "WARN"));
              var v = p();
              null != v && (l = h(v)), u.call(f);
            }
    ...
    98431: function (e, t, r) {
      ...
      function et() {
        ...
        (function e(t, r, n) {
          ...
          (t = X(r))
            ? (function (e, t) {
                if (null != e) {
                  if (f(e[L])) return H(e).pipe(K(t), G(t));
                  if (F(e))
                    return new R(function (r) {
                      var n = 0;
      ...
      function eo(e) {
        return e instanceof u.Ix;
      }
      Object.prototype.hasOwnProperty, Object.prototype.propertyIsEnumerable;
      var ei = [
        u.TQ.ConnectionStateChanged,
        u.TQ.RoomMetadataChanged,
        u.TQ.ActiveSpeakersChanged,
        u.TQ.ConnectionQualityChanged,
        u.TQ.ParticipantConnected,
        u.TQ.ParticipantDisconnected,
        u.TQ.ParticipantPermissionsChanged,
        u.TQ.ParticipantMetadataChanged,
        u.TQ.TrackMuted,
        u.TQ.TrackUnmuted,
        u.TQ.TrackPublished,
        u.TQ.TrackUnpublished,
        u.TQ.TrackStreamStateChanged,
        u.TQ.TrackSubscriptionFailed,
        u.TQ.TrackSubscriptionPermissionChanged,
        u.TQ.TrackSubscriptionStatusChanged,
        u.TQ.LocalTrackPublished,
        u.TQ.LocalTrackUnpublished,
      ];
      u.dd.TrackPublished,
        u.dd.TrackUnpublished,
        u.dd.TrackMuted,
        u.dd.TrackUnmuted,
        u.dd.TrackStreamStateChanged,
        u.dd.TrackSubscribed,
        u.dd.TrackUnsubscribed,
        u.dd.TrackSubscriptionPermissionChanged,
        u.dd.TrackSubscriptionFailed,
        u.dd.LocalTrackPublished,
        u.dd.LocalTrackUnpublished,
        u.dd.ConnectionQualityChanged,
        u.dd.IsSpeakingChanged,
        u.dd.ParticipantMetadataChanged,
        u.dd.ParticipantPermissionsChanged,
        u.dd.TrackMuted,
        u.dd.TrackUnmuted,
        u.dd.TrackPublished,
        u.dd.TrackUnpublished,
        ...
        u.dd.TrackSubscriptionFailed,
        u.dd.TrackSubscriptionPermissionChanged,
        u.dd.TrackSubscriptionStatusChanged,
        u.dd.LocalTrackPublished,
        u.dd.LocalTrackUnpublished;
      ...
      function eu(e) {
        return Array.isArray(e) && e.filter(ea).length > 0;
      }
      function el(e) {
      ...
      function ex(e) {
        ...
        return (function (e, t) {
          ...
          c.useMemo(() => {
            var e;
            return ((e = u.TQ.ConnectionStateChanged),
            new R((r) => {
              let n = (...e) => {
                r.next(e);
              };
      ...
      function e_(e) {
        ...
        let i = (function (e) {
          ...
          a = c.useRef(null),
          {
            ...
            let [n, o] = c.useState(el(e)),
              [i, a] = c.useState(null == n ? void 0 : n.isMuted),
                ...
                () =>
                  (function (e) {
                        ...
                        .pipe(
                          D((e) => {
                            let {
                              ...
                              o = e.getTrackPublication(u.fQ.Source.Microphone);
                            return {
                              isCameraEnabled: r,
                              isMicrophoneEnabled: t,
                              isScreenShareEnabled: n,
                    ...
                    return {
                      className:
                        ((t =
                          e.source === u.fQ.Source.Camera ||
                          e.source === u.fQ.Source.ScreenShare
        ...
        return (
          ...
          c.createElement("audio", em({ ref: a }, l))
        );
      }
      function eO(e) {
        let { room: t, htmlProps: r } = (function (e) {
          ...
          return (
            c.useEffect(() => {
              ...
              return (
                w
                  .on(u.TQ.SignalConnected, e)
                  .on(u.TQ.MediaDevicesError, t)
                  .on(u.TQ.EncryptionError, r),
                () => {
                  w.off(u.TQ.SignalConnected, e)
                    .off(u.TQ.MediaDevicesError, t)
                    .off(u.TQ.EncryptionError, r);
                }
              );
            }, [w, s, f, d, v, y, b]),
            c.useEffect(() => {
              if (w) {
                ...
                l
                  ? (ec.debug("connecting"),
                    w.connect(n, r, a).catch((e) => {
                      ec.warn(e), null == v || v(e);
                    }))
                  : (ec.debug("disconnecting because connect is false"),
                    w.disconnect());
              }
            }, [l, r, JSON.stringify(a), w, v, n, m]),
            c.useEffect(() => {
              if (!w) return;
              let e = (e) => {
                switch (e) {
                  case u.em.Disconnected:
                    h && h();
                    break;
                  case u.em.Connected:
                    p && p();
              ...
              return (
                w.on(u.TQ.ConnectionStateChanged, e),
                () => {
                  w.off(u.TQ.ConnectionStateChanged, e);
                }
              );
            }, [r, p, h, w]),
            c.useEffect(() => {
      ...
      function eA({ volume: e, muted: t }) {
        let r = (function (
          e = [
            u.fQ.Source.Camera,
            u.fQ.Source.Microphone,
            u.fQ.Source.ScreenShare,
            u.fQ.Source.ScreenShareAudio,
            u.fQ.Source.Unknown,
          ],
          t = {}
        ) {
          ...
          return (
            c.useEffect(() => {
              let e = (function (e, t, r) {
                ...
                ec.debug("setting track bundles", e, t), o(e), a(t);
              });
          ...
          (e) => !eo(e.participant) && e.publication.kind === u.fQ.Kind.Audio
        );
        return (
          c.useEffect(() => {
...
//# sourceMappingURL=7007.60d5c28f95c4e2d3.js.map
