      ...
      let v = ["PageUp", "PageDown"],
        ...
        x = (0, o.forwardRef)((e, t) => {
          let {
            ...
            H = (0, o.useRef)(V);
          function z(e, t, { commit: n } = { commit: !1 }) {
            let r = (String(c).split(".")[1] || "").length,
              o = (function (e, t) {
                let n = Math.pow(10, t);
                return Math.round(e * n) / n;
              })(Math.round((e - d) / c) * c + d, r),
              l = (0, i.u)(o, [d, s]);
            Z((e = []) => {
              var r, o;
                  ...
                  (0, r.Z)(
                    ...
                    D,
                    {
                      ...
                      onSlideEnd: m
                        ? void 0
                        : function () {
                            let e = H.current[K.current];
                            V[K.current] !== e && b(V);
                          },
                      onHomeKeyDown: () => !m && z(d, 0, { commit: !0 }),
                      onEndKeyDown: () =>
                        !m && z(s, V.length - 1, { commit: !0 }),
              ...
              onKeyDown: (0, l.M)(e.onKeyDown, (e) => {
                "Home" === e.key
                  ...
                  : "End" === e.key
                    ...
                    : v.concat(w).includes(e.key) && (c(e), e.preventDefault());
              }),
          ...
          return (0, o.createElement)(
            ...
            (0, r.Z)(
              ...
              i,
              {
                ...
                style: {
                  ...e.style,
                  [d.startEdge]: (c > 1 ? Math.min(...f) : 0) + "%",
                  [d.endEdge]: 100 - Math.max(...f) + "%",
                },
              }
            )
          );
        ...
        H = (0, o.forwardRef)((e, t) => {
          ...
          return (0, o.createElement)(z, (0, r.Z)({}, e, { ref: d, index: u }));
        }),
        z = (0, o.forwardRef)((e, t) => {
          var n;
          let { __scopeSlider: i, index: d, ...u } = e,
            s = _(Z, i),
            c = P(Z, i),
                  ...
                  (0, r.Z)(
                    ...
                    u,
                    {
                      ...
                      onFocus: (0, l.M)(e.onFocus, () => {
                        s.valueIndexToChangeRef.current = d;
                      }),
                    }
                  )
                )
...
//# sourceMappingURL=6277.89a907fb501282da.js.map
