(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [8682],
  {
    92784: function (e, t, n) {
      ...
      function g(e) {
        let { messages: t } = e,
          ...
          r = (0, s.uniqBy)(
            n.map((e) => (0, a.gP)(!0, e)).filter(h),
            (e) => e.url
          );
        return (0, d.jsx)("div", {
          className: "mt-4 grid w-full grid-cols-[50%,50%] gap-3",
          children: r.map((e) => (0, d.jsx)(m, { citationMetadata: e }, e.url)),
        });
      }
      var f = n(49305),
        A = n(70079),
      ...
      let b = new Map();
      function y() {
        let { 0: e, 1: t } = (0, A.useState)(b),
          { isSuccess: n, data: r } = (0, v.a)({
      ...
      function j(e) {
        let { queryKey: t } = e,
          [n] = t;
        return x.Z.checkConnectorAPI().then((e) => e.connectors.filter(w));
      }
      function w(e) {
        return e.type === f.PO.GDRIVE || e.type === f.PO.O365;
      }
      function O(e) {
                  ...
                  switch (r.type) {
                    ...
                    case f.PO.O365:
                      if (r.access_token) {
                                ...
                                handler: {
                                  ...
                                  tryFetch: (function (e, t) {
                                    return async () => {
                                      var n;
                                      let r =
                                          "https://graph.microsoft.com/v1.0/me/drive/items/".concat(
                        ...
                        })(e, r.access_token).filter((e) => void 0 !== e);
                        n.push(...t);
                      }
                    case f.PO.GDRIVE_SYNC_CONNECTOR:
                  }
                return n;
              })(t, r)
            );
      ...
      let k =
        ...
        N = /\bhttps:\/\/onedrive\.live\.com\/[^\s]*/gm;
      var S = n(29287),
        E = n(58819),
        P = n(14551),
        C = n(8718),
        ...
        T = n(84692),
        L = n(68498);
      let U = "AIzaSyBjWFkxENpfA2b0Leq9VtNLumQs4u2VbkA";
      async function z(e) {
        await (null == B &&
          (B = new Promise((e, t) => {
        ...
        return (
          ...
          new Promise((n) => {
            ...
            let a = new google.picker.DocsView(google.picker.ViewId.DOCS)
              .setIncludeFolders(!0)
              .setSelectFolderEnabled(t == f.PO.GDRIVE_SYNC_CONNECTOR)
              .setMode(google.picker.DocsViewMode.LIST);
            t == f.PO.GDRIVE_SYNC_CONNECTOR &&
          ...
          children: [
            ...
            (0, d.jsxs)(E.Z.Root, {
              children: [
                ...
                (0, d.jsx)(E.Z.Portal, {
                  children: (0, d.jsxs)(E.Z.Content, {
                    children: [
                      [f.PO.GDRIVE, f.PO.O365].map((e) => {
                        let t = a.get(e);
                        return t
                          ? (0, d.jsx)(
                              Q,
        ...
        return (0, d.jsx)(
          E.Z.Item,
          {
            ...
            children: (0, d.jsxs)("div", {
              className: "flex space-x-2",
              children: [
                t.type === f.PO.GDRIVE && (0, d.jsx)(D.dv9, {}),
                t.type === f.PO.O365 && (0, d.jsx)(D.oV6, {}),
                (0, d.jsx)("div", {
                  children: t.access_token
                    ? s.formatMessage(W.uploadFromMessage, {
                        connector_name: t.name,
                      })
                    : s.formatMessage(W.signinWithMessage, {
                        connector_name: t.name,
                      }),
                }),
              ],
      ...
      function Y(e) {
        let {
          ...
          s = (0, A.useCallback)(
            async (e) => {
              e.preventDefault(), (0, X.yA)(f.PO.GDRIVE);
              let s = await V(f.PO.GDRIVE, t);
              null != s &&
                s.forEach((e) => {
                  null != e &&
                    _.Dw.uploadFile(
      ...
      function ei(e) {
        let { getInputProps: t, openFileDialog: n, gizmoId: r } = e,
          { gdrive_sync: a, o365: s } = (0, ee.X)();
        return (0, d.jsx)("div", {
          children: (0, d.jsxs)(er.fC, {
            children: [
              (0, d.jsx)(er.xz, {
                asChild: !0,
                  ...
                  (0, d.jsxs)(er.ck, {
                    children: [
                      ...
                      a.loaded &&
                        ...
                        (0, d.jsxs)(et.cY, {
                          onClick: async () => {
                            await V(f.PO.GDRIVE_SYNC_CONNECTOR, a.access_token);
                          },
                          children: [
                            (0, d.jsx)("input", es({}, t())),
                            (0, d.jsx)(T.Z, {
    ...
    70173: function (e, t, n) {
            ...
            (0, R.jsx)(c.Z.Portal, {
              children: (0, R.jsxs)(c.Z.Content, {
                ...
                children: [
                  ...
                  (0, R.jsx)(c.Z.Item, {
                    onClick: () => {
                      P.A.logEvent(C.M.clickLogOut, { eventSource: "mouse" }),
                        (0, E.w7)();
                    },
                    icon: g.N_,
                    children: (0, R.jsx)(M.Z, {
      ...
      function I(e) {
        let {
          ...
          i = (0, w.Xy)(s).tags.includes(r.S.GPT_4) ? d.X72 : d.stH;
        return t
          ? (0, R.jsx)(R.Fragment, { children: n })
          : (0, R.jsxs)(S.fC, {
              modal: !1,
              onOpenChange: (e) => {
                P.A.logEvent(C.M.toggleModelSwitcher, { isOpen: e }),
                  _.m9.logEvent("toggle_model_switcher", null, {
                    isOpen: String(e),
                  });
              },
              children: [
                ...
                (0, R.jsx)(S.Uv, {
                  children: (0, R.jsx)(S.VY, {
                    ...
                    sideOffset: 4,
                    children: (0, R.jsx)(o.DS, { clientThreadId: s }),
                  }),
                }),
              ],
            });
      ...
      function x(e) {
        ...
        return (0, g.jsxs)(l.hj, {
          children: [
            ...
            (0, g.jsx)(c.cY, { onClick: () => x(!0), children: "Add Contact" }),
          ],
        });
      }
      function v(e) {
    ...
    94556: function (e, t, n) {
            ...
            (0, O.jsxs)("div", {
              ...
              children: [
                ...
                (0, O.jsx)(u.Z, {
                  ...
                  onChange: (e) => {
                    A.setUserPrompt(e.target.value);
                  },
                  value: r.userPrompt,
                }),
              ],
            ...
            (0, O.jsxs)("div", {
              ...
              children: [
                ...
                (0, O.jsx)(d.Z, {
                  ...
                  rows: 8,
                  onChange: (e) => {
                    A.setSystemPrompt(e.target.value);
                  },
      ...
      let L = new S.xj(M, S.EU.tokenizer, T({}, S.EU.tokens)),
        U = new S.nZ(T({}, S.Dm.nodes), T({}, S.Dm.marks));
      function z(e, t) {
        var n = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
          var r = Object.getOwnPropertySymbols(e);
        ...
        return (0, m.jsxs)(i.Z.Root, {
          children: [
            (0, m.jsxs)(y, {
              $as: i.Z.Trigger,
              className: "pr-1.5",
              children: [n ? n.name : "Themes", (0, m.jsx)(x.bTu, {})],
            }),
            (0, m.jsx)(i.Z.Portal, {
    ...
    25617: function (e, t, n) {
        ...
        return (0, A.jsxs)("div", {
          ...
          children: [
            ...
            (0, A.jsxs)(r.z, {
              ...
              onClick: () => y(t, n),
              children: [
                (0, A.jsx)(d._hL, { className: "icon-sm" }),
                " Download ",
                t,
              ],
            }),
            (0, A.jsxs)(r.z, {
              ...
              openNewTab: !0,
              children: [
                (0, A.jsx)(d.nY6, { className: "icon-sm" }),
                " Give feedback",
              ],
            }),
          ],
      ...
      function w() {
        ...
        if (!r || a) return (0, A.jsx)("div", { children: "Loading..." });
        let { thread: s } = r;
        return (0, A.jsxs)("div", {
          className: "flex flex-col gap-2 break-words py-6 font-mono text-xs",
          children: [
            (0, A.jsx)(j, { downloadFilename: "thread.json", downloadData: s }),
            (0, A.jsx)("div", {
              className: "px-6 pb-6",
              children: (0, A.jsx)(O, { data: s, collapsed: 3 }),
            }),
            t.map((e, t) => {
              var n;
              return (0, A.jsxs)(
        ...
        return (0, A.jsxs)("div", {
          ...
          children: [
            (0, A.jsx)("button", {
              ...
              children: r
                ? (0, A.jsxs)(A.Fragment, {
                    children: [(0, A.jsx)(m.rIY, { size: 14 }), " Expand all"],
                  })
                : (0, A.jsxs)(A.Fragment, {
                    children: [
                      (0, A.jsx)(m.NsE, { size: 14 }),
                      " Collapse all",
                    ],
                  }),
            }),
    ...
    20735: function (e, t, n) {
      ...
      function S(e) {
        var t, n, r, a, s, i, g, x, y, j, k, S;
        let { onClose: P, settings: C, onUpdateSetting: _ } = e,
          { theme: D, setTheme: M } = (0, f.F)(),
          { 0: R, 1: T } = (0, A.useState)(C.rewrittenSnippetsPrompt);
        return (0, b.jsx)(p.Z, {
          isOpen: !0,
          onClose: () => {
            R !== C.rewrittenSnippetsPrompt &&
              _(w(w({}, C), {}, { rewrittenSnippetsPrompt: R })),
              P();
          },
          type: "success",
          rootClassName: "z-40",
            ...
            children: [
              ...
              (0, b.jsxs)(E, {
                children: [
                  ...
                  (0, b.jsx)(u.Z, {
                    onChange: (e) => _(w(w({}, C), {}, { suggestions: e })),
                ...
                children: [
                  ...
                  (0, b.jsx)(u.Z, {
                    ...
                    enabled:
                      null !==
                        (g =
                          null === (x = C.agentSettingsOverrides) ||
                          void 0 === x
                            ? void 0
                            : x.show_image_to_model) && void 0 !== g
                        ? g
                ...
                children: [
                  ...
                  (0, b.jsxs)(d.Z.Root, {
                    value:
                      null !==
                        (y =
                          null === (j = C.agentSettingsOverrides) ||
                          void 0 === j
                            ? void 0
              ...
              (0, b.jsxs)(E, {
                children: [
                  ...
                  (0, b.jsx)(o.Z, {
                    ...
                    className: "w-64",
                    value:
                      null !== (k = C.agentSettingsOverrides.eval_preset) &&
                      void 0 !== k
                        ? k
              ...
              (0, b.jsxs)(E, {
                children: [
                  ...
                  (0, b.jsx)(u.Z, {
                    onChange: (e) =>
                      _(w(w({}, C), {}, { useRewrittenSnippets: e })),
                    enabled:
                      null !== (S = C.useRewrittenSnippets) && void 0 !== S
                        ? S
              ...
              (0, b.jsx)(l.z, {
                onClick: () => {
                  T(O.rewrittenSnippetsPrompt), _(O);
                },
                type: "reset",
                color: "neutral",
                children: "Reset",
    ...
    721: function (e, t, n) {
      ...
      function Y(e) {
        let {
          ...
          x = (0, g.useRef)(n ? { query: n } : null),
          b = (0, g.useRef)(n ? "url_query" : "search_input"),
          y = (0, U.W6)(U.bM.isSettingsModalOpen),
          j = (0, U.W6)(U.bM.isDebugModalOpen),
          [w, k] = (0, q.r)(),
          { 0: N, 1: S } = (0, g.useState)(null),
          { 0: E, 1: C } = (0, g.useState)(),
          { 0: _, 1: D } = (0, g.useState)(null != n),
          M = (0, z.nn)(z.LW.threadId),
          Z = (0, z.nn)(z.LW.lastTurn),
          K = (0, h.useRouter)(),
          { 0: Y, 1: ee } = (0, g.useState)(null),
          et = (0, o.gb)({ namespace: o.dG.SonicHome, opts: { debug: !0 } });
        (0, g.useEffect)(() => {
          ...
          (0, g.useEffect)(() => {
            (async function () {
              t && ee((await (0, c.FB)(t.id)).slice(0, 6));
            })();
          }, [t]);
        let { readyState: en, postQuery: er } = (function (e) {
            let { threadId: t, socketUrl: n, onTurnSubmitted: r } = e,
              { 0: s, 1: i } = (0, g.useState)(!1),
              { 0: o, 1: c } = (0, g.useState)(!0),
                ...
                postQuery: (0, g.useCallback)(
                  async (e) => {
                    ...
                    let { threadId: n } = e,
                      ...
                      s = !!n;
                    return (
                      n || (n = null != a ? a : await (0, F.gK)()),
                      (0, F.dN)({
                        threadId: null !== (t = n) && void 0 !== t ? t : "",
                        query: e.query,
                        agentSettingsOverrides: e.agentSettingsOverrides,
                        metadata: e.metadata,
                      })
                        .then(() => (null == r ? void 0 : r({ isFollowup: s })))
                        .catch((e) =>
            ...
            onTurnSubmitted: (0, g.useCallback)(
              (e) => {
                let { isFollowup: t } = e;
                t ||
                  et.logTiming("search_query_submitted", {
                    context: { source: eo() },
                  });
              },
              [et]
          ...
          })({ profiler: et, querySource: eo() }),
          { data: es } = (0, s.a)({
            queryKey: ["userLocation", w.useLocation],
            queryFn: (e) => {
              let {
                queryKey: [t, n],
              } = e;
          ...
          ei = (0, g.useMemo)(() => J(J({}, m), es), [m, es]),
          el = (0, g.useCallback)(
            async (e, t, n) => {
              try {
                let r = null === t ? "query" : "followup",
                  a = eo();
                "query" === r && (et.reset(), ea(), S(e), C(e));
                let s = await er({
                  threadId: t,
                  initialThreadId: n,
                  query: e,
            ...
            [Z, er, et, w.agentSettingsOverrides, ea, Y, ei]
          );
        function eo() {
          return b.current;
        }
        let ec = (e, t) => {
            ...
            el(null != e ? e : "", n ? M : null, r), D(!0);
          },
          eu = (e) => {
            z.P3.clearThread(), (b.current = "search_input");
            let t = new URLSearchParams(window.location.search);
            e ? t.set("q", e) : t.delete("q");
            let n = "/search";
            t.size > 0 && (n += "?".concat(t.toString())),
              K.replace(n, void 0, { shallow: !0 }),
              e ? (el(e, null, null), D(!0)) : D(!1);
          };
        return (
          (0, g.useEffect)(() => {
            var e;
            en === f.kQ.OPEN &&
              (null != n &&
                (null === (e = x.current) || void 0 === e
                  ? void 0
                  : e.query) !== n &&
                (z.P3.clearThread(), (x.current = { query: n })),
              null == x.current ||
                x.current.submitted ||
                ((async function () {
                  null == x.current ||
                    x.current.submitted ||
                    ((x.current.submitted = !0),
                    await el(x.current.query, null, r));
                })(),
                D(!0)));
          }, [en, t.id, n, r, el, _]),
          (0, P.jsxs)(P.Fragment, {
            children: [
              (0, P.jsxs)(p(), {
                children: [
                  (0, P.jsx)("title", {
                    children:
                      _ && E ? "".concat(E, " - SearchGPT") : "SearchGPT",
                  }),
                  (0, P.jsx)("link", {
                    rel: "icon",
                    type: "image/x-icon",
              ...
              (0, P.jsx)(v.c.Provider, {
                ...
                children: (0, P.jsx)(R, {
                  ...
                  onSubmitFollowup: (e) => ec(e, { isFollowup: !0 }),
                  onReset: eu,
                  onSubmitSearch: (e) => {
                    eu(e);
                  },
    ...
    69721: function (e, t, n) {
      ...
      let V = (e) => {
        ...
        q = (e) =>
          (0, M.a)({
            queryKey: ["eval", e],
            queryFn: async () =>
              _.c.get("".concat(I.rq, "/evals/evals/").concat(e)),
          }),
        H = new Map(),
        Q = (e, t) => {
          var n;
        ...
        X = (e) => {
          ...
          return (0, R.D)({
            mutationKey: ["eval", e],
            mutationFn: async () =>
              _.c.delete("".concat(I.rq, "/evals/evals/").concat(e)),
            onSettled: () => {
              t.setQueryData(["evals"], (t) =>
          ...
          return U.Ue({
            fetcher: async (e) => {
              ...
              try {
                ...
                A.m.danger("Failed to read eval run stream"),
      ...
      function $() {
        return (0, M.a)({
          queryKey: ["tags"],
          queryFn: async () =>
            (0, v.sortBy)(await _.c.get("".concat(I.rq, "/evals/tags"))),
        });
      }
      async function ee(e) {
        try {
          ...
          A.m.danger("Failed to download CSV: ".concat(e));
        }
      }
      function et(e) {
        return (0, M.a)({
      ...
      function ei(e) {
        ...
        let g = (e, t) => {
          ...
          A = "pending" !== s && void 0 !== s ? s.thoughts : void 0,
          { 0: x, 1: b } = (0, l.useState)(!1),
          j = (0, l.useRef)(null);
        return (0, k.jsx)(f.E, {
          label: A,
          disabled: !A || i,
      ...
      function el(e) {
        ...
        let { open: n, criterion: r, onUpdateCriterion: a } = e,
          s = (0, M.a)({
            ...
            queryFn: async () =>
              await _.c.get("".concat(I.rq, "/evals/grader_response_fields")),
          });
      ...
      function ev(e) {
        ...
        return (0, k.jsx)(c, {
          ...
          styles: {
            ...
            multiValue: (e, t) =>
              eA(eA({}, e), {}, { backgroundColor: eh(t.data.value) }),
          },
          components: { Input: ex },
          isClearable: !1,
        ...
        return (0, l.createElement)(
          ...
          eA(
            ...
            {},
            {
              ...
              style: eA({ backgroundColor: eh(t) }, n.style),
            }
          ),
          t
        );
      ...
      function ek(e) {
        ...
        let { 0: V, 1: H } = (0, l.useState)(!1),
          ...
          G = (0, l.useCallback)(() => {
            V &&
              (null == F
                ? (B.mutate(), A.m.info("Test case deleted"))
                : (z.mutate(F), A.m.info("Test case updated")),
              H(!1));
          }, [F, z, V, B]),
          K = (0, l.useCallback)(
            (e) => {
        ...
        return (0, k.jsxs)("div", {
          ...
          children: [
            ...
            (0, k.jsx)("div", {
              className: "flex flex-col gap-2 pt-1 leading-none",
              children: (0, k.jsx)(C, { result: $, className: "icon-sm" }),
            }),
          ],
        });
      }
          ...
          x =
            ...
            (0, T.h)({
              queries: i.map((e) => ({
                queryKey: ["eval", e],
                queryFn: async () =>
                  await _.c.get("".concat(I.rq, "/evals/evals/").concat(e)),
              })),
              combine: (e) => (0, v.compact)(e.map((e) => e.data)),
            })),
          b = new Map();
        for (let e of A) b.set(e.eval_id, e);
        (0, l.useEffect)(() => {
          var e;
              ...
              children: [
                ...
                (0, k.jsxs)("div", {
                  className: (0, a.default)(
                    ...
                    y === x.length ? "text-green-500" : "text-red-500"
                  ),
                  children: [
      ...
      function eE(e) {
        let { selectedBatchId: t, setSelectedBatchId: n, className: r } = e,
          { data: s } = (0, M.a)({
            ...
            queryFn: async () =>
              (await _.c.get("".concat(I.rq, "/evals/batched_runs"))).items,
          });
        return (0, k.jsxs)("div", {
            ...
            t.turn_template &&
              (0, k.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, k.jsx)(eC.default, { json: t.turn_template }),
                ],
              }),
            null != t.batch_id &&
              (0, k.jsxs)(d.z, {
        ...
        return (0, k.jsxs)("div", {
          ...
          children: [
            (0, k.jsxs)("div", {
              className: "flex items-center gap-1",
              children: [
                (0, k.jsx)(C, { result: t.passed ? "passed" : "failed" }),
                t.criterion.prompt,
                (0, k.jsx)("button", {
                  onClick: () => r((e) => !e),
                ...
                children: [
                  ...
                  (0, k.jsxs)("div", {
                    children: [
                      ...
                      (0, k.jsx)(eC.default, { json: t.grading_object }),
                    ],
                  }),
                ],
              }),
            ...
            null == w || null === (t = w.data) || void 0 === t
              ...
              : t.filter((e) =>
                  e.steps.some(
                    (e) =>
                      !A ||
                      e.user_action.query_fragment.toLowerCase().includes(A)
                  )
                ),
          { 0: N, 1: S } = (0, l.useState)([]),
          { 0: E, 1: P } = (0, l.useState)(!1),
          { 0: C, 1: _ } = (0, l.useState)(!1),
          D = J(
            (null != N ? N : []).map((e) => e.id),
            i
          );
                        ...
                        return (0, k.jsx)(
                          ek,
                          {
                            ...
                            setSelected: (t) => {
                              t
                                ? S([...N, e])
                                : S(N.filter((t) => t.id !== e.id));
                            },
                            isSelected: N.some((t) => t.id === e.id),
    ...
    31863: function (e, t, n) {
      ...
      function _(e) {
        ...
        let g = "thumbsUp" === o ? l.go : l.W2,
          A = (0, j.W6)(j.bM.isDebugModalOpen);
        return (0, N.jsxs)("div", {
    ...
    81273: function (e, t, n) {
            ...
            (0, ef.jsx)(ea.Z.Portal, {
              children: (0, ef.jsxs)(ea.Z.Content, {
                ...
                children: [
                  (0, ef.jsx)(eb, {}),
                  (0, ef.jsx)(ev, {
                    onClick: () => ex.vm.toggleDebugModalOpen(),
                    icon: (0, ef.jsx)(ei.WP, { className: "icon-sm" }),
                    children: "Debug",
                  }),
                  (0, ef.jsx)(ev, {
                    onClick: () => ex.vm.toggleSettingsModalOpen(),
      ...
      function eD(e) {
        let { image: t, className: n } = e,
          { isDownloaded: r } = eC(t.thumbnail_url);
      ...
      function eM() {
        var e;
        let t = (0, ex.W6)(ex.bM.getFocusedImageCitation),
          n = () => {
            ex.vm.setFocusedImage(void 0);
          },
          r = (0, ek.d)(
            null !== (e = null == t ? void 0 : t.url) && void 0 !== e ? e : ""
          ),
          { imageDimensions: a, isErrored: s } = eC(
              ...
              children: (0, ef.jsx)(eS.E.div, {
                ...
                children: (0, ef.jsx)(eO.ZP.Overlay, {
                  ...
                  children: (0, ef.jsx)(eS.E.div, {
                    ...
                    children: (0, ef.jsxs)(eN.VY, {
                      className:
                        "relative flex flex-col overflow-hidden bg-token-main-surface-primary shadow-[0_0_200px_0_rgb(0_0_0_/_0.5)] sm:max-h-[95vh] sm:w-1/3 sm:min-w-[600px]",
                      children: [
                        (0, ef.jsx)("div", {
                          ...
                          children: (0, ef.jsx)("button", {
                            onClick: n,
                            className:
                              "text-token-main-surface-primary outline-none hover:opacity-70",
                            children: (0, ef.jsx)(es.niP, {
                              className:
                                "h-9 w-9 drop-shadow-[0_0_4px_rgba(0_0_0_/_0.5)]",
                            }),
                          }),
                        }),
                        null != a
                        ...
                        (0, ef.jsxs)("div", {
                          className:
                            "grid h-28 grid-cols-[auto,1fr,auto] grid-rows-[auto,1fr] gap-x-4 p-snc-2",
                          children: [
                            (0, ef.jsx)("div", {
                            ...
                            (0, ef.jsx)("a", {
                              href: t.url,
                              className:
                                "truncate pr-2 text-token-text-tertiary hover:opacity-70",
                              target: "_blank",
                              rel: "noreferrer",
                              children: r.data,
                            }),
                            ...
                            (0, ef.jsx)("a", {
                              href: t.url,
                              className:
                                "truncate pr-2 font-medium hover:opacity-70",
                              target: "_blank",
                              rel: "noreferrer",
                              children: t.title,
                            }),
      ...
      function tM(e) {
        ...
        switch (t.content_type) {
          ...
          case "image/png":
            return (0, ef.jsx)(tN, { className: n });
          case "audio/mpeg":
            return (0, ef.jsx)(tx, { className: n });
          case "audio/m4a":
            return (0, ef.jsx)(th, { className: n });
          case "audio/ogg":
            return (0, ef.jsx)(tj, { className: n });
          case "audio/wav":
            return (0, ef.jsx)(tC, { className: n });
          case "video/mp4":
      ...
      function tW(e) {
        ...
        let {
          ...
          h =
            null !== (t = (0, ek.d)(c.url).data) && void 0 !== t
              ? t
              : (0, eY.p)(c.url, "short"),
          g = l === c.url;
        return (
            ...
            s > 0
              ? a.map((e, s) => {
                  ...
                  return (0, ef.jsx)(
                    eS.E.div,
                    {
                      initial: r ? { opacity: 0, translateY: 4 } : {},
                      animate: r ? { opacity: 1, translateY: 0 } : {},
                      transition: tH(s),
                      children: (0, ef.jsx)(
                        tW,
                        {
      ...
      function t4(e) {
        ...
        return t.length >= 4
          ...
          : t.length >= 1
            ? (0, ef.jsx)(t3, { image: t[0], children: n })
      ...
      function t9(e) {
        let { images: t, numVisible: n = 8, children: r } = e,
          { downloadedImageUrls: a } = e_(t.map((e) => e.thumbnail_url)),
          ...
          return (0, ef.jsxs)("div", {
            children: [
              ...
              (0, ef.jsx)("div", {
                ...
                children: e.toLocaleString((0, t7.BH)(null, !0), {
      ...
      let no = (0, en.Z)(nt.Z.Cell)(Q || (Q = (0, J.Z)(["py-5 align-middle"]))),
        nc = (0, eS.E)(nt.Z.Row);
      var nu = n(28541),
        nd = n.n(nu);
      let nm = ["East", "Central", "West"];
      function np(e) {
        let { data: t } = e,
          { 0: n, 1: r } = (0, et.useState)(0),
          a = nd()(t.conferences[n].divisions, (e) => {
            var t;
            let n = nm.indexOf(null !== (t = e.name) && void 0 !== t ? t : "");
            return -1 === n ? 1 / 0 : n;
          }),
          s =
            ...
            (0, ef.jsx)("div", {
              ...
              children: a.map((e) =>
                e.name
                  ...
                  : (0, ef.jsx)(nA, { league: t.league.id, teams: e.teams })
              ),
            }),
          ],
        });
      }
      let nh = (0, en.Z)(nt.Z.HeaderCell)(
          W ||
            (W = (0, J.Z)([
      ...
      function nA(e) {
        let { league: t, teams: n } = e,
          r = nf[t];
        return (0, ef.jsxs)(nt.Z.Root, {
          size: "compact",
          children: [
            (0, ef.jsxs)(nt.Z.Header, {
              children: [
                (0, ef.jsx)(nh, { children: "Team" }),
                (0, ef.jsx)(nh, {}),
                r.map((e) =>
                  (0, ef.jsx)(
                    nh,
                ...
                (0, ef.jsxs)(
                  nt.Z.Row,
                  {
                    children: [
                      ...
                      (0, ef.jsx)(nt.Z.Cell, { className: "w-full" }),
                      r.map((t) =>
                        (0, ef.jsx)(
                          nt.Z.Cell,
                          {
      ...
      function ny(e) {
        let { data: t } = e,
          {
            ...
            var e;
            let n = (0, nv.Z)(t.target_time, t.target_location.timezone),
              r =
                t.source_time &&
                null !== (e = t.source_location) &&
                void 0 !== e &&
                e.timezone
                  ? (0, nv.Z)(t.source_time, t.source_location.timezone)
                  : null,
              a = (0, nb.Z)(n, "h:mmaaa", {
        ...
        return s
          ...
          : (0, ef.jsx)(nj, { humanReadableTime: a, humanReadableLocation: o });
      }
      function nj(e) {
        let {
          humanReadableTime: t,
      ...
      function nN(e) {
        let t = new Date(e);
        return (0, nn.Z)(t, "EEE, MMM d h:mm a");
      }
      function nS(e) {
        let t = new Date(e);
        return (0, nn.Z)(t, "MMM dd, yyyy");
      }
      function nE(e) {
        let t = new Date(e);
        return (0, nn.Z)(t, "MMM yyyy");
      }
      function nP(e) {
        let t = new Date(e);
        return (0, nn.Z)(t, "MMM dd");
      }
      nw.kL.register(
        nw.qi,
        nw.uw,
      ...
      let nC = {
        "1d": {
          ...
          formatTimestampLabel: function (e) {
            let t = new Date(e);
            return (0, nn.Z)(t, "h:mm a");
          },
          formatTimestampTooltip: nN,
          maxTicksLimit: 6,
          lineTension: 0,
        },
        "5d": {
          label: "5D",
          formatTimestampLabel: nP,
          formatTimestampTooltip: nN,
          maxTicksLimit: 6,
          lineTension: 0,
        },
        ...
        "6m": {
          label: "6M",
          formatTimestampLabel: nE,
          formatTimestampTooltip: nS,
          maxTicksLimit: 5,
          lineTension: 0.1,
        },
        ytd: {
      ...
      function nM(e) {
        ...
        return (0, ef.jsxs)(ef.Fragment, {
          children: [
            (0, ef.jsx)(nR, { data: n, priceChange: i }),
            n.histories &&
              (0, ef.jsx)("div", {
                className: "mt-6",
                children: (0, ef.jsx)(n_, {
                  isUp: i.isUp,
                      ...
                      children: "".concat(
                        (function (e) {
                          ...
                          return 1 === t.length || e.hourly.length > 0
                            ? nW(t[0], { alwaysShowDate: !0 })
                            : 7 === t.length
                              ? (0, nr.Z)(t[0])
                                ? "This week"
                                : "Week of ".concat((0, nn.Z)(t[0], "MMM do"))
                              : ""
                                  .concat(nW(t[0]), " - ")
                                  .concat(nW(t[t.length - 1]));
                        })(t)
                      ),
                    }),
                  ],
                    ...
                    children: [
                      (0, ef.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, ef.jsx)("span", {
                            children: "".concat(
                              nV("fahrenheit", l.temperature.max),
                              "\xb0F"
                            ),
                          }),
                          ...
                          (0, ef.jsx)("span", {
                            children: "".concat(
                              nV("fahrenheit", l.temperature.min),
                              "\xb0F"
                            ),
                          }),
                        ],
                  ...
                  children: [
                    ...
                    (0, ef.jsxs)("div", {
                      ...
                      children: [
                        (0, ef.jsx)("span", {
                          children: " ".concat(
                            nV("fahrenheit", t.temperature.min),
                            "\xb0F"
                          ),
                        }),
                        ...
                        (0, ef.jsx)("span", {
                          children: " ".concat(
                            nV("fahrenheit", t.temperature.max),
                            "\xb0F"
                          ),
                        }),
                      ],
            ...
            ? (0, ef.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, ef.jsx)("div", {
                    ...
                    children:
                      "sunrise" === t.type
                        ? (0, ef.jsx)(nU.Z, nZ({}, a.sunrise))
                        : (0, ef.jsx)(nU.Z, nZ({}, a.sunset)),
                  }),
                  (0, ef.jsx)("div", {
                    className: "text-xs text-token-text-tertiary",
                    children: nG(t.timestamp, "h:mma", n),
                  }),
                ],
              })
            : null;
          ...
          : (0, ef.jsxs)("div", {
              ...
              children: [
                ...
                (0, ef.jsx)("div", {
                  className: "mt-3 text-sm font-medium",
                  children: "".concat(
                    nV("fahrenheit", t.temperature.current),
                    "\xb0F"
                  ),
                }),
                (0, ef.jsx)("div", {
                  className: "text-xs text-token-text-tertiary",
                  children: nG(t.timestamp, "ha", n),
                }),
              ],
            });
      }
      function nW(e) {
        ...
        if ((0, nr.Z)(e)) {
          let n = "Today";
          return t ? "".concat(n, ", ").concat((0, nn.Z)(e, "MMM do")) : n;
        }
        if ((0, nT.Z)(e)) {
          let n = "Tomorrow";
          return t ? "".concat(n, ", ").concat((0, nn.Z)(e, "MMM do")) : n;
      ...
      function nX(e) {
        ...
        switch (null == t ? void 0 : t.type) {
          case "finance":
            return (0, ef.jsx)(nM, { data: t.data });
          case "sports-standings":
            return (0, ef.jsx)(np, { data: t.data });
          case "sports-schedule":
            return (0, ef.jsx)(nl, { data: t.data });
          case "time-difference":
            return (0, ef.jsx)(ny, { data: t.data });
          case "calculator":
            return (0, ef.jsx)(ne, { data: t.data });
          case "weather":
            return (0, ef.jsx)(nq, { weatherResults: t.data });
          default:
            return null;
        }
      }
      function nK(e) {
        ...
        return (s && (t = (0, ef.jsx)(nY, { videoId: s })), t)
      ...
      let n5 = (0, et.forwardRef)(function (e, t) {
        let {
          turn: n,
          isHighlighted: r,
          onRetryQuery: a,
        ...
        return (0, ef.jsxs)(
          ...
          n2(
            ...
            {
              children: [
                i && (0, ef.jsx)(n6, { text: n.user_query }),
                n0(n)
                  ? (0, ef.jsx)(n4, {
              ...
              children: [
                null != p &&
                  (0, ef.jsx)(n9, {
                    children: (0, ef.jsx)("div", {
                      className: "px-snc-results-content-padding",
                      children: (0, ef.jsx)(nX, { widget: p }),
                    }),
                  }),
                null != m &&
                  0 === r.index &&
                  null == p &&
                  (0, ef.jsx)(n9, { children: (0, ef.jsx)(n$, { tldr: m }) }),
                (0, ef.jsxs)("div", {
                  children: [
                    (0, ef.jsx)(t4, {
                      images: d,
                      children: (0, ef.jsx)(t0.h7.Provider, {
                        value: {
      ...
      function ro() {
        let e = (function () {
          ...
          { downloadedImageUrls: t } = e_(e.map((e) => e.thumbnail_url)),
      ...
      function ru(e) {
        ...
        return (
          (0, et.useEffect)(() => {
            t === rc.Sources && r && n(rc.Answer);
          }, [r, n, t]),
          (0, ef.jsxs)("div", {
            className: "flex gap-6",
            children: [
              (0, ef.jsx)(rd, {
                $selected: t === rc.Answer,
                disabled: t === rc.Answer,
                onClick: () => n(rc.Answer),
                children: "Answer",
              }),
              !r &&
                (0, ef.jsx)(rd, {
                  $selected: t === rc.Sources,
                  disabled: t === rc.Sources,
                  onClick: () => n(rc.Sources),
                  children: "Sources",
                }),
              (0, ef.jsx)(rd, {
                $selected: t === rc.Images,
                disabled: t === rc.Images,
                onClick: () => n(rc.Images),
                children: "Images",
              }),
            ],
      ...
      function rh(e) {
        let {
          ...
          g = (0, $.w$)(),
          f = (0, $.aj)(),
          { 0: A, 1: x } = (0, et.useState)(rc.Answer),
          {
            ...
            function l() {
              null != e.current && null != t.current
                ? r({
                    ...
                    followupTurnIndex:
                      (0, rp.S)(e9.nn.getState().thread).turns.length - 1,
                  })
                : r(null);
            }
            (0, et.useEffect)(() => {
                  ...
                  (0, ef.jsxs)("div", {
                    ...
                    children: [
                      (0, ef.jsxs)("header", {
                        ...
                        children: [
                          (0, ef.jsx)(ru, { selectedTab: A, onChangeTab: x }),
                          (0, ef.jsxs)("div", {
                            className:
                      ...
                      A === rc.Images && (0, ef.jsx)(ro, {}),
                      A === rc.Sources && (0, ef.jsx)(rm, { highlightUrl: p }),
                    ],
                  }),
                  f &&
                    (0, ef.jsx)("div", {
              ...
              if (!a) {
                ...
                try {
                  ...
                  a &&
                    ...
                    L({
                      conversationId: e,
                      credentials: _(_({}, a), {}, { e2eeKey: a.e2ee_key }),
                    });
                } catch (e) {
                  throw (
            ...
            (0, f.useEffect)(() => {
              ...
              if (e && !r) {
                let r = async (r) => {
                  ...
                  let a = { type: x.ActionRequest, payload: { action: r } };
...
//# sourceMappingURL=sso.03d77bb7b3a6307e.js.map
