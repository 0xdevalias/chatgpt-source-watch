(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [867],
  {
    80722: function (e, s, t) {
      ...
      async function P(e) {
        let {
          queryKey: [s, { workspaceId: t }],
        } = e;
        return d.Z.getWorkspaceAnalytics(t);
      }
      function L(e) {
        let { data: s, label: t, getWeekValue: a } = e,
          r = (0, x.Z)(),
          l = (0, y.F)().theme,
          i = (0, m.useMemo)(
            () =>
                ...
                return {
                  ...
                  scales: {
                    y: {
                      ...
                      ticks: {
                        stepSize: 3,
                        color: s.getPropertyValue("--text-tertiary"),
                        padding: 12,
                      },
                      grid: {
                        tickLength: 0,
                        color: s.getPropertyValue("--border-medium"),
                      },
                      border: { display: !1 },
                    },
                    x: {
                  ...
                  plugins: {
                    legend: !1,
                    tooltip: {
                      backgroundColor: s.getPropertyValue("--surface-primary"),
                      titleColor: s.getPropertyValue("--text-primary"),
                      bodyColor: s.getPropertyValue("--text-secondary"),
                      displayColors: !1,
          ...
          o = {
            labels: s.weekly_data.map((e) =>
              r.formatDate(e.week, { month: "numeric", day: "numeric" })
            ),
            datasets: [
              {
                label: t,
                data: s.weekly_data.map(a),
                borderWidth: 0,
                backgroundColor: n,
                barThickness: 20,
              },
        ...
        return (0, v.jsx)("div", {
          ...
          children: (0, v.jsx)(b.$Q, { options: i, data: o, height: 192 }),
        });
      }
      function _(e) {
      ...
      function M(e) {
        let { data: s } = e,
          t = (0, x.Z)(),
          a = s.weekly_data[s.weekly_data.length - 2];
        return (0, v.jsxs)("div", {
          className: "mt-10",
          children: [
            (0, v.jsx)("div", {
              className: "mb-2 font-medium text-token-text-primary",
              children: (0, v.jsx)(j.Z, O({}, U.totals)),
            }),
            (0, v.jsxs)("div", {
              className: "mb-16 flex gap-4",
              children: [
                (0, v.jsx)(_, {
                  label: t.formatMessage(U.usersLabel),
                  value: s.total_users,
                }),
                (0, v.jsx)(_, {
                  label: t.formatMessage(U.conversationsLabel),
                  value: s.total_conversations,
                }),
                (0, v.jsx)(_, {
                  label: t.formatMessage(U.messagesLabel),
              ...
              children: [
                (0, v.jsx)("div", {
                  ...
                  children: (0, v.jsxs)("div", {
                    children: [
                      (0, v.jsx)(A, {
                        children: (0, v.jsx)(j.Z, O({}, U.usageTitle)),
                      }),
                      null != a &&
                        (0, v.jsxs)("div", {
                          children: [
                            (0, v.jsx)(C, { children: a.message_count }),
                            (0, v.jsx)(D, {
                              children: (0, v.jsx)(
                                j.Z,
                                O({}, U.messagesLastWeek)
                              ),
                            }),
                          ],
                        }),
                ...
                (0, v.jsx)("div", {
                  children: (0, v.jsx)(L, {
                    data: s,
                    label: t.formatMessage(U.messagesChartLabel),
                    getWeekValue: (e) => e.message_count,
                  }),
                }),
              ],
            }),
            (0, v.jsxs)(Z, {
              children: [
                (0, v.jsx)("div", {
                  children: (0, v.jsx)(L, {
                    data: s,
                    label: t.formatMessage(U.activeUsersChartLabel),
                    getWeekValue: (e) => e.active_users_count,
                  }),
                }),
                (0, v.jsx)("div", {
                  ...
                  children: (0, v.jsxs)("div", {
                    children: [
                      (0, v.jsx)(A, {
                        children: (0, v.jsx)(j.Z, O({}, U.weeklyUsersTitle)),
                      }),
                      null != a &&
                        (0, v.jsxs)("div", {
                          children: [
                            (0, v.jsx)(C, { children: a.active_users_count }),
                            (0, v.jsx)(D, {
                              children: (0, v.jsx)(
                                j.Z,
                                O({}, U.activeUsersLastWeek)
                              ),
                            }),
                          ],
                        }),
      ...
      g.kL.register(g.uw, g.f$, g.od, g.ZL, g.Dx, g.u, g.De);
      let Z = k.Z.div(
          a ||
            (a = (0, c.Z)([
        ...
        A = k.Z.div(r || (r = (0, c.Z)(["font-medium"]))),
        C = k.Z.div(l || (l = (0, c.Z)(["font-medium text-3xl"]))),
        D = k.Z.div(i || (i = (0, c.Z)(["text-sm text-token-text-tertiary"])));
      function N(e) {
        let { currentWorkspaceId: s } = e,
          t = (0, x.Z)(),
          { data: a, isLoading: r } = (0, u.a)({
            queryKey: ["workspace-analytics", { workspaceId: s }],
            queryFn: P,
          });
          ...
          children: [
            (0, v.jsx)(f(), {
              children: (0, v.jsx)("title", {
                children: t.formatMessage(U.title),
              }),
            }),
            (0, v.jsx)(o.yG, {
              title: t.formatMessage(U.title),
              subtitle: t.formatMessage(U.pageDescription),
            }),
            (0, v.jsx)(o.hb, {
              showSpinner: r,
              children: void 0 !== a ? (0, v.jsx)(M, { data: a }) : null,
            }),
          ],
        });
      }
  ...
  function (e) {
    e.O(0, [6835, 7549, 9112, 2888, 9774, 179], function () {
      return e((e.s = 54522));
    }),
      (_N_E = e.O());
  },
]);
//# sourceMappingURL=analytics-e84bc29600d3ffbf.js.map
