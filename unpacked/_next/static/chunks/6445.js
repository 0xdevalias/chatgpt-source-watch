          ...
          let {
            ...
            [I = [], T] = (0, d.T)({
              ...
              onChange: (e) => {
                var t;
                let n = [...P.current];
                null === (t = n[K.current]) || void 0 === t || t.focus(), E(e);
              },
            }),
            V = (0, o.useRef)(I);
                  ...
                  (0, r.Z)(
                    ...
                    D,
                    {
                      ...
                      onSlideEnd: m
                        ? void 0
                        : function () {
                            let e = V.current[K.current],
                              t = I[K.current];
                            t !== e && b(I);
                          },
                      onHomeKeyDown: () => !m && Z(u, 0, { commit: !0 }),
                      onEndKeyDown: () =>
                        !m && Z(c, I.length - 1, { commit: !0 }),
          ...
          return (0, o.createElement)(
            ...
            (0, r.Z)({}, f, {
              ...
              onPointerMove: (0, l.M)(e.onPointerMove, (e) => {
                let t = e.target;
                t.hasPointerCapture(e.pointerId) && a(e);
              }),
...
//# sourceMappingURL=6445.09fe8b3ac253b1b0.js.map
