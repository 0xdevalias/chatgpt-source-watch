...
`),
      ...
      function eg(
        ...
        let p = Math.floor(i + l / 2),
          ...
          m = y(d, l, t.cellVerticalPadding),
          x = m / 2,
          k = b(h, n, o, t.cellHorizontalPadding, m),
          C = w(n + c, i + u, v(k, p, m));
        switch (r) {
          case !0:
            e.beginPath(),
      ...
      function eS(e, t, r, n, i, o, l, a, s, c, u, d, h, f, p, g, m, v = !1) {
        ...
        let b = m.horizontalBorderColor ?? m.borderColor,
          y = m.borderColor,
          w = 0,
          x = o,
          k = 0,
        ...
        let R = l + 0.5;
        for (let e = g - p; e < g; e++)
          (R -= d(e)), S.push({ x1: w, y1: R, x2: x, y2: R, color: b });
        if (!0 !== v) {
          let e = u + 0.5,
            t = r,
            n = R;
          for (; e + i < n; ) {
            ...
            if (r >= k && r <= C - 1) {
              ...
              S.push({
                ...
                x2: x,
                y2: r,
                color: e?.horizontalBorderColor ?? e?.borderColor ?? b,
              });
            }
            (e += d(t)), t++;
          }
          ...
          if (void 0 === o.menuIcon || o.menuIcon === f.pN.Triangle) {
            ...
            !(function (e, t, r) {
              ...
              for (let r = 0; r < o; r++) {
                ...
                let v = p / 2,
                  b = Math.abs((Math.cos(v) * n) / Math.sin(v));
                a =
                  b > Math.min(u.len / 2, d.len / 2)
                    ? Math.abs(
                        ((b = Math.min(u.len / 2, d.len / 2)) * Math.sin(v)) /
                          Math.cos(v)
                      )
                    : n;
                let y = s.x + d.nx * b,
              ...
              eD($, l, n, s, c, v, b, (i, l, c, d, v) => {
                ...
                let ea =
                  ...
                  es = (function (e, t, r) {
                    ...
                    for (let i of (F(e, t, r.current.range) && n++,
                ...
                if (((d || ed !== P.bgCell) && (b = ep(ed, b)), es > 0 || K)) {
                  K && (b = ep(el.bgHeader, b));
                  for (let e = 0; e < es; e++) b = ep(el.accentLight, b);
                } else if (void 0 !== k) {
                  for (let e of k)
                    if (e[0] === t.sourceIndex && e[1] === l) {
                      b = ep(el.bgSearchResult, b);
                      break;
                    }
                }
                if (void 0 !== C)
                ...
                if (void 0 !== w) {
                  ...
                  (r !== c - 1 || G + 1 <= a) &&
                    ...
                    e.rect(G + 1, t, Z - 1, r),
                    e.clip()),
                    (b = void 0 === b ? el.bgCell : ep(b, el.bgCell));
                }
                let ef = t.sourceIndex === r.length - 1,
                  eg = l === s - 1;
                void 0 !== b &&
                  ((e.fillStyle = b),
                  void 0 !== Y && (Y.fillStyle = b),
                  void 0 !== w
                    ? e.fillRect(
                        G + 1,
                        i + 1,
          ...
          x = m.map((e) => {
            ...
            return (function (e, t, r, n, i) {
              ...
              let b = f + g,
                ...
                k = f + g > a,
                C = p + m > s,
                S = (f > o && f < a) || (b > o && b < a) || (f < o && b > a),
                M = (p > l && p < s) || (y > l && y < s) || (p < l && y > s);
              if (S && M) {
                let e = Math.max(f, o),
                  t = Math.max(p, l),
                  r = Math.min(b, a),
              ...
              if (x && k) {
                let e = Math.max(f, a),
                  t = Math.min(y, l);
                v.push({
                  rect: { x: e, y: p, width: b - e, height: t - p },
              ...
              if (k && M) {
                let e = Math.max(f, a),
                  ...
                  n = Math.min(y, s);
                v.push({
                  rect: { x: e, y: t, width: b - e, height: n - t },
              ...
              if (k && C) {
                let e = Math.max(f, a),
                  t = Math.max(p, s);
                v.push({
                  rect: { x: e, y: t, width: b - e, height: y - t },
              ...
              return (
                m.x + m.width >= a.length && (b.width -= 1),
                m.y + m.height >= f && (b.height -= 1),
                {
                  color: e.color,
                  style: g,
                  clip: p.clip,
      ...
      function eL(e, t, r, n, i, o, l, a, s, c, u, d, h, f, p, g, m) {
        let v, b;
      ...
      function eF(e, t) {
        ...
        ey.save(),
          ...
          1 !== ed && (ey.scale(ed, ed), ew.scale(ed, ed));
        let eC = N(g, d, c, b, f),
          eE = [],
        ...
        let eF = () => {
          !(function (e, t, r, n, i, o, l, a, s, c, u, d, h, f, p, g, m, v, b) {
            let y = l + a;
            if (y <= 0) return;
                ...
                C
                  ...
                  : (E || R > 0) &&
                    ...
                    R > 0 &&
                      ...
                      e.fill(),
                      (e.globalAlpha = 1))),
                  eI(e, n, I, t.width, l, t, C, k, M, E, R, h, v, b),
                  e.restore();
              }),
              r &&
                (function (e, t, r, n, i, o, l, a, s, c, u, d) {
                  ...
                  e$(t, r, n, i, (t, r, n, s, g, m) => {
                    ...
                    let v = u(r),
                      ...
                      w = y ? b.bgHeaderHovered : b.bgHeader;
                    if (
                      (w !== l.bgHeader && ((e.fillStyle = w), e.fill()),
                      (e.fillStyle = b.textGroupHeader ?? b.textHeader),
                      void 0 !== v)
                    ) {
                      let t = n;
                      if (
          ...
          })(ey, eC, m, G, c, f, x, k, b, E, T, y, Z, K, M, A, ea, D, ee),
            eS(
              ey,
              eC,
              h,
            ...
            ey.stroke(),
            eO && eA(ey, c, u, d, h, f, p, g, v, x, k, S, P, O, j, y),
            eT && eL(ey, c, u, h, f, p, eC, g, y, eg, T, ek, z, P, J, I, O);
        };
        if (void 0 !== ea) {
          let e = eC[eC.length - 1].sourceIndex + 1,
            ...
            r = (e) => {
              ...
              I &&
                ...
                void 0 !== t &&
                ea.has(L(t.range)) &&
                eL(e, c, u, h, f, p, eC, g, y, eg, T, ek, z, P, J, I, O);
            };
          t &&
            (r(ew),
            null !== eb &&
            ...
            (void 0 !== ea &&
              ...
              e_(eC, h, f, p, eg, (e, t, r, n) => {
                let i = Math.max(0, n - t),
                  o = e.width - i - 1;
                ea.has([e.sourceIndex, -1]) && ey.rect(t + i + 1, k, o, eg - k);
              }),
              ey.clip()),
            eF()),
            ew.restore(),
        ...
        })(ew, eC, c, u, P, O, M, ek, y);
        let eN = eA(ew, c, u, d, h, f, p, g, v, x, k, S, P, O, j, y),
          eW = w
            ? eL(ew, c, u, h, f, p, eC, g, y, eg, T, ek, z, P, J, I, O)
            : void 0;
        if (((ew.fillStyle = y.bgCell), eE.length > 0)) {
        ...
        (r = T.rows),
          ...
          eS(ew, eC, h, f, p, c, u, eE, eB, k, eg, ek, H, M, P, O, y),
          eN?.(),
          eW?.(),
          E &&
            e_(
          ...
          null !== eb &&
            ((eb.fillStyle = y.bgCell),
            eb.fillRect(0, 0, c, u),
            eb.drawImage(ew.canvas, 0, 0));
        let ej =
          ((o = 0),
          e_(
            eC,
      ...
      var eG = l.memo(
        l.forwardRef((e, t) => {
          let {
            ...
            eL = e.translateX ?? 0,
            eD = e.translateY ?? 0,
            e_ = Math.max(z, Math.min(c.length - 1, u)),
            e$ = l.useRef(null),
            eW = l.useRef(),
            [eV, eG] = l.useState(!1),
            eZ = l.useRef([]),
          ...
          let ti = l.useMemo(
            ...
            tl = l.useCallback(
              (e, t, i) => {
                ...
                let l = o.width / r,
                  a = ee(t, i, r, n, b, te, e_, g, eL, eD, w, z, H, ti, y);
                return (
                  1 !== l &&
              ...
              [r, n, b, te, e_, g, eL, eD, w, z, H, ti, y]
            ),
            ta = l.useCallback(
              (e, t, i, l) => {
                let s;
              ...
              [r, ti, e_, eL, n, R, m, b, w, y, g, eD, H, tl, v, O, te]
            ),
            [ts] = eJ ?? [],
            tc = l.useRef(() => {}),
            tu = l.useRef(eJ);
          ...
          let ty = l.useCallback((e) => {
              (eW.current = e), tb.current(), (eW.current = void 0);
            }, []),
            tw = (function (e) {
              let t = l.useRef([]),
                r = l.useRef(0),
          ...
          null != tL &&
            ...
            (tL.style.cursor = tH.current = tA.cursor);
            ...
            tW = l.useCallback(
              (e) => {
                ...
                (t$.current = o.location),
                  o.isTouch && (t_.current = Date.now()),
                  e4.current !== o.isTouch && e8(o.isTouch),
                  (o.kind !== eX || void 0 === tD(n, o.location[0], t, r)) &&
                    (o.kind !== eY ||
                      void 0 ===
                        tF(o.group, o.bounds, o.localEventX, o.localEventY)) &&
                    (W?.(o),
                    !o.isTouch &&
                      !0 !== eu &&
                      eu !== o.kind &&
          ...
          let tB = l.useRef(0),
            tj = l.useCallback(
              (e) => {
                ...
                if (s.kind === eY) {
                  let e = tF(s.group, s.bounds, s.localEventX, s.localEventY);
                  if (void 0 !== e) {
              ...
              l.useCallback(
                (e) => {
                  ...
                  if (a.kind === eX && void 0 !== c)
                    ...
                    let e = tF(a.group, a.bounds, a.localEventX, a.localEventY);
              ...
              (e) => {
                ...
                if (eK(i, tU.current)) {
                  if ("cell" === i.kind || i.kind === eX || i.kind === eY) {
                    ...
                    o(r, t), (tu.current = r), e && ty(new el([i.location]));
                  }
                } else
                  X?.(i),
                    o(
          ...
          let t1 = l.useRef(),
            t2 = (function (e, t, r) {
              ...
              [r, ti, e_, Y, eL, w, g, i, O, t0, x, Z, K, tl, ex],
              0
            ),
            t5 = 0 !== z && F ? (e_ > z ? 1 : s(-eL / 100, 0, 1)) : 0,
            t3 = -(32 * g) + eD,
            t7 = D ? s(-t3 / 100, 0, 1) : 0,
            t6 = l.useMemo(
              () =>
                ...
                l.createElement(
                  ...
                  l.createElement(
                    ...
                    l.createElement(
                      ...
                      l.createElement("div", { className: "dvn-stack" }, b),
                      void 0 !== h &&
                        l.createElement(
                          l.Fragment,
                          null,
        ...
        return (
          ...
          l.createElement(
            e2,
            {
              ...
              scrollWidth: u + Math.max(0, b ?? 0) + (S ?? 0),
              scrollHeight: z + (M ?? 0),
              clientHeight: E,
              rightElement: m,
              paddingBottom: M,
      ...
      let ty = { kind: f.p6.Loading, allowOverlay: !1 },
        ...
        tx = l.forwardRef((e, t) => {
          ...
          let [b, y] = l.useState(tw),
            ...
            t7 = L ?? (j > 1e4 ? 48 : j > 1e3 ? 44 : j > 100 ? 36 : 32),
            t6 = "none" !== O,
            t8 = t6 ? 1 : 0,
            t4 = void 0 !== ew,
            t9 = e7?.sticky === !0,
          ...
          let [ro, rl] = (function (e, t, r, n, i) {
            ...
            rc = l.useCallback(
              (e, t) => {
                t &&
                  ...
                  void 0 !== e0
                    ? ((rs.current = tb(e, -t8)), e0(rs.current))
                    : y(e);
              },
              [e0, ro, t8, ee]
            ),
            ...
            rg = l.useCallback(
              (e) => {
                if (void 0 !== eO) {
                  let t = eO(tb(e, -t8));
                  return "boolean" == typeof t ? t : tb(t, t8);
                }
                return !0;
              },
              [eO, t8]
            ...
            ry = l.useMemo(() => (0, ec.yR)((0, ec.Zu)(), t1), [t1]),
          ...
          let rW = rF.x + t8,
            ...
            }, [rU, rq, eC, rP.length, ry.accentColor, t8]),
            rZ = l.useRef(rP);
          rZ.current = rP;
          let rQ = l.useCallback(
            ...
            r0 = l.useCallback(
              (e) => {
                ...
                x({
                  ...e,
                  theme: (0, ec.yR)(ry, i, o, l, e.content.themeOverride),
                });
              },
              [D, rP, rJ, ry]
            ),
                  ...
                  if (null !== l && null !== a) {
                    ...
                    if (
                      ...
                      let l = {
                        ...
                        a = 0;
                      for (let e = 0; e < eF; e++) a += rS[e].width;
                      let s = 0,
                        c = e6 + (t9 ? 1 : 0);
                      c > 0 && (s = $(rX, c, tQ));
                      ...
                      u > l.x
                        ...
                        v > l.y
                          ? (p = l.y - v)
                          : b < l.y + l.height && (p = l.y + l.height - b),
                        "vertical" === r || ("number" == typeof e && e < eF)
                          ? (f = 0)
                          : ("horizontal" === r ||
                ...
                if ("cell" === e.kind) {
                  ...
                  if (((ni.current = [i, o]), x(void 0), t6 && 0 === i))
                    ...
                    if (
                      ...
                      n
                        ? rb(void 0, e, t)
                        : rb(f.EV.fromSingleSelection(e), void 0, t);
                    } else
                      n
                        ? (l.hasIndex(i)
                            ? rb(l.remove(i), void 0, t)
                            : rb(void 0, i, t),
                          (ne.current = i))
                        : "none" !== eM &&
                          (rb(f.EV.fromSingleSelection(i), void 0, t),
                          (ne.current = i));
              ...
              (e) => {
                ...
                if ((rV(), t)) {
                  if (n.hasAll([o, l + 1])) {
                    ...
                    rb(e, void 0, t);
                  } else rb(void 0, [o, l + 1], t);
                } else rb(f.EV.fromSingleSelection([o, l + 1]), void 0, t);
              },
              [eM, rV, rn.columns, rP, t8, rb]
            ),
            nd = l.useRef(!1),
            nh = l.useCallback(
              async (e) => {
                if (void 0 !== ro && void 0 !== ru) {
                  ...
                  if (null !== i) {
                    ...
                    let t = tr(i, ry, n, 0, r, tK, tq, !1, rC);
                    ru?.(n, t.width, e, t.width);
                  }
                }
              },
              [rS, ro, tq, ry, tK, ru, t8, j, rC]
            ),
            [nf, np] = l.useState(),
            ng = l.useCallback(
              async (e, t) => {
            ...
            nk = l.useCallback(
              (e, t, r, n, i, o) => {
                ...
                let a =
                    0 === eF
                      ? void 0
                      : { x: 0, y: e.y, width: eF, height: e.height },
                  s = [];
                void 0 !== a && s.push(a),
                  e6 > 0 &&
                    (s.push({
                    ...
                    eF > 0 &&
                      s.push({ x: 0, y: j - e6, width: eF, height: e6 }));
                let c = {
                  x: e.x - t8,
                  y: e.y,
                  width: e.width,
            ...
            nC = g(
              ...
              l.useCallback(
                (e, t) => {
                  ex?.(e - t8, t - t8),
                    "none" !== eM &&
                      rb(f.EV.fromSingleSelection(t), void 0, !0);
                },
                [eM, ex, t8, rb]
              )
            ),
              ...
              (e) => {
                ...
                tn(t3.scrollToSelectedCell, e, r)
                  ...
                  : "none" !== eM && tn(t3.selectColumn, e, r)
                    ? i.hasIndex(l)
                      ? rb(i.remove(l), void 0, !0)
                      : "single" === eM
                        ? rb(f.EV.fromSingleSelection(l), void 0, !0)
                        : rb(void 0, l, !0)
          ...
          let nX = l.useMemo(
            ...
            nK = Math.min(rP.length, eF + (t6 ? 1 : 0));
          l.useImperativeHandle(
            t,
            () => ({
          ...
          let [nq, nG] = nx ?? [],
            nZ = l.useCallback(
              (e) => {
                ...
                if (-1 === r) {
                  "none" !== eM &&
                    (rb(f.EV.fromSingleSelection(t), void 0, !1), rV());
                  return;
                }
                (nq !== t || nG !== r) &&
                  (rm(
        ...
        tk = {
          ...
          onClick: (e) => {
            let { cell: t, posX: r, posY: n, bounds: i, theme: o } = e,
              ...
              h = y(u, a, o.cellVerticalPadding),
              p = v(
                b(t.contentAlign ?? "center", s, l, o.cellHorizontalPadding, h),
                d,
                h
              ),
              g = w(s + r, c + n, p);
      ...
      let tT = {
          ...
          draw: (e) =>
            (function (e, t) {
              ...
              for (let [e, r] of (i.beginPath(), b.entries())) {
                let s = t[e],
                  c = r.x + 8;
                if (void 0 !== s.img) {
      ...
      function tj(e, t) {
        if (t) {
          if (tD.test(e)) return e.replace(t_, tB);
...
`
      ...
      (rA.options = rA.setOptions =
        ...
        (rA.use = function (...e) {
          return (
            rz.use(...e), (rA.defaults = rz.defaults), (tF = rA.defaults), rA
          );
        }),
      ...
      class rL extends l.PureComponent {
        targetElement = null;
        ...
        rB = (e) => {
          ...
          return d
            ...
            : l.createElement(
                rW,
                { targetWidth: o.width },
                l.createElement(rL, { contents: c, createNode: i }),
                !u &&
                  l.createElement(
                    l.Fragment,
                    null,
    ...
    70557: function (e, t, r) {
          ...
          Object.defineProperties(i, {
            ...
            [t]: {
              ...
              get() {
                let e = this[l],
                  t = o[n];
                return _(e) ? Object.assign({}, t, e) : W(e, t);
              },
              set(e) {
                this[l] = e;
              },
      ...
      function tg(e, t, r, n, i, o = {}) {
        ...
        for (
          e.save(),
            ...
            F(o.rotation) || e.rotate(o.rotation),
          ...
          (a = s[l]),
            ...
            c &&
              ...
              F(o.strokeWidth) || (e.lineWidth = o.strokeWidth),
      ...
      function tw(e, t) {
        let r = {},
          n = _(t),
          i = n ? Object.keys(t) : t,
          o = _(e) ? (n ? (r) => W(e[r], e[t[r]]) : (t) => e[t]) : () => e;
        for (let e of i) r[e] = ty(o(e));
        return r;
      }
      function tx(e) {
      ...
      function tH(e, t, r, n) {
        ...
        let o = t._rootScopes,
          ...
          s = new Set();
        s.add(n);
        let c = tL(s, a, r, l || r, n);
        return (
          null !== c &&
          (void 0 === l || l === r || null !== (c = tL(s, a, l, c, n))) &&
          tT(Array.from(s), [""], o, l, () =>
            (function (e, t, r) {
              let n = e._getTarget();
              t in n || (n[t] = {});
      ...
      function rt(e, t, r) {
        ...
        for (let e = f, r = f; e <= p; ++e)
          (i = t[e % c]).skip ||
            (n = h(i[l])) === o ||
            ((b = d(n, a, s)),
            null === y && k() && (y = 0 === u(n, a) ? e : r),
            null !== y &&
              C() &&
              (v.push(re({ start: y, end: e, loop: g, count: c, style: m })),
              (y = null)),
            (r = e),
            (o = n));
        return (
          null !== y &&
            v.push(re({ start: y, end: p, loop: g, count: c, style: m })),
          v
        );
      }
      function rr(e, t) {
    ...
    25771: function (e, t, r) {
      ...
      let s = (0, n.forwardRef)(function (e, t) {
        let {
          ...
          x = () => {
            l(t, null), y.current && (y.current.destroy(), (y.current = null));
          };
        return (
          (0, n.useEffect)(() => {
            !c &&
          ...
          (0, n.useEffect)(() => {
            if (!c && y.current) {
              var e, t;
              (e = y.current.config.data), (t = h.labels), (e.labels = t);
            }
          }, [c, h.labels]),
          (0, n.useEffect)(() => {
            !c &&
              y.current &&
              h.datasets &&
              a(y.current.config.data, h.datasets, u);
          }, [c, h.datasets]),
          (0, n.useEffect)(() => {
            y.current && (c ? (x(), setTimeout(w)) : y.current.update(m));
          }, [c, f, h.labels, h.datasets, m]),
          (0, n.useEffect)(() => {
            y.current && (x(), setTimeout(w));
          }, [d]),
          (0, n.useEffect)(() => (w(), () => x()), []),
          n.createElement(
            "canvas",
            Object.assign({ ref: b, role: "img", height: r, width: s }, v),
            g
          )
        );
      });
...
//# sourceMappingURL=1856.9d5fe805d6e5fac3.js.map
