...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [8671],
  {
    89823: function (e, t, n) {
      ...
      function l(e, t, n) {
        ...
        if (
          (e.forEach((e) => {
            let t = r.D5U.sizeFromShape(e.shapeInfo.logicalShape);
            if (
              (e.shapeInfo.isUniform
                ? T.push(`uniform float ${e.name}${t > 1 ? `[${t}]` : ""};`)
                : (T.push(`uniform sampler2D ${e.name};`),
                  T.push(`uniform int offset${e.name};`)),
              ...
              switch (t.length) {
                case 1:
                  T.push(`uniform int ${e.name}Shape;`);
                  break;
                case 2:
                  T.push(`uniform ivec2 ${e.name}Shape;`);
                  break;
                case 3:
                  T.push(`uniform ivec3 ${e.name}Shape;`);
                  break;
                case 4:
                  T.push(`uniform ivec4 ${e.name}Shape;`);
              }
              T.push(`uniform ivec2 ${e.name}TexShape;`);
            }
          }),
          n.enableShapeUniforms)
        ) {
          switch (t.logicalShape.length) {
            case 1:
              T.push("uniform int outShape;");
              break;
            case 2:
              T.push("uniform ivec2 outShape;"),
                T.push("uniform int outShapeStrides;");
              break;
            case 3:
              T.push("uniform ivec3 outShape;"),
                T.push("uniform ivec2 outShapeStrides;");
              break;
            case 4:
              T.push("uniform ivec4 outShape;"),
                T.push("uniform ivec3 outShapeStrides;");
          }
          T.push("uniform ivec2 outTexShape;");
        }
        n.customUniforms &&
          n.customUniforms.forEach((e) => {
            T.push(
              `uniform ${e.type} ${e.name}${
                e.arrayIndex ? `[${e.arrayIndex}]` : ""
              };`
            );
          });
        let m = T.join("\n"),
  ...
  `;
                            let l = [Math.ceil(o[0] / 2), Math.ceil(o[1] / 2)];
                            return `
    vec4 ${r}(int index) {
      vec2 uv = packedUVfrom1D(
        ${l[0]}, ${l[1]}, index);
                        ...
                        case 2:
                          return (function (e, t) {
                            let n = e.shapeInfo.logicalShape,
                              o = e.name,
                              a =
                                "get" + o.charAt(0).toUpperCase() + o.slice(1),
                              l = e.shapeInfo.texShape,
                              c = l[0],
                              u = l[1],
                              p = (0, i.A)();
                            if (null != l && r.D5U.arraysEqual(n, l))
                              return t
                                ? `
  ...
  `;
                            let x = [Math.ceil(l[0] / 2), Math.ceil(l[1] / 2)],
                              h = Math.ceil(n[1] / 2);
                            return `
    vec4 ${a}(int row, int col) {
  ...
  `;
                        ...
                        case 3:
                          return (function (t, n) {
                            let r = t.shapeInfo.logicalShape,
                              o = t.name,
                              a =
                                "get" + o.charAt(0).toUpperCase() + o.slice(1),
  ...
  `;
                            let a = e.shapeInfo.logicalShape,
                              l = a.length,
  ...
  `;
                  ...
                  : (l += (function e(t, n = !1) {
                      let i = t.shapeInfo.logicalShape;
                      switch (i.length) {
                        case 0:
                          return (function (e, t) {
                            let n = e.name,
                          ...
                          return (function (t, n) {
                            let i = t.shapeInfo.logicalShape,
                              ...
                              a =
                                "get" + o.charAt(0).toUpperCase() + o.slice(1),
                              l = t.shapeInfo.texShape;
                            if (null != l && r.D5U.arraysEqual(i, l)) {
                              if (n)
                                return `
  ...
  `;
                            ...
                            let { newShape: c, keptDims: u } =
                              r.D5U.squeezeShape(i);
...
`;
    ...
    `;
                            let x = t.shapeInfo.texShape,
                              h = x[0],
                              v = x[1],
                              $ = t.shapeInfo.flatOffset;
                            if (v === l && null == $)
                              return n
                                ? `
      float ${a}(int row, int col, int depth) {
  ...
  `;
    ...
    `;
                            let h = t.shapeInfo.flatOffset,
                              v = t.shapeInfo.texShape,
                              $ = v[0],
                              C = v[1],
                              T = `int stride2 = ${o}Shape[3];`,
                              m = `int stride1 = ${o}Shape[2] * stride2;`,
                              R = `int stride0 = ${o}Shape[1] * stride1;`;
                            if (C === u && null == h)
                              return n
                                ? `
      float ${a}(int row, int col, int depth, int depth2) {
  ...
  `;
                        ...
                        case 5:
                          return (function (t) {
                            let n = t.shapeInfo.logicalShape,
                              i = t.name,
                              o =
  ...
  `;
    ...
    `;
                            let v = t.shapeInfo.flatOffset,
                              $ = t.shapeInfo.texShape,
                              C = $[0],
                              T = $[1];
                            if (T === h && null == v)
                              return `
  ...
  `;
                        ...
                        default:
                          throw Error(
                            `${i.length}-D input sampling is not yet supported`
                          );
                      }
                    })(e, o));
                let c = e.shapeInfo.logicalShape,
                  u = t.logicalShape;
                return (
                  c.length <= u.length &&
                    (n
                      ? (l += (function (e, t) {
                          ...
                          let i = e.name,
                            ...
                            l = e.shapeInfo.logicalShape.length,
                            c = t.logicalShape.length,
                            u = a(e.shapeInfo.logicalShape, t.logicalShape),
                            p = v(c),
                            x = c - l,
                            h = ["x", "y", "z", "w", "u", "v"];
                          n =
  ...
  `;
                      ...
                      : (l += (function (e, t) {
                          ...
                          let i = e.name,
                            ...
                            p = e.shapeInfo.logicalShape.length,
                            x = t.logicalShape.length;
                          if (
                            !e.shapeInfo.isUniform &&
                            p === x &&
                            null == e.shapeInfo.flatOffset &&
                            r.D5U.arraysEqual(u, c)
                          )
                            return `
      float ${l}() {
...
`;
  ...
  `;
      ...
      function d(e) {
        let t = e.name,
          n = r.D5U.sizeFromShape(e.shapeInfo.logicalShape);
        return n < 2
          ? `return ${t};`
          : `
    for (int i = 0; i < ${n}; i++) {
  ...
  `;
      ...
      function $(e, t, n) {
        let { newShape: i, keptDims: o } = r.D5U.squeezeShape(t),
          a = t.length,
          l = e && 3 === a && 1 === t[0],
          c = l ? t.slice(1) : i,
