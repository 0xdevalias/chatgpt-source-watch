(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [9923],
  {
    ...
    19604: function (e, t, r) {
      ...
      t.atelierHeath = n(c);
      var u = r(24875);
      t.atelierLakeside = n(u);
      var h = r(12254);
      t.atelierSeaside = n(h);
      var p = r(26630);
      t.bespin = n(p);
      var d = r(9723);
      t.brewer = n(d);
    ...
    53616: function (e, t, r) {
      ...
      for (var a in s)
        if (s.hasOwnProperty(a)) {
          ...
          delete s[a].channels,
            delete s[a].labels,
            Object.defineProperty(s[a], "channels", { value: l }),
            Object.defineProperty(s[a], "labels", { value: c });
        }
      (s.rgb.hsl = function (e) {
        ...
        (s.lab.xyz = function (e) {
          var t,
            ...
            o = e[1],
            s = e[2];
          (t = o / 500 + (r = (i + 16) / 116)), (n = r - s / 200);
          var a = Math.pow(r, 3),
            l = Math.pow(t, 3),
            c = Math.pow(n, 3);
          return (
            (r = (a > 0.008856 ? a : (r - 16 / 116) / 7.787) * 100),
            [
              (t = (l > 0.008856 ? l : (t - 16 / 116) / 7.787) * 95.047),
              r,
              (n = (c > 0.008856 ? c : (n - 16 / 116) / 7.787) * 108.883),
            ]
          );
        }),
        ...
        (s.lch.lab = function (e) {
          ...
          return [
            r,
            n * Math.cos((t = (e[2] / 360) * 2 * Math.PI)),
            n * Math.sin(t),
          ];
        }),
        ...
        for (
          var t = (function (e) {
              ...
              for (t[e].distance = 0; r.length; )
                for (
                  var i = r.pop(), o = Object.keys(n[i]), s = o.length, a = 0;
                  a < s;
                  a++
                ) {
                  var l = o[a],
    ...
    64510: function (e, t, r) {
      ...
      for (var a in n) o.call(n, a) && (s[n[a]] = a);
      ...
      (l.get = function (e) {
        ...
        (l.get.rgb = function (e) {
          ...
          if ((t = e.match(/^#([a-f0-9]{6})([a-f0-9]{2})?$/i))) {
            for (r = 0, i = t[2], t = t[1]; r < 3; r++) {
              var a = 2 * r;
              s[r] = parseInt(t.slice(a, a + 2), 16);
            }
            i && (s[3] = parseInt(i, 16) / 255);
          } else if ((t = e.match(/^#([a-f0-9]{3,4})$/i))) {
            for (r = 0, i = (t = t[1])[3]; r < 3; r++)
    ...
    90094: function (e, t, r) {
      ...
      function c(e, t) {
        ...
        if (null == e)
          ...
          (this.model = h.model),
            (u = i[this.model].channels),
            (this.color = h.value.slice(0, u)),
            (this.valpha = "number" == typeof h.value[u] ? h.value[u] : 1);
        } else if (e.length) {
        ...
        if (l[this.model])
          for (r = 0, u = i[this.model].channels; r < u; r++) {
            var y = l[this.model][r];
      ...
      function u(e, t, r) {
        return (
          ...
          function (n) {
            ...
            return (
              arguments.length
                ? (r && (n = r(n)), ((i = this[e]()).color[t] = n))
                : ((i = this[e]().color[t]), r && (i = r(i))),
              i
            );
          }
        );
        ...
        Object.keys(i).forEach(function (e) {
          if (-1 === s.indexOf(e)) {
            ...
            (c.prototype[e] = function () {
              ...
              return new c(
                (Array.isArray((r = i[this.model][e].raw(this.color)))
                  ? r
                  : [r]
                ).concat(n),
                e
              ...
              (c[e] = function (r) {
                return (
                  "number" == typeof r && (r = p(o.call(arguments), t)),
                  new c(r, e)
                );
              });
          }
          ...
          for (
              ...
              (r = new (function () {
                return (
                  ...
                  (this.get_content = function () {
                    for (
                      ...
                      if (
                        ...
                        t.length && (r = !0), this.line_char_count--;
                        continue;
                      }
                      if (r) {
                  ...
                  (this.get_tag = function () {
                    ...
                    var l = s.substring(1, e).toLowerCase();
                    if (
                      "/" === s.charAt(s.length - 2) ||
                      ...
                      this.record_tag(l), (this.tag_type = "SCRIPT");
                    else if ("style" === l)
                      this.record_tag(l), (this.tag_type = "STYLE");
                    else if (this.Utils.in_array(l, a)) {
                      var c = this.get_unformatted("</" + l + ">", s);
                      i.push(c),
                        t > 0 &&
                          this.Utils.in_array(
                          ...
                          i.splice(0, 0, this.input.charAt(t - 1)),
                        (r = this.pos - 1),
                        this.Utils.in_array(
                          this.input.charAt(r + 1),
                          this.Utils.whitespace
                        ) && i.push(this.input.charAt(r + 1)),
                        (this.tag_type = "SINGLE");
                    } else if ("!" === l.charAt(0)) {
                      if (-1 != l.indexOf("[if")) {
                        if (-1 != s.indexOf("!IE")) {
                      ...
                      "/" === l.charAt(0)
                        ? (this.retrieve_tag(l.substring(1)),
                          (this.tag_type = "END"))
                        : (this.record_tag(l), (this.tag_type = "START")),
            ...
            switch (r.token_type) {
              ...
              case "TK_TAG_END":
                ...
                break;
              case "TK_TAG_SINGLE":
                var h = r.token_text.match(/^\s*<([a-z]+)/i);
                (h && r.Utils.in_array(h[1], a)) ||
                  r.print_newline(!1, r.output),
                  r.print_token(r.token_text),
                  (r.current_mode = "CONTENT");
                break;
              ...
              case "TK_SCRIPT":
                if ("" !== r.token_text) {
                  r.output.push("\n");
                  var p = r.token_text;
                  if ("TK_SCRIPT" == r.token_type)
                    var d = "function" == typeof js_beautify && js_beautify;
                  else if ("TK_STYLE" == r.token_type)
                    var d = "function" == typeof css_beautify && css_beautify;
                  if ("keep" == t.indent_scripts) var f = 0;
                  else if ("separate" == t.indent_scripts)
                    var f = -r.indent_level;
                  else var f = 1;
                  var m = r.get_full_indent(f);
                  if (d) p = d(p.replace(/^\s*/, m), t);
                  else {
                    var g =
                        p
                          .match(/^\s*/)[0]
                          .match(/[^\n\r]*$/)[0]
                          .split(r.indent_string).length - 1,
                      b = r.get_full_indent(f - g);
                    p = p
                      .replace(/^\s*/, m)
                      .replace(/\r\n|\r|\n/g, "\n" + b)
                      .replace(/\s*$/, "");
                  }
                  p && (r.print_token(p), r.print_newline(!0, r.output));
                }
                r.current_mode = "TAG";
            }
    ...
    17181: function (e, t, r) {
      ...
      var A = Function.prototype,
        ...
        O = (n = /[^.]+$/.exec((D && D.keys && D.keys.IE_PROTO) || ""))
          ? "Symbol(src)_1." + n
          : "",
        M = A.toString,
        F = S.hasOwnProperty,
      ...
      function q(e) {
        return function () {
          ...
          var n = W((t = e.prototype)) ? j(t) : {},
            i = e.apply(n, r);
          return W(i) ? i : n;
        };
      }
      function B(e, t, r, n, i, o, s, a, l, c) {
        var u = 128 & t,
          h = 1 & t,
          p = 2 & t,
          d = 24 & t,
          ...
          m = p ? void 0 : q(e);
        return function g() {
          for (var b = arguments.length, v = Array(b), _ = b; _--; )
            v[_] = arguments[_];
          if (d)
            var k = P(g),
              x = (function (e, t) {
          ...
          if (
            ...
            var E = C(v, k);
            return L(e, t, B, g.placeholder, r, v, E, a, l, c - b);
          }
          var A = h ? r : this,
            S = p ? A[e] : e;
          return (
            ...
            a
              ...
              : f && b > 1 && v.reverse(),
            u && l < b && (v.length = l),
            this && this !== w && this instanceof g && (S = m || q(S)),
            S.apply(A, v)
          );
        };
      }
      function L(e, t, r, n, i, o, s, a, l, c) {
        var u = 8 & t;
        ...
        return (h.placeholder = n), U(h, e, t);
      }
      function P(e) {
      ...
      function $(e, t) {
        var r,
          n = null == e ? void 0 : e[t];
        return !(!W(n) || (O && O in n)) &&
          ("[object Function]" == (r = W(n) ? T.call(n) : "") ||
      ...
      function J(e, t, r) {
        var n = (function (e, t, r, n, i, o, s, a) {
          ...
          if (
            ...
            (n = p[3]),
            (i = p[4]),
            (a = p[9] = null == p[9] ? (l ? 0 : e.length) : I(p[9] - c, 0)) ||
              !(24 & t) ||
              (t &= -25),
            t && 1 != t)
          )
            8 == t || 16 == t
              ? ((d = e),
                ...
                (F = function e() {
                  for (
                    var t = arguments.length, r = Array(t), n = t, i = P(e);
                    n--;
                  )
                    r[n] = arguments[n];
                  var o = t < 3 && r[0] !== i && r[t - 1] !== i ? [] : C(r, i);
                  return (t -= o.length) < m
                    ? L(
                        d,
                        f,
                    ...
                    : x(
                        this && this !== w && this instanceof e ? g : d,
                        this,
                        r
                      );
                }))
              : (32 != t && 33 != t) || i.length
                ...
                : ((b = e),
                  ...
                  (F = function e() {
                    ...
                    return x(
                      this && this !== w && this instanceof e ? E : b,
                      k ? v : this,
                      o
                    );
                  }));
            ...
            var d,
              ...
              F =
                ...
                function e() {
                  return (
                    this && this !== w && this instanceof e ? M : A
                  ).apply(O ? D : this, arguments);
                });
          return U(F, e, t);
        })(e, 8, void 0, void 0, void 0, void 0, void 0, (t = r ? void 0 : t));
        return (n.placeholder = J.placeholder), n;
      }
      function W(e) {
        var t = typeof e;
        ...
        var t,
          r = (t = e)
            ? (t = (function (e) {
                ...
                if (
                  "symbol" == typeof (t = e) ||
                  (t && "object" == typeof t && "[object Symbol]" == T.call(t))
                )
                  return l;
                if (W(e)) {
                  var t,
    ...
    54221: function (e, t, r) {
      ...
      e.exports = function (e, t, r) {
        ...
        function _() {
          ...
          a = setTimeout(
            _,
            ((e = i - l), (r = i - c), (n = t - e), h ? f(n, o - r) : n)
          );
        }
        function k(e) {
          return ((a = void 0), p && n) ? y(e) : ((n = i = void 0), s);
        }
        function w() {
          var e,
            r = m(),
          ...
          if (((n = arguments), (i = this), (l = r), o)) {
            if (void 0 === a)
              return (c = e = l), (a = setTimeout(_, t)), u ? y(e) : s;
            if (h) return (a = setTimeout(_, t)), y(l);
          }
        ...
        return (
          ...
          g(r) &&
            ((u = !!r.leading),
            (o = (h = "maxWait" in r) ? d(b(r.maxWait) || 0, t) : o),
            (p = "trailing" in r ? !!r.trailing : p)),
          (w.cancel = function () {
            void 0 !== a && clearTimeout(a), (c = 0), (n = l = i = a = void 0);
          }),
          (w.flush = function () {
            return void 0 === a ? s : k(m());
          }),
          w
        );
      };
    ...
    92796: function (e) {
      for (var t = self.crypto || self.msCrypto, r = "-_", n = 36; n--; )
        r += n.toString(36);
      for (n = 36; n-- - 10; ) r += n.toString(36).toUpperCase();
      e.exports = function (e) {
        var i = "",
          o = t.getRandomValues(new Uint8Array(e || 21));
        for (n = e || 21; n--; ) i += r[63 & o[n]];
        return i;
      };
    },
    18004: function (e, t, r) {
      "use strict";
      r.d(t, {
        Z: function () {
          return ie;
      ...
      let l = 0,
        ...
        p = (e) => {
          var t;
          let { b: r, c: n } = e[c];
          n && (n(), null == (t = g.get(r)) || t());
        },
        d = (e, t) => {
          let r = e[c].o,
            n = t[c].o;
          return r === n || e === n || (u(r) && d(r, t));
        },
        f = (e, t) => {
        ...
        y = (e) => {
          ...
          let s = new WeakMap(),
            a = (e, t, r) => {
              let n = s.get(t);
              n || ((n = new Map()), s.set(t, n)),
                r.then(() => {
                  n.get(e) !== r || (n.delete(e), n.size || s.delete(t));
                }),
                n.set(e, r);
            },
            l = (e) => {
            ...
            g = (e) => {
              let t = c.get(e);
              return t || ((t = new Map()), c.set(e, t)), t;
            },
            y = (e, t) => {
              if (e) {
                let r = g(e),
                ...
                return (
                  !n &&
                    ((n = y(e.p, t)) && "p" in n && h(n.p) && (n = void 0),
                    n && r.set(t, n)),
                  n
                );
              }
            ...
            v = (e, t, r) => {
              if ((Object.freeze(r), e)) g(e).set(t, r);
              else {
                let e = n.get(t);
            ...
            _ = (e, t = new Map(), r) => {
              ...
              return (r.forEach((r) => {
                var o;
                let s = (null == (o = y(e, r)) ? void 0 : o.r) || 0;
                n.set(r, s), t.get(r) !== s && (i = !0);
              }),
              t.size !== n.size || i)
                ? n
                : t;
            ...
            k = (e, t, r, n, i) => {
              ...
              let s = {
                  ...
                  y: !0,
                  d: _(e, null == o ? void 0 : o.d, n),
                },
                a = !(null == o ? void 0 : o.y);
              return (o && "v" in o && Object.is(o.v, r)
                ? s.d === o.d ||
                  (s.d.size === o.d.size &&
                    Array.from(s.d.keys()).every((e) => o.d.has(e))) ||
                  ((a = !0),
                ...
                : ((a = !0),
                  ++s.r,
                  s.d.has(t) && (s.d = new Map(s.d).set(t, s.r))),
              o && !a)
                ? o
                : (v(e, t, s), s);
            },
            ...
            x = (e, t, r, n) => {
              let i = y(e, t);
              if (i && "p" in i) {
                if (d(i.p, r) && !h(i.p)) return i.y ? i : { ...i, y: !0 };
                p(i.p);
              }
              a(e, t, r);
              let o = {
            ...
            A = (e, t, r) => {
              ...
              try {
                let r = t.read((r) => {
                  n.add(r);
                  let i = r === t ? y(e, r) : A(e, r);
                  if (i) {
                    if ("e" in i) throw i.e;
                    if ("p" in i) throw i.p;
                    return i.v;
                  }
                  if (b(r)) return r.init;
                  throw Error("no atom init");
                });
                return E(e, t, r, n);
              } catch (r) {
                if (r instanceof Promise)
                  return x(e, t, u(r) && h(r) ? m(r) : f(r, r), n);
                return w(e, t, r, n);
              }
            },
            S = (e, t) => {
              ...
              let n = !0,
                ...
                o = t.write(
                  ...
                  (r, i) => {
                    let o;
                    if (r === t) {
                      if (!b(r)) throw Error("atom not writable");
                      l(r).forEach((t) => {
                        t !== e && E(t, r, i);
                      }),
                        y(e, r) !== E(e, r, i) && M(e, r);
            ...
            j = (e, t, n) => {
              ...
              if (
                (i.set(t, o),
                r.add(t),
                A(void 0, t).d.forEach((r, n) => {
                  let o = i.get(n);
                  o ? o.t.add(t) : n !== t && j(e, n, t);
                }),
                z(t) && t.onMount)
              ) {
                let r = t.onMount((r) => T(t, r, e));
                (e = void 0), r && (o.u = r);
              }
              return o;
            },
            ...
            N = (e, t, r, n) => {
              ...
              null == n ||
                n.forEach((r, n) => {
                  ...
                  let s = i.get(n);
                  s && (s.t.delete(t), D(n, s) && I(e, n));
                }),
                o.forEach((r) => {
                  let n = i.get(r);
                  n ? n.t.add(t) : i.has(t) && j(e, r, t);
                });
            },
            R = (e) => {
              if (e) {
          ...
          return {
            ...
            h: (e, t) => {
              for (let [r, n] of e) b(r) && (E(t, r, n), M(t, r));
              R(t);
            },
            n: (e) => (
              t.add(e),
        ...
        v = (e, t) => ({ s: t ? t(e).SECRET_INTERNAL_store : y(e) }),
        _ = new Map(),
        k = (e) => (_.has(e) || _.set(e, (0, s.createContext)(v())), _.get(e));
      function w(e, t) {
        return (function (e, t) {
          let r = `atom${++l}`,
            n = { toString: () => r };
      ...
      var A = w(!1),
        ...
        M = function () {
          return !!(
            ...
            (void 0 !== O && null != O.versions && null != O.versions.node) ||
            "nodejs" === window.name ||
            (null == navigator
              ? void 0
              : navigator.userAgent.includes("Node.js")) ||
            (null == navigator ? void 0 : navigator.userAgent.includes("jsdom"))
          );
        },
        F = M() ? (0, s.createContext)(null) : {};
      if (!M())
        for (
          var T = document.querySelectorAll("style[data-cmpld]"), z = 0;
          z < T.length;
          z++
        )
          document.head.appendChild(T[z]);
      var j = function () {
          return M() ? (0, s.useContext)(F) || {} : F;
        },
        I = function (e) {
          if (M()) {
            var t = j();
            return s.createElement(F.Provider, { value: t }, e.children);
          }
          return e.children;
        },
        N = ["", "l", "v", "w", "f", "i", "h", "a", "m"],
        ...
        B = function (e) {
          return 64 === e.charCodeAt(0)
            ? "m"
            : (58 === e.charCodeAt(10) && q[e.slice(14, e.indexOf("{"))]) || "";
        };
      function L(e) {
        var t = j();
        if (e.children.length) {
          if (M()) {
            for (var r = {}, n = !1, i = 0; i < e.children.length; i++) {
              var o = e.children[i];
              if (!t[o]) {
                (t[o] = !0), (n = !0);
                var a = B(o);
              ...
              (function (e, t) {
                var r = (function (e, t) {
                  if (!R[e]) {
                    ...
                    t.nonce && o.setAttribute("nonce", t.nonce),
                      o.appendChild(document.createTextNode("")),
                      document.head.insertBefore(o, n),
                      (R[e] = o);
                  }
                  return R[e];
                })(B(e), t).sheet;
      ...
      function P(e) {
        if (e.length <= 1 && (!e[0] || -1 === e[0].indexOf(" ")))
          return e[0] || void 0;
        for (var t = {}, r = 0; r < e.length; r++) {
          ...
          if (n)
            for (var i = n.split(" "), o = 0; o < i.length; o++) {
              var s = i[o];
              t[s.slice(0, 95 === s.charCodeAt(0) ? 5 : void 0)] = s;
            }
        }
        var a = "";
      ...
      function $(e, t, r) {
        return void 0 != e ? (t ? (r ? r + e + t : e + t) : e) : "var(--c-, )";
      }
      var U = {
          scheme: "monokai",
          base00: "#1E1E2E",
      ...
      function W(e) {
        return s.createElement(
          ...
          s.createElement(L, null, [
            ...
            "._94n57vkz{bottom:1pc}",
            "._1xi27vkz{right:1pc}",
            "._bfhk2l5j{background-color:#1e1e2e}",
            "._16qspg5n{box-shadow:var(--_nq33mp)}",
            "._2rko1ssb{border-radius:50%}",
            "._ca0q1y44{padding-top:4px}",
            "._u5f3i2wt{padding-right:6px}",
            "._n3td1y44{padding-bottom:4px}",
            "._19bvi2wt{padding-left:6px}",
            "._v564g17y{transition:opacity .3s}",
            "._19itglyw{border:none}",
            "._1pbyhac1{z-index:99999}",
            "._16l415iw:hover{opacity:.7}",
            "._d0altlke:hover{cursor:pointer}",
            "._w8l51u1b svg{width:34px}",
            "._17521u1b svg{height:34px}",
            "._11wmh2mm svg{position:relative}",
            "._1qh112gs svg{bottom:-2px}",
          ]),
          s.createElement(
            "button",
            {
              ...
              onClick: e.onClick,
              className: P([
                "_r06hglyw _kqsw1n9t _94n57vkz _1xi27vkz _bfhk2l5j _16qspg5n _2rko1ssb _ca0q1y44 _u5f3i2wt _n3td1y44 _19bvi2wt _v564g17y _19itglyw _1pbyhac1 _16l415iw _d0altlke _w8l51u1b _17521u1b _11wmh2mm _1qh112gs",
              ]),
              style: { "--_nq33mp": $("0 0 30px ".concat(J.black30)) },
            },
            s.createElement(
              "svg",
              {
              ...
              s.createElement("title", null, "prosemirror"),
              s.createElement("desc", null, "Created using Figma"),
              s.createElement("use", {
                xlinkHref: "#a",
      ...
      function ef(e) {
        return Object.keys(e).reduce(function (t, r) {
          var n;
          return -1 !== ep.indexOf(r)
            ? eh(
                eh({}, t),
                ((n = e[r]),
                ed.reduce(function (e, t) {
                  return (e[t + r[0].toUpperCase() + r.substr(1)] = n), e;
                }, {}))
              )
            : t;
        }, e);
      ...
      var ev = (function (e) {
        ...
        function n() {
          ...
          for (var t = arguments.length, i = Array(t), o = 0; o < t; o++)
            i[o] = arguments[o];
          return (
            er(K((e = r.call.apply(r, [this].concat(i)))), "state", {
              isControlled: void 0 !== e.props.size,
              size: e.props.size || e.props.defaultSize,
              isDimHidden: !e.props.isVisible,
              fullWidth: window.innerWidth,
              fullHeight: window.innerHeight,
              isTransitionStarted: !1,
              isWindowResizing: !1,
            }),
            er(K(e), "transitionEnd", function () {
              e.setState({ isTransitionStarted: !1 });
            }),
            er(K(e), "hideDim", function () {
              e.props.isVisible || e.setState({ isDimHidden: !0 });
            }),
            er(K(e), "handleDimClick", function () {
              "opaque" === e.props.dimMode &&
                e.props.onVisibleChange &&
                e.props.onVisibleChange(!1);
            }),
            er(K(e), "handleResize", function () {
              window.requestAnimationFrame
                ? window.requestAnimationFrame(
                    e.updateWindowSize.bind(K(e), !0)
                  )
                : e.updateWindowSize(!0);
            }),
            er(K(e), "updateWindowSize", function (t) {
              var r = {
                fullWidth: window.innerWidth,
                fullHeight: window.innerHeight,
              };
              t
                ? (e.setState(
                    eg(eg({}, r), {}, { isResizing: !0, isWindowResizing: t })
                  ),
                  e.debouncedUpdateWindowSizeEnd())
                : e.setState(r);
            }),
            er(K(e), "updateWindowSizeEnd", function () {
              e.setState({ isResizing: !1, isWindowResizing: !1 });
            }),
            er(
              K(e),
              "debouncedUpdateWindowSizeEnd",
              ec()(e.updateWindowSizeEnd, 30)
            ),
            er(K(e), "handleWrapperLeave", function () {
              e.setState({ isResizing: !1 });
            }),
            er(K(e), "handleMouseDown", function () {
              e.setState({ isResizing: !0 });
            }),
            er(K(e), "handleMouseUp", function () {
              e.setState({ isResizing: !1 });
            }),
            er(K(e), "handleMouseMove", function (t) {
              if (e.state.isResizing && !e.state.isWindowResizing) {
                ...
                switch (
                  (t.touches &&
                    ((u = t.touches[0].clientX), (h = t.touches[0].clientY)),
                  i)
                ) {
                  case "left":
                    r = o ? u / a : u;
                ...
                e.props.onSizeChange && e.props.onSizeChange(r),
                  c || e.setState({ size: r });
              }
            }),
            e
          ...
          Y(n, [
            ...
            },
            {
              ...
              value: function (e) {
                ...
                this.setState({ isControlled: t }),
                  t && e.size && this.props.size !== e.size
            ...
            },
            {
              ...
              value: function (e) {
                ...
                this.setState({
                  size: e.fluid
                    ? this.state.size / ey(e.position, r, n)
                    : ey(e.position, r, n) * this.state.size,
                });
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                    ...
                    [{}].concat(
                      eo(
                        ...
                        [
                          ...
                          n,
                          "transparent" === r && eb.dimTransparent,
                          !o && eb.dimHidden,
                          a && o && eb.dimAppear,
                          a && !o && eb.dimDisappear,
                        ])
                    ...
                    [{}].concat(
                      eo(
                        (function (e, t) {
                          ...
                          switch (a) {
                            case "left":
                              r = { width: d, left: l ? 0 : "-" + d };
                              break;
                            case "right":
                              r = { left: l ? f(h) : h, width: d };
                              break;
                            case "top":
                              r = { top: l ? 0 : "-" + d, height: d };
                              break;
                            case "bottom":
                              r = { top: l ? f(p) : p, height: d };
                          }
                          var m = ["left", "top", "width", "height"].map(
                            function (e) {
                              return ""
                                .concat(e, " ")
                                .concat(s / 1e3, "s ease-out");
                            }
                          );
                          return [
                            eb.dock,
                ...
                return s.createElement(
                  "div",
                  { style: Object.assign({}, eb.wrapper, { zIndex: u }) },
                  "none" !== h &&
                    !b &&
                    s.createElement("div", {
                      style: y,
      ...
      er(ev, "propTypes", {
        position: ea().oneOf(["left", "right", "top", "bottom"]),
        zIndex: ea().number,
        fluid: ea().bool,
        size: ea().number,
        defaultSize: ea().number,
        dimMode: ea().oneOf(["none", "transparent", "opaque"]),
        isVisible: ea().bool,
        onVisibleChange: ea().func,
        onSizeChange: ea().func,
        dimStyle: ea().object,
        dockStyle: ea().object,
        duration: ea().number,
      }),
      ...
      var e_ = "._vchhusvi{box-sizing:border-box}",
        ek = "._1bsb1osq{width:100%}",
        ew = s.createContext({
          selectedIndex: "state",
          onSelect: function (e) {},
        }),
        ex = function (e) {
          ...
          return s.createElement(
            ...
            s.createElement(L, null, [
              ...
              "._n7zl14jc{border-bottom:1px solid rgba(203,166,247,.2)}",
            ]),
            s.createElement(
              "div",
              {
                "data-test-id":
                  "__prosemirror_devtools_tabs_buttons_container__",
                className: P(["_1e0c1txw _qtt8glyw _n7zl14jc"]),
              },
              t
            )
          );
        ...
        eE = function (e) {
          ...
          return s.createElement(
            I,
            null,
            s.createElement(L, null, ["._4t3i1osq{height:100%}", ek]),
            s.createElement(
              "div",
              {
                "data-test-id": "__prosemirror_devtools_tabs_container__",
                className: P(["_4t3i1osq _1bsb1osq"]),
              },
              t
            )
          );
        ...
        eC = function (e) {
          ...
          return s.createElement(
            ...
            null,
            s.createElement(L, null, [
              "._syaz5y2n{color:#cdd6f4}",
              "._1p1dangw{text-transform:uppercase}",
              "._1wybw1gv{font-size:13px}",
              "._ca0q7vkz{padding-top:1pc}",
              "._u5f31tcg{padding-right:24px}",
              "._n3tddlk8{padding-bottom:14px}",
              "._19bv1tcg{padding-left:24px}",
              e_,
              "._uiztglyw{-webkit-user-select:none;-moz-user-select:none;user-select:none}",
              "._n7zl13lm{border-bottom:var(--_1deexx)}",
              "._d0altlke:hover{cursor:pointer}",
              "._irr33ch5:hover{background-color:rgba(205,214,244,.05)}",
            ...
            s.createElement(
              "div",
              {
                onClick: n,
                className: P([
                  "_syaz5y2n _1p1dangw _1wybw1gv _ca0q7vkz _u5f31tcg _n3tddlk8 _19bv1tcg _vchhusvi _uiztglyw _n7zl13lm _d0altlke _irr33ch5 _nt751r31 _49pcglyw _1hvw1o36",
                ]),
                style: {
                  "--_1deexx": $(r ? "2px solid ".concat(J.main) : "none"),
                },
              },
              t
            )
      ...
      function eS(e) {
        var t = (0, s.useContext)(ew);
        return s.createElement(
          I,
          null,
          s.createElement(L, null, [
            ek,
            "._4t3it4lq{height:calc(100% - 3pc)}",
            e_,
          ]),
          s.createElement(
            "div",
            { className: P(["_1bsb1osq _4t3it4lq _vchhusvi"]) },
            e.children({ index: t.selectedIndex })
          )
        );
      }
      function eD(e) {
        return s.createElement(
          ew.Provider,
          { value: { onSelect: e.onSelect, selectedIndex: e.selectedIndex } },
          s.createElement(eE, null, e.children)
        );
      }
      var eO = [
          "jsonID",
        ...
        eF = ["nodeAfter", "nodeBefore", "parent"];
      function eT(e, t, r) {
        return t.reduce(function (t, n) {
          return (
            r && r[n]
              ? (t[n] = r[n].reduce(function (t, r) {
                  return (
                    (t[r] =
                      -1 !== eF.indexOf(r) && e[n][r]
                        ? e[n][r].toJSON()
                        : e[n][r]),
                    t
                  );
                }, {}))
              : (t["jsonID" === n ? "type" : n] = e[n]),
            t
          );
        }, {});
      }
      var ez = "._4t3i1osq{height:100%}",
        ej = function (e) {
          var t = e.children,
            r = e.testId;
          return s.createElement(
            I,
            null,
            s.createElement(L, null, ["._1e0c1txw{display:flex}", ez]),
            s.createElement(
              "div",
              { "data-test-id": r, className: P(["_1e0c1txw _4t3i1osq"]) },
              t
            )
          );
        },
        eI = function (e) {
          ...
          return s.createElement(
            ...
            s.createElement(L, null, [
              ...
              "._ca0q7vkz{padding-top:1pc}",
              "._u5f3f6fq{padding-right:18px}",
              "._n3tdf6fq{padding-bottom:18px}",
              "._19bvf6fq{padding-left:18px}",
              "._1kl79cqg{border-left:var(--_7sctaf)}",
              "._16jlkb7n{flex-grow:1}",
              "._ca0qidpf{padding-top:0}",
              "._u5f3idpf{padding-right:0}",
              "._n3tdidpf{padding-bottom:0}",
              "._19bvidpf{padding-left:0}",
              "._1ul9fx7m{min-width:var(--_74ww00)}",
              "._p12f1mu9{max-width:var(--_1p7w3p2)}",
            ]),
            s.createElement(
              "div",
              {
                className: P([
                  "_vchhusvi _4t3i1osq _1reo15zi _18m915zi _1kl7glyw _ca0q7vkz _u5f3f6fq _n3tdf6fq _19bvf6fq",
                  r && "_1kl79cqg",
                  n && "_16jlkb7n",
                  i && "_ca0qidpf _u5f3idpf _n3tdidpf _19bvidpf",
                  "_1ul9fx7m _p12f1mu9",
                ]),
                style: {
                  "--_7sctaf": $("1px solid " + J.main20),
                  "--_74ww00": $(o ? "".concat(o, "px") : "none"),
                  "--_1p7w3p2": $(a ? "".concat(a, "px") : "none"),
                },
              },
              t
            )
      ...
      var eB = function (e) {
        ...
        return s.createElement(
          "div",
          (0, eN.Z)({}, t("arrowContainer", r), { onClick: o }),
          s.createElement(
            "div",
            t(["arrow", "arrowSign"], i, n, r),
            "▶",
            "double" === r &&
              s.createElement("div", t(["arrowSign", "arrowSignInner"]), "▶")
          )
        );
      };
      function eL(e, t) {
      ...
      function eP(e, t, r) {
        ...
        if ("Object" === e) {
          ...
          r && o.sort(!0 === r ? void 0 : r),
            (s = {
              entries: (o = o.slice(n, i + 1)).map(function (e) {
                return { key: e, value: t[e] };
              }),
            });
        } else if ("Array" === e)
          s = {
            entries: t.slice(n, i + 1).map(function (e, t) {
              ...
              n <= l &&
                (h && Array.isArray(d)
                  ? "string" == typeof d[0] || "number" == typeof d[0]
                    ? c.push({ key: d[0], value: d[1] })
                    : c.push({
                        key: "[entry ".concat(l, "]"),
                        value: { "[key]": d[0], "[value]": d[1] },
                      })
                  : c.push({ key: l, value: d })),
                l++;
            }
          } catch (e) {
            p.e(e);
      ...
      function e$(e, t, r) {
        ...
        for (var i = e; i <= t; i += r)
          n.push({ from: i, to: Math.min(t, i + r - 1) });
        return n;
      }
      (eB.propTypes = {
        styling: ea().func.isRequired,
        arrowStyle: ea().oneOf(["single", "double"]),
        expanded: ea().bool.isRequired,
        nodeType: ea().string.isRequired,
        onClick: ea().func.isRequired,
      }),
        (eB.defaultProps = { arrowStyle: "single" });
      var eU = (function (e) {
        Q(n, e);
        var t,
          r =
        ...
        function n(e) {
          ...
          return (
            H(this, n),
            er(K((t = r.call(this, e))), "handleClick", function () {
          ...
          Y(n, [
            {
              ...
              value: function () {
                ...
                return this.state.expanded
                  ...
                  : s.createElement(
                      "div",
                      (0, eN.Z)({}, t("itemRange", this.state.expanded), {
      ...
      er(eU, "propTypes", {
        styling: ea().func.isRequired,
        from: ea().number.isRequired,
        to: ea().number.isRequired,
        renderChildNodes: ea().func.isRequired,
        nodeType: ea().string.isRequired,
      });
      var eV = (function (e) {
        Q(n, e);
          ...
          Y(n, [
            {
              ...
              value: function (e) {
                var t = eH(e);
                eH(this.props).expanded !== t.expanded && this.setState(t);
              },
            },
            {
              ...
              value: function () {
                var e = this.props,
                      ...
                      ? (function e(t, r, n) {
                          ...
                          return (
                            (function (e, t, r, n) {
                              var i,
                                ...
                                s =
                                  ...
                                  void 0 !== arguments[5]
                                    ? arguments[5]
                                    : 1 / 0,
                                a = eP.bind(null, e, t, r);
                              if (!n) return a().entries;
                              var l = s < 1 / 0,
                                c = Math.min(
                                  s - o,
                                  "Object" === e
                              ...
                              if ("Iterable" !== e) {
                                if (c <= n || n < 7) return a(o, s).entries;
                              } else if (c <= n && !l) return a(o, s).entries;
                              if ("Iterable" === e) {
                                var u = a(o, o + n - 1),
                                  h = u.hasMore,
                                  p = u.entries;
                                ...
                                i = l
                                  ...
                                  : [].concat(
                                      eo(a(0, n - 5).entries),
                                      eo(e$(n - 4, c - 5, n)),
                                      eo(a(c - 4, c - 1).entries)
                                    );
                              return i;
                            })(i, o, h, a, r, n).forEach(function (r) {
                              if (void 0 !== r.to)
                                p.push(
                                  s.createElement(
                                    eU,
                                ...
                                p.push(
                                  s.createElement(
                                    ...
                                    (0, eN.Z)({}, t, {
                                      ...
                                      collectionLimit: a,
                                      key: "Node--".concat(n),
                                      keyPath: [n].concat(eo(c)),
                                      value: u(i),
                                      circularCache: [].concat(eo(l), [i]),
                                      isCircular: o,
                                      hideRoot: !1,
                                    })
                                  )
                  ...
                  m = t(
                    n,
                    i,
                    s.createElement("span", l("nestedNodeItemType", d), r),
                    a(i, c),
                    u
                  ),
                  g = [u, n, d, p];
                return o
                  ? s.createElement(
                      "li",
                      l.apply(void 0, ["rootNode"].concat(g)),
                      s.createElement(
                        "ul",
                        l.apply(void 0, ["rootNodeChildren"].concat(g)),
                        f
                      )
                    )
                  : s.createElement(
                      "li",
                      l.apply(void 0, ["nestedNode"].concat(g)),
                      p &&
                        s.createElement(eB, {
                          styling: l,
                          nodeType: n,
                      ...
                      s.createElement(
                        ...
                        (0, eN.Z)(
                          ...
                          l.apply(
                            void 0,
                            [["label", "nestedNodeLabel"]].concat(g)
                          ),
                          { onClick: this.handleClick }
                        ),
                        h.apply(void 0, g)
                      ...
                      s.createElement(
                        ...
                        (0, eN.Z)(
                          {},
                          l.apply(void 0, ["nestedNodeItemString"].concat(g)),
                          { onClick: this.handleClick }
                        ),
                        m
                      ),
                      s.createElement(
                        "ul",
                        l.apply(void 0, ["nestedNodeChildren"].concat(g)),
                        f
                      )
                    );
              },
      ...
      er(eV, "propTypes", {
        getItemString: ea().func.isRequired,
        nodeTypeIndicator: ea().any,
        nodeType: ea().string.isRequired,
        data: ea().any,
        hideRoot: ea().bool.isRequired,
        createItemString: ea().func.isRequired,
        styling: ea().func.isRequired,
        collectionLimit: ea().number,
        keyPath: ea().arrayOf(ea().oneOfType([ea().string, ea().number]))
          .isRequired,
        labelRenderer: ea().func.isRequired,
        shouldExpandNode: ea().func,
        level: ea().number.isRequired,
        sortObjectKeys: ea().oneOfType([ea().func, ea().bool]),
        isCircular: ea().bool,
        expandable: ea().bool,
      }),
        er(eV, "defaultProps", {
      ...
      eY.propTypes = { data: ea().object, nodeType: ea().string.isRequired };
      var eK = ["data"];
      function eX(e) {
        return ""
          .concat(e.length, " ")
      ...
      e5.propTypes = {
        ...
        labelRenderer: ea().func.isRequired,
        keyPath: ea().arrayOf(
          ea().oneOfType([ea().string, ea().number]).isRequired
        ).isRequired,
        valueRenderer: ea().func.isRequired,
        value: ea().any,
        valueGetter: ea().func,
      };
      var e3 = [
      ...
      var e8 = function (e) {
        var t,
          ...
          h = c(a)
            ? "Custom"
            : "Object" ===
                  (t = Object.prototype.toString.call(a).slice(8, -1)) &&
          ...
          d = e6(e6(e6({}, u), p), {}, { data: a, isCustomNode: c });
        switch (h) {
          case "Object":
          case "Error":
          case "WeakMap":
          case "WeakSet":
            return s.createElement(eY, d);
          case "Array":
            return s.createElement(eQ, d);
          case "Iterable":
          case "Map":
          case "Set":
            return s.createElement(e2, d);
          case "String":
            return s.createElement(
              e5,
              (0, eN.Z)({}, p, {
      ...
      e8.propTypes = {
        ...
        value: ea().any,
        valueRenderer: ea().func.isRequired,
        isCustomNode: ea().func.isRequired,
      };
      var e9 = e8,
        e7 = r(19604),
        te = r(90094),
      ...
      var ts = e7.default,
        ...
        tl = function (e) {
          var t,
            ...
            p = eq(
              [
                0.299 * (r = (t = tt()(e).array())[0] / 255) +
                  0.587 * (n = t[1] / 255) +
                  0.114 * (i = t[2] / 255),
                -0.14713 * r + -0.28886 * n + 0.436 * i,
                0.615 * r + -0.51499 * n + -0.10001 * i,
              ],
              3
            ),
            d = p[0],
            f =
              ((s =
                1 *
                  (c = (o = [
                    d < 0.25 ? 1 : d < 0.5 ? 0.9 - d : 1.1 - d,
                    p[1],
                    p[2],
                  ])[0]) +
                0 * (u = o[1]) +
                1.13983 * (h = o[2])),
              (a = 1 * c + -0.39465 * u + -0.5806 * h),
              (l = 1 * c + 2.02311 * u + 0 * h),
              [
                ...
                case "function":
                  return function (r) {
                    for (
                      ...
                      i[o - 1] = arguments[o];
                    return tc({ className: e })(t.apply(void 0, [r].concat(i)));
                  };
              }
              break;
            case "object":
                ...
                case "function":
                  return function (r) {
                    for (
                      ...
                      i[o - 1] = arguments[o];
                    return tc({ style: e })(t.apply(void 0, [r].concat(i)));
                  };
              }
              break;
            case "function":
                ...
                case "string":
                  return function (r) {
                    for (
                      ...
                      i[o - 1] = arguments[o];
                    return e.apply(void 0, [tc(r)({ className: t })].concat(i));
                  };
                case "object":
                  return function (r) {
                    for (
                      ...
                      i[o - 1] = arguments[o];
                    return e.apply(void 0, [tc(r)({ style: t })].concat(i));
                  };
                case "function":
                  return function (r) {
                    for (
                    ...
                    return e.apply(
                      void 0,
                      [t.apply(void 0, [r].concat(i))].concat(i)
                    );
                  };
              }
          }
        ...
        th = function (e, t) {
          var r = Object.keys(t);
          for (var n in e) -1 === r.indexOf(n) && r.push(n);
        ...
        tp = function (e, t) {
              ...
              function (e, t) {
                return (
                  "string" == typeof t
                    ...
                    : "object" === V(t)
                      ? (e.style = to(to({}, e.style), t))
                      : "function" == typeof t &&
                        (e = to(to({}, e), t.apply(void 0, [e].concat(n)))),
                  e
                );
              },
              { className: "", style: {} }
          ...
          return (
            ...
            0 === Object.keys(o.style).length && delete o.style,
            o
          );
        },
        td = function (e) {
        ...
        tf = tn()(function (e) {
          var t =
            ...
            i = void 0 === n ? ts : n,
            o = t.base16Themes,
            s = tg(r, void 0 === o ? null : o);
          s && (r = to(to({}, s), r));
          for (
            var a = ta.reduce(function (e, t) {
                return (e[t] = r[t] || i[t]), e;
              }, {}),
              l = th(
                Object.keys(r).reduce(function (e, t) {
                  return -1 === ta.indexOf(t) && (e[t] = r[t]), e;
                }, {}),
                e(a)
              ),
              c = arguments.length,
            ...
            u[h - 3] = arguments[h];
          return tn()(tp, 2).apply(void 0, [l].concat(u));
        }, 3),
        tm = function (e) {
          return !!e.extend;
        },
        tg = function (e, t) {
          if (
            (e && tm(e) && e.extend && (e = e.extend), "string" == typeof e)
          ) {
            var r = eq(e.split(":"), 2),
              n = r[0],
              i = r[1];
            (e = t ? t[n] : e7[n]), "inverted" === i && (e = td(e));
          }
      ...
      var tv = tf(
          function (e) {
            ...
            return {
              ...
              nestedNodeLabel: function (e, t, r, n, i) {
                return {
                  style: ty(
                    ty({}, e.style),
                    {},
              ...
              nestedNodeItemString: function (e, r, n, i) {
                return {
                  style: ty(
                    ty({}, e.style),
                    {},
        ...
        var t,
          ...
          o =
            ...
            (i = Object.keys(
              ...
              ((r = "string" == typeof r ? { extend: r } : tw({}, r)),
                ...
                console.error(
                  ...
                  (r[n[t]] = function (r) {
                    for (
                      ...
                      o[s - 1] = arguments[s];
                    return { style: tw(tw({}, n), e[t].apply(e, o)) };
                  });
              })),
            r);
        return (
      ...
      var tC = (function (e) {
        ...
        function n(e) {
          var t;
          return H(this, n), ((t = r.call(this, e)).state = tE(e)), t;
        }
        return (
          Y(n, [
            {
            ...
            },
            {
              ...
              value: function () {
                var e = this.props,
                  ...
                  i = e.hideRoot,
                  o = (e.theme, e.invertTheme, eR(e, t_)),
                  a = this.state.styling;
                return s.createElement(
                  "ul",
                  a("tree"),
                  s.createElement(
                    ...
                    (0, eN.Z)(
                      {},
                      tw({ postprocessValue: n, hideRoot: i, styling: a }, o),
                      { keyPath: i ? [] : r, value: n(t) }
                    )
                  )
                );
              },
      ...
      function tS(e) {
        return s.createElement(
          tC,
          tA({ invertTheme: !1, theme: U, hideRoot: !0 }, e)
        );
      }
      er(tC, "propTypes", {
        data: ea().any,
        hideRoot: ea().bool,
        theme: ea().oneOfType([ea().object, ea().string]),
        invertTheme: ea().bool,
        keyPath: ea().arrayOf(ea().oneOfType([ea().string, ea().number])),
        postprocessValue: ea().func,
        sortObjectKeys: ea().oneOfType([ea().func, ea().bool]),
      }),
        er(tC, "defaultProps", {
          ...
          getItemString: function (e, t, r, n) {
            return s.createElement("span", null, r, " ", n);
          },
      ...
      var tD = "._1p1dangw{text-transform:uppercase}",
        tO = "._1dyzt94y{letter-spacing:1px}",
        tM = "._k48p1nn1{font-weight:400}",
        tF = "._otyridpf{margin-bottom:0}",
        tT = function (e) {
          var t = e.children;
          return s.createElement(
            I,
            ...
            s.createElement(
              ...
              {
                className: P([
                  "_syaz1ds0 _ca0qidpf _u5f3idpf _n3tdidpf _19bvidpf _19pkidpf _2hwxidpf _otyridpf _18u0idpf _k48p1nn1 _1dyzt94y _1wybw1gv _1p1dangw _16jlkb7n",
                ]),
              },
              t
            )
        ...
        tz = function (e) {
          ...
          return s.createElement(
            I,
            null,
            s.createElement(L, null, ["._1e0c1txw{display:flex}"]),
            s.createElement("div", { className: P(["_1e0c1txw"]) }, t)
          );
        },
        tj = function (e) {
          var t = e.children,
          ...
          return s.createElement(
            ...
            null,
            s.createElement(L, null, [
              "._ca0qi2wt{padding-top:6px}",
              "._u5f319bv{padding-right:10px}",
              "._n3tdi2wt{padding-bottom:6px}",
              "._19bv19bv{padding-left:10px}",
              "._19pkyjp0{margin-top:-6px}",
              "._2hwx14id{margin-right:-10px}",
              tF,
              "._18u0ftgi{margin-left:8px}",
              tM,
              tO,
              "._1wyb1skh{font-size:11px}",
              "._syazryvq{color:rgba(205,214,244,.8)}",
              tD,
              "._v564111k{transition:background .3s,color .3s}",
              "._2rkoyh40{border-radius:2px}",
              "._19itglyw{border:none}",
              "._11q71j28{background:transparent}",
              "._irr31wye:hover{background-color:rgba(203,166,247,.4)}",
              "._30l35y2n:hover{color:#cdd6f4}",
              "._d0altlke:hover{cursor:pointer}",
              "._nt751r31:focus{outline-color:currentColor}",
              "._49pcglyw:focus{outline-style:none}",
              "._1hvw1o36:focus{outline-width:medium}",
              "._1di61emw:active{background-color:rgba(203,166,247,.6)}",
            ]),
            s.createElement(
              "button",
              {
                onClick: r,
                className: P([
                  "_ca0qi2wt _u5f319bv _n3tdi2wt _19bv19bv _19pkyjp0 _2hwx14id _otyridpf _18u0ftgi _k48p1nn1 _1dyzt94y _1wyb1skh _syazryvq _1p1dangw _v564111k _2rkoyh40 _19itglyw _11q71j28 _irr31wye _30l35y2n _d0altlke _nt751r31 _49pcglyw _1hvw1o36 _1di61emw",
                ]),
              },
              t
            )
        ...
        tN = w(function (e) {
          ...
          return n
            ? ((t = n.selection),
              ...
              t.empty
                ? (r = t.$from.marks())
                : n.doc.nodesBetween(t.from, t.to, function (e) {
                    r = r.concat(e.marks);
                  }),
              r
                .reduce(function (e, t) {
      ...
      function tL(e) {
        for (var t, r = e; !t && r; )
          r.pmViewDesc && (t = r), (r = r.parentNode);
        return t;
      }
      function tP(e, t) {
        (null == t || t > e.length) && (t = e.length);
      ...
      var t$ = function (e) {
        ...
        tU = function (e) {
          ...
          return s.createElement(
            ...
            null,
            s.createElement(L, null, [
              "._1ul9mgvx{min-width:180px}",
              "._vchhusvi{box-sizing:border-box}",
              "._129lrdoj+._129lrdoj{padding-top:9px}",
            ]),
            s.createElement(
              "div",
              { className: P(["_1ul9mgvx _vchhusvi _129lrdoj"]) },
              t
            )
          );
        },
        tJ = function (e) {
          ...
          return s.createElement(
            ...
            null,
            s.createElement(L, null, [
              "._19pkhage{margin-top:.5em}",
              "._2hwxidpf{margin-right:0}",
              "._otyrhage{margin-bottom:.5em}",
              "._18u01x4e{margin-left:1em}",
            ]),
            s.createElement(
              "div",
              { className: P(["_19pkhage _2hwxidpf _otyrhage _18u01x4e"]) },
              t
            )
          );
        },
        tW = function (e) {
          ...
          return s.createElement(
            I,
            null,
            s.createElement(L, null, ["._ca0qpd1z{padding-top:.25em}"]),
            s.createElement("div", { className: P(["_ca0qpd1z"]) }, t)
          );
        },
        tH = function (e) {
          var t = e.children;
          return s.createElement(
            ...
            s.createElement(L, null, [
              ...
              "._syazx4b6{color:#89dceb}",
              "._19pkidpf{margin-top:0}",
              "._2hwxhage{margin-right:.5em}",
            ...
            s.createElement(
              ...
              {
                className: P([
                  "_1e0c1o8l _syazx4b6 _19pkidpf _2hwxhage _otyridpf _18u0idpf",
                ]),
              },
              t
            )
        ...
        tV = function (e) {
          ...
          return s.createElement(
            I,
            null,
            s.createElement(L, null, ["._syazonp9{color:#fab387}"]),
            s.createElement("div", { className: P(["_syazonp9"]) }, t)
          );
        },
        tZ = function (e) {
          var t = e.children,
          ...
          return s.createElement(
            ...
            null,
            s.createElement(L, null, [
              "._syaz4yqd{color:rgba(205,214,244,.6)}",
            ...
            s.createElement(
              "button",
              {
                ...
                onClick: r,
                className: P([
                  "_syaz4yqd _11q7glyw _19itglyw _v564111k _2rko1l7b _d0altlke _irr31wye _30l35y2n _nt751r31 _49pcglyw _1hvw1o36",
                ]),
              },
              t
            )
      ...
      function tG(e, t, r, n) {
        return "Object" === e && t.type
          ? s.createElement("span", null, "{} ", t.type)
          : s.createElement("span", null, r, " ", n);
      }
      var tY = w(!1);
      function tK() {
        var e,
          ...
          ? s.createElement(
              ...
              s.createElement(
                ...
                s.createElement(
                  tz,
                  null,
                  s.createElement(tT, null, "Current Doc"),
                  s.createElement(
                    tj,
                    {
                      onClick: function () {
                ...
                s.createElement(tS, {
                  ...
                  getItemString:
                    ...
                    function (e, r, n, i) {
                      ...
                      return "Object" === e && r.type
                        ? s.createElement("span", null, "{} ", r.type, " ", o)
                        : s.createElement("span", null, n, " ", i, " ", o);
                    }),
                  shouldExpandNode: function (e) {
                    var t;
                    return (
                      (t = [].concat(e).reverse()),
                      !!a &&
              ...
              s.createElement(
                ...
                s.createElement(
                  ...
                  s.createElement(
                    tz,
                    null,
                    s.createElement(tT, null, "Selection"),
                    s.createElement(
                      tj,
                      {
                        onClick: function () {
                  ...
                  s.createElement(
                    ...
                    s.createElement(tS, {
                      data: n
                        ? eT(l.selection, eO, eM)
                        : eT(l.selection, eO.slice(0, 6)),
                      hideRoot: !0,
                    })
                  )
                ),
                s.createElement(
                  tU,
                  null,
                  s.createElement(tT, null, "Active Marks"),
                  s.createElement(
                    t$,
                    null,
                    o.length
                      ...
                      : s.createElement(
                          ...
                          s.createElement(
                            tW,
                            null,
                            s.createElement(tH, null, "no active marks")
                          )
                        )
                  )
                ),
                s.createElement(
                  tU,
                  null,
                  s.createElement(tT, null, "Document Stats"),
                  s.createElement(
                    tJ,
                    null,
                    s.createElement(
                      tW,
                      null,
                      s.createElement(tH, null, "nodeSize:"),
                      s.createElement(tV, null, l.doc.nodeSize)
                    ),
                    s.createElement(
                      tW,
                      null,
                      s.createElement(tH, null, "childCount:"),
                      s.createElement(tV, null, l.doc.childCount)
                    )
                  )
                )
              )
      ...
      var t1 = function () {},
        t2 = function (e) {
          ...
          return s.createElement(
            ...
            null,
            s.createElement(L, null, [
              "._11q7izeb{background:var(--_1k9t07z)}",
              "._19itglyw{border:none}",
              "._vchhusvi{box-sizing:border-box}",
              "._syazryvq{color:rgba(205,214,244,.8)}",
              "._1e0c1txw{display:flex}",
              "._ect4k7ds{font-family:monospace}",
              "._1wyb1skh{font-size:11px}",
              "._k48p1nn1{font-weight:400}",
              "._1dyzt94y{letter-spacing:1px}",
              "._19pkidpf{margin-top:0}",
              "._2hwxidpf{margin-right:0}",
              "._otyridpf{margin-bottom:0}",
              "._18u0idpf{margin-left:0}",
              "._1ul913i4{min-width:190px}",
              "._tzy4139p{opacity:var(--_yl51qy)}",
              "._ca0qi2wt{padding-top:6px}",
              "._u5f3f6fq{padding-right:18px}",
              "._n3tdi2wt{padding-bottom:6px}",
              "._19bvf6fq{padding-left:18px}",
              "._19bvnm8a{padding-left:var(--_1hdy39e)}",
              "._y3gn1e5h{text-align:left}",
              "._1p1dangw{text-transform:uppercase}",
              "._v5641y8x{transition:background .3s}",
              "._1bsb1osq{width:100%}",
              "._w41414jc+._w41414jc{border-top:1px solid rgba(203,166,247,.2)}",
              "._irr31wye:hover{background-color:rgba(203,166,247,.4)}",
              "._30l35y2n:hover{color:#cdd6f4}",
              "._d0altlke:hover{cursor:pointer}",
              "._nt751r31:focus{outline-color:currentColor}",
            ...
            s.createElement(
              "div",
              {
                "data-test-id": "__prosemirror_devtools_list_item".concat(
                  e.isDimmed ? "_inactive" : "",
                  "__"
                ),
                onClick: e.onClick,
                onDoubleClick: e.onDoubleClick,
                className: P([
                  "_11q7izeb _19itglyw _vchhusvi _syazryvq _1e0c1txw _ect4k7ds _1wyb1skh _k48p1nn1 _1dyzt94y _19pkidpf _2hwxidpf _otyridpf _18u0idpf _1ul913i4 _tzy4139p _ca0qi2wt _u5f3f6fq _n3tdi2wt _19bvf6fq _19bvnm8a _y3gn1e5h _1p1dangw _v5641y8x _1bsb1osq _w41414jc _irr31wye _30l35y2n _d0altlke _nt751r31 _49pcglyw _1hvw1o36 _1di61emw",
                ]),
                style: {
                  "--_1k9t07z": $(t),
                  "--_yl51qy": $(e.isDimmed ? 0.3 : 1),
                  "--_1hdy39e": $(e.nested ? "36px" : "18px"),
                },
              },
              e.children
            )
      ...
      function t5(e) {
        var t,
          ...
          y = e.onListItemClick,
          v = void 0 === y ? t1 : y,
          _ = e.onListItemDoubleClick,
          k = void 0 === _ ? t1 : _,
          w = e.customItemBackground;
        return s.createElement(
          "div",
          null,
          s.createElement(
            t2,
            {
              ...
              isSelected: o.some(h) && n,
              isPrevious: d(o[0], 0) && n,
              isDimmed: o.every(m),
              background: w,
            },
            s.createElement("div", { style: { flexGrow: 1 } }, l(o, 0)),
            s.createElement("div", null, n ? "▶" : "▼")
          ),
          s.createElement(
            I,
            null,
            s.createElement(L, null, ["._1e0crqpp{display:var(--_1a5yx7a)}"]),
            s.createElement(
              "div",
              {
                className: P(["_1e0crqpp"]),
                style: { "--_1a5yx7a": $(n ? "none" : "block") },
              },
              (o || []).map(function (e, t) {
                return s.createElement(
                  t2,
        ...
        return s.createElement(
          ...
          (e.items || []).map(function (t, n) {
            return Array.isArray(t)
              ? s.createElement(
                  t5,
                  tQ({}, e, { items: t, key: t[0].timestamp }),
                  (e.groupTitle || t1)(t, n)
                )
              : s.createElement(
                  t2,
                  {
                    ...
                    isPrevious: i(t, n),
                    isDimmed: a(t, n),
                    background: e.customItemBackground,
                    onClick: function () {
                      return h(t, n);
                    },
                    onDoubleClick: function () {
      ...
      var t4 = "._1tke1ar4{min-height:1ex}",
        t6 = "._azhwidpf{text-indent:0}",
        t8 = "._19bv1l7b{padding-left:3px}",
        t9 = "._n3tdyh40{padding-bottom:2px}",
        t7 = "._u5f31l7b{padding-right:3px}",
        re = "._ca0qt94y{padding-top:1px}",
        rt = "._bfhk7woi{background-color:rgba(205,214,244,.2)}",
        rr = "._1e0c1o8l{display:inline-block}",
        rn = function (e) {
          var t = e.children;
          return s.createElement(
            I,
            null,
            s.createElement(L, null, ["._syaz1u6e{color:#cba6f7}"]),
            s.createElement("span", { className: P(["_syaz1u6e"]) }, t)
          );
        },
        ri = function (e) {
          var t = e.children;
          return s.createElement(
            I,
            null,
            s.createElement(L, null, ["._syaz5y2n{color:#cdd6f4}"]),
            s.createElement("span", { className: P(["_syaz5y2n"]) }, t)
          );
        },
        ro = function (e) {
          var t = e.children;
          return s.createElement(
            ...
            s.createElement(
              ...
              {
                className: P([
                  "_1e0c1o8l _bfhk7woi _syaz7i12 _ca0qt94y _u5f31l7b _n3tdyh40 _19bv1l7b _azhwidpf _4bfu1r31 _1hms1911 _ajmmnqa1 _1tke1ar4",
                ]),
              },
              t
            )
        ...
        rs = function (e) {
          ...
          return s.createElement(
            ...
            s.createElement(
              ...
              {
                className: P([
                  "_1e0c1o8l _bfhk7woi _syazqv97 _ca0qt94y _u5f31l7b _n3tdyh40 _19bv1l7b _azhwidpf _1tke1ar4",
                ]),
              },
              t
            )
        ...
        return "string" == typeof e
          ...
          : (function (e) {
              ...
              return void 0 === t
                ? "undefined"
                : t.length > 22
                  ? "".concat(t.substr(0, 15), "…").concat(t.substr(-5))
                  : t;
            })(e);
      }
      function ru(e) {
        if (Array.isArray(e)) {
          if (1 === e.length) return s.createElement(rs, null, rc(e[0]));
          if (2 === e.length)
            return s.createElement(
              rn,
              null,
              s.createElement(ro, null, rc(e[0])),
              " =>",
              " ",
              s.createElement(rs, null, rc(e[1]))
            );
          if (3 === e.length && 0 === e[1] && 0 === e[2])
            return s.createElement(ro, null, rc(e[0]));
          if (3 === e.length && 2 === e[2])
            return s.createElement(
              rn,
              null,
              ...
              e[0]
                ...
                .map(function (e) {
                  return e.delete
                    ...
                    : e.add
                      ? s.createElement(rs, { key: e.add + "add" }, e.add)
                      : s.createElement(ri, { key: e.raw + "raw" }, e.raw);
                }),
              '"'
            );
        }
      ...
      var rd = function (e) {
          ...
          return s.createElement(
            ...
            null,
            s.createElement(L, null, [
              "._ca0q1vy9{padding-top:9px!important}",
              "._u5f3grf3{padding-right:0!important}",
              "._n3td1o4j{padding-bottom:18px!important}",
              ...
              "._18u0idpf{margin-left:0}",
              "._syazryvq{color:rgba(205,214,244,.8)}",
              "._key71u6e .prosemirror-dev-tools-highlighter-tag{color:#cba6f7}",
            ]),
            s.createElement(
              "pre",
              {
      ...
      function rk() {
              ...
              value:
                ...
                function (t, n) {
                  ...
                  for (o.method = t, o.arg = n; ; ) {
                    ...
                    if ("normal" === l.type) {
                      if (
                        ((s = o.done ? "completed" : "suspendedYield"),
                        l.arg === h)
                      )
                        continue;
                ...
                return new t(function (i, s) {
                  !(function n(i, o, s, a) {
                    ...
                    if ("throw" !== l.type) {
                      var c = l.arg,
                        h = c.value;
                      return h && "object" == r_(h) && r.call(h, "__await")
        ...
        return (
          ...
          (d.displayName = l(f, a, "GeneratorFunction")),
      ...
      function rx(e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = null != arguments[t] ? arguments[t] : {};
          t % 2
            ? rw(Object(r), !0).forEach(function (t) {
                rE(e, t, r[t]);
              })
            : Object.getOwnPropertyDescriptors
              ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
      ...
      var rO = w([]),
        ...
        rT = w(
          null,
          ((i = rk().mark(function e(t, r, n) {
            var i, o, s, a, l, c, u, h, p, d, f, m, g, b;
            return rk().wrap(function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 5:
                    ...
                    if (
                      ((i = t(rM)), (o = t(rO))[0].state !== n.payload.newState)
                    ) {
                      e.next = 10;
                      break;
                    }
                  ...
                  case 10:
                    var y;
                    if (
                      ((a = (s = n.payload).oldState),
                      (l = s.newState),
                      (c = s.tr),
                      (u = (function (e, t, r, n) {
                        if (!r.getMeta("_skip-dev-tools-history_")) {
                          var i = e.slice(null !== t ? t : 0, 200);
                          return (
                            i.unshift(
                              (function (e) {
                                var t = rv.PW.fromSchema(e.schema),
                                  r = e.selection,
                                  n = t.serializeFragment(r.content().content),
                                  i = [];
                                if (n)
                                  for (var o = n.firstChild; o; )
                                    i.push(o.outerHTML), (o = o.nextSibling);
                                return {
                                  id: ry()(),
                                  state: e,
                                  timestamp: Date.now(),
                                  ...
                                  diff: void 0,
                                  selection: void 0,
                                  selectionContent: (0, rg.prettyPrint)(
                                    i.join("\n"),
                                    { max_char: 60, indent_size: 2 }
                                  ),
                                };
                              })(n)
                            ),
                      ...
                      null !== i &&
                        ...
                        r(
                          ...
                          u.reduce(function (e, t) {
                            return (e[t.id] = h[t.id]), e;
                          }, {})
                        )),
                      (p = t(rF)),
                      (d = rC(u, 1)[0].id),
                      (e.next = 20),
                      n.payload.diffWorker
                    );
                  case 20:
                    return (
                      (f = e.sent),
                      (e.next = 23),
                      Promise.all([
                        f.diff({ a: a.doc.toJSON(), b: l.doc.toJSON(), id: d }),
                        f.diff({
                          a: rz(a.selection),
                          b: rz(l.selection),
                          id: d,
                  ...
                  case 23:
                    (g = (m = rC(e.sent, 2))[0].delta),
                      (b = m[1].delta),
                      r(
                        rF,
                        rx(rx({}, p), {}, rE({}, d, { diff: g, selection: b }))
                      );
                  case 28:
                  case "end":
                    return e.stop();
      ...
      function rq(e) {
        if (!e.selectionContent) return null;
        var t = Array.isArray(e.selectionContent)
          ? e.selectionContent.join("\n")
          : e.selectionContent;
        return s.createElement(
          rI,
          null,
          s.createElement(tT, null, "Selection Content"),
          s.createElement(rm, null, t)
        );
      }
      function rB(e) {
        return e.diff
          ? s.createElement(
              rI,
              null,
              s.createElement(tT, null, "Doc diff"),
              s.createElement(rp, { delta: e.diff })
            )
          : null;
      }
      function rL(e) {
        return e.selection
          ? s.createElement(
              rI,
              null,
              s.createElement(tT, null, "Selection diff"),
              s.createElement(rp, { delta: e.selection })
            )
          : null;
      }
      var rP = w(0);
      function r$(e) {
        var t,
          ...
          m = c
            ...
            .reduce(function (e, t) {
              return (
                Array.isArray(t) && 1 === t.length ? e.push(t[0]) : e.push(t), e
              );
            }, []);
        return s.createElement(
          ej,
          ...
          s.createElement(
            ...
            s.createElement(t3, {
              ...
              title: function (e) {
                return Array.isArray(e) ? rR(e[0].timestamp) : rR(e.timestamp);
              },
              groupTitle: function (e) {
                return Array.isArray(e)
                  ? rR(e[0].timestamp) + " [".concat(e.length, "]")
                  : rR(e.timestamp);
              },
              isSelected: function (e) {
                return !Array.isArray(e) && e.timestamp === p.timestamp;
              },
              isPrevious: function (e) {
                return !Array.isArray(e) && h && e.timestamp === h.timestamp;
              },
              isDimmed: function (e) {
                return !Array.isArray(e) && !!f && e.timestamp > f.timestamp;
              },
              customItemBackground: function (e) {
                return e.isSelected
                  ? J.main40
                  : e.isPrevious
                    ? J.main20
              ...
              onListItemClick: function (e) {
                Array.isArray(e) || a(e.index);
              },
              onListItemDoubleClick: function (e) {
                Array.isArray(e) || n(e, e.index);
              },
            })
          ),
          s.createElement(
            eI,
            { grow: !0, sep: !0 },
            s.createElement(rB, { diff: d }),
            s.createElement(rL, { selection: p.selection }),
            s.createElement(rq, { selectionContent: p.selectionContent }),
            !d &&
              !p.selectionContent &&
              s.createElement(tX, null, "Docs are equal.")
          )
        );
      }
      var rU = w(function (e) {
        ...
        rJ = ["schema", "contentExpr", "schema", "parseDOM", "toDOM"];
      function rW(e, t) {
        ...
        return e
          ? s.createElement(
              ...
              s.createElement(
                eI,
                { grow: !0 },
                s.createElement(tT, null, "Nodes"),
                s.createElement(tS, {
                  data: e.nodes,
                  postprocessValue: rW.bind(null, rJ),
                })
              ),
              s.createElement(
                eI,
                { grow: !0, sep: !0 },
                s.createElement(tT, null, "Marks"),
                s.createElement(tS, {
                  data: e.marks,
                  postprocessValue: rW.bind(null, rJ),
                })
      ...
      function rG(e) {
        return s.createElement(
          "div",
          null,
          s.createElement(tT, null, "Plugin State"),
          s.createElement(tS, { data: e.pluginState, valueRenderer: rZ })
        );
      }
      var rY = w(0);
      function rK() {
        ...
        return s.createElement(
          ...
          s.createElement(
            ...
            { grow: !0, sep: !0 },
            c
              ? s.createElement(rG, { pluginState: c })
              : s.createElement(tX, null, "Plugin doesn't have any state")
          )
        );
      }
      var rX = w(function (e) {
          var t = e(tI);
          return t
            ? Object.keys(t.schema.nodes).reduce(function (e, t, r) {
                var n,
                  i,
                  o =
                    r >= rQ.length
                      ? ((i = r / (n = rQ.length)),
                        Math.round(n * (i - Math.floor(i))))
                      : r;
                return (e[t] = rQ[o]), e;
              }, {})
            : {};
      ...
      var r1 = "._16jlkb7n{flex-grow:1}",
        r2 = "._o572qvpr{white-space:pre}",
        r5 = "._19bvi2wt{padding-left:6px}",
        r3 = "._n3td1l7b{padding-bottom:3px}",
        r4 = "._u5f3i2wt{padding-right:6px}",
        r6 = "._ca0q1l7b{padding-top:3px}",
        r8 = "._d0altlke:hover{cursor:pointer}",
        r9 = "._11q71iim{background:var(--_1d6dlof)}",
        r7 = "._otyr1l7b{margin-bottom:3px}",
        ne = "._1bsb1osq{width:100%}",
        nt = "._1e0c1txw{display:flex}",
        nr = "._1s7z104w{border-right:1px solid rgba(205,214,244,.2)}",
        nn = "._1kl7104w{border-left:1px solid rgba(205,214,244,.2)}",
        ni = "._vchhusvi{box-sizing:border-box}",
        no = "._19bv1crf{padding-left:9pt}",
        ns = "._n3tdidpf{padding-bottom:0}",
        na = "._u5f31crf{padding-right:9pt}",
        nl = "._ca0qidpf{padding-top:0}",
        nc = function (e) {
          var t = e.children;
          return s.createElement(
            I,
            null,
            s.createElement(L, null, ["._19pk1crf{margin-top:9pt}"]),
            s.createElement("div", { className: P(["_19pk1crf"]) }, t)
          );
        },
        nu = function (e) {
          var t = e.children;
          return s.createElement(
            I,
            null,
            s.createElement(L, null, [nl, na, ns, no, ni, nn, nr]),
            s.createElement(
              "div",
              {
                className: P([
                  "_ca0qidpf _u5f31crf _n3tdidpf _19bv1crf _vchhusvi _1kl7104w _1s7z104w",
                ]),
              },
              t
            )
        ...
        nh = function (e) {
          ...
          return s.createElement(
            ...
            s.createElement(
              ...
              {
                className: P([
                  "_ca0qidpf _u5f31crf _n3tdidpf _19bv1crf _1e0c1txw _1bsb1osq _vchhusvi _1kl7104w _1s7z104w _1n261g80",
                ]),
              },
              t
            )
        ...
        np = function (e) {
          ...
          return s.createElement(
            I,
            null,
            s.createElement(L, null, [ne, r7, ni, nt, r9, r8]),
            s.createElement(
              "div",
              {
                onClick: n,
                className: P([
                  "_1bsb1osq _otyr1l7b _vchhusvi _1e0c1txw _11q71iim _d0altlke",
                ]),
                style: { "--_1d6dlof": $(r) },
              },
              t
        ...
        nd = function (e) {
          ...
          return s.createElement(
            ...
            s.createElement(L, null, [
              ...
              r3,
              r5,
              "._bfhk1kix{background-color:hsla(0,0%,100%,.3)}",
            ]),
            s.createElement(
              "div",
              {
        ...
        nf = function (e) {
          ...
          return s.createElement(
            I,
            null,
            s.createElement(L, null, [r6, r4, r3, r5, r2]),
            s.createElement(
              "div",
              {
                className: P([
        ...
        nm = function (e) {
          ...
          return s.createElement(
            I,
            null,
            s.createElement(L, null, [r1]),
            s.createElement("div", { className: P(["_16jlkb7n"]) }, t)
          );
        },
        ng = function (e) {
          var t = e.children;
          return s.createElement(
            ...
            s.createElement(L, null, [
              r1,
              r6,
              "._u5f3rdoj{padding-right:9px}",
              r3,
              "._19bvrdoj{padding-left:9px}",
              r2,
            ]),
            s.createElement(
              "div",
              {
                className: P([
                  "_16jlkb7n _ca0q1l7b _u5f3rdoj _n3td1l7b _19bvrdoj _o572qvpr",
                ]),
              },
              t
            )
        ...
        nb = function (e) {
          ...
          return s.createElement(
            I,
            null,
            s.createElement(L, null, [r1, r7, nt, ni, r9, r8]),
            s.createElement(
              "div",
              {
                onClick: n,
                className: P([
                  "_16jlkb7n _otyr1l7b _1e0c1txw _vchhusvi _11q71iim _d0altlke",
                ]),
                style: { "--_1d6dlof": $(r) },
              },
              t
      ...
      function ny(e) {
        var t = e.content;
        if (!t || !t.content || !t.content.length) return null;
        var r = t.content;
        if (r[0].isBlock) {
          var n = e.startPos + 1;
          return s.createElement(
        ...
        return s.createElement(
          ...
          s.createElement(
            np,
            {
              bg: i,
              onClick: function () {
                return e.onNodeSelected({ node: r });
              },
            },
            n > 0 &&
              s.createElement(
                nd,
                {
                  tooltip: "Pos: "
                    .concat(n - 1, " (before ")
                    .concat(r.type.name, " opening tag)"),
                },
                n - 1
              ),
            s.createElement(nf, null, r.type.name, " ", o),
            s.createElement(
              nd,
              {
                tooltip: "Pos: "
            ...
            s.createElement(nm, null),
            s.createElement(
              nd,
              {
                tooltip: "Pos: "
                  .concat(n + r.nodeSize - 1, " (after ")
                  .concat(r.type.name, " closing tag)"),
              },
              n + r.nodeSize - 1
            )
          ),
      ...
      function n_(e) {
        ...
        return s.createElement(
          ...
          {
            onClick: function () {
              return e.onNodeSelected({ node: t });
            },
            bg: r,
          },
          0 === i
            ? s.createElement(
                nd,
                {
                  tooltip: "Pos: "
                    .concat(n, " (before ")
                    .concat(t.type.name, " opening tag)"),
                },
                n
              )
            : null,
          s.createElement(ng, null, t.type.name, " ", o),
          s.createElement(nm, null),
          s.createElement(
            nd,
            {
              tooltip: "Pos: "
                .concat(n + t.nodeSize, " (before ")
                .concat(t.type.name, " closing tag)"),
            },
            n + t.nodeSize
          )
        );
      ...
      function nw() {
        ...
        return s.createElement(
          ...
          s.createElement(
            eI,
            { sep: !0, minWidth: 200, maxWidth: 300 },
            s.createElement(
              tz,
              null,
              s.createElement(tT, null, "Node Info"),
              s.createElement(
                tj,
                {
                  onClick: function () {
      ...
      function nx(e) {
        return 1 === e.marks.length
          ? " - [".concat(e.marks[0].type.name, "]")
          : e.marks.length > 1
            ? " - [".concat(e.marks.length, " marks]")
            : "";
      }
      let nE = Symbol(),
        nC = Symbol();
      ...
      let nA = (e, t) => {
        ...
        nS = (e, t, r) => {
          do {
            let [n, ...i] = t,
              o = e.get(n);
            if ((o || ((o = [new WeakMap()]), e.set(n, o)), !i.length)) {
              o[1] = r;
              return;
            }
            (e = o[0]), (t = i);
        ...
        let n = {
          getItem: (n) => {
            ...
            let s = (e) => {
              ...
              a =
                null != (o = null == (i = e()) ? void 0 : i.getItem(n))
                  ? o
                  : null;
      ...
      var nM = (function (e, t, r = nO) {
        ...
        return (
          (i.onMount = (t) => {
            let i;
            if (
              (r.subscribe && ((i = r.subscribe(e, t)), t(n())), r.delayInit)
            ) {
              let e = n();
          ...
          w(
            (e) => e(i),
            (n, o, s) => {
              let a = "function" == typeof s ? s(n(i)) : s;
              return a === nE
                ? (o(i, t), r.removeItem(e))
                : (o(i, a), r.setItem(e, a));
            }
          )
        );
      })("prosemirror-dev-tools-snapshots", []);
      function nF(e, t) {
        return "save" === t.type
          ? [t.payload.snapshot].concat(e)
          : "delete" === t.type
            ? e.filter(function (e) {
                return e !== t.payload.snapshot;
              })
            : e;
      }
      function nT() {
      ...
      var nR = function (e) {
          ...
          return s.createElement(
            ...
            s.createElement(L, null, [
              ...
              "._1wyb1skh{font-size:11px}",
              "._syazryvq{color:rgba(205,214,244,.8)}",
              "._bfhk1ojv{background-color:rgba(205,214,244,.1)}",
              "._1p1dangw{text-transform:uppercase}",
              "._v564111k{transition:background .3s,color .3s}",
              "._2rkoyh40{border-radius:2px}",
              "._19itglyw{border:none}",
              "._1h5m1y44+._1h5m1y44{margin-left:4px}",
              "._irr31wye:hover{background-color:rgba(203,166,247,.4)}",
              "._30l35y2n:hover{color:#cdd6f4}",
              "._d0altlke:hover{cursor:pointer}",
              "._nt751r31:focus{outline-color:currentColor}",
            ...
            s.createElement(
              "button",
              {
                onClick: r,
                className: P([
                  "_ca0qi2wt _u5f319bv _n3tdi2wt _19bv19bv _k48p1nn1 _1dyzt94y _1wyb1skh _syazryvq _bfhk1ojv _1p1dangw _v564111k _2rkoyh40 _19itglyw _1h5m1y44 _irr31wye _30l35y2n _d0altlke _nt751r31 _49pcglyw _1hvw1o36 _1di61emw",
                ]),
              },
              t
            )
        ...
        nq = function (e) {
          ...
          return s.createElement(
            ...
            s.createElement(
              "div",
              { className: P(["_4t3i1tcg _vwz41tcg _1e0c1txw _1bsb1osq"]) },
              t
            )
          );
        },
        nB = function (e) {
          ...
          return s.createElement(
            I,
            null,
            s.createElement(L, null, ["._16jlkb7n{flex-grow:1}"]),
            s.createElement("div", { className: P(["_16jlkb7n"]) }, t)
          );
        };
      function nL(e) {
        ...
        return s.createElement(t3, {
          ...
          title: function (e) {
            return s.createElement(
              nq,
              null,
              s.createElement(nB, null, e.name),
              s.createElement(
                "div",
                null,
                s.createElement(
      ...
      function nP() {
        var e = nI(nT(), 2),
            ...
            function (e) {
              ...
              if (o && n) {
                var r = t.create({
                  schema: o.schema,
                  plugins: o.plugins,
                  doc: o.schema.nodeFromJSON(e.snapshot),
                });
                n.updateState(r),
                  a(r),
                  l({ type: "reset", payload: { state: n.state } });
              }
            },
            [n, o]
          ),
          u = s.useCallback(
            function (e) {
              r({ type: "delete", payload: { snapshot: e } });
            },
            [r]
          );
        return s.createElement(
      ...
      var n$ = function (e) {
        ...
        return s.createElement(
          ...
          null,
          s.createElement(L, null, [
            "._1wyb1osq{font-size:100%}",
            "._vwz4kb7n{line-height:1}",
            "._17hvidpf li+li{margin-top:0}",
            "._1mwnidpf li+li{margin-right:0}",
            "._eld4idpf li+li{margin-bottom:0}",
            "._1k0gidpf li+li{margin-left:0}",
          ]),
          s.createElement(
            "div",
            {
      ...
      function nJ(e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = null != arguments[t] ? arguments[t] : {};
          t % 2
            ? nU(Object(r), !0).forEach(function (t) {
                var n;
                (n = r[t]),
                  t in e
                    ? Object.defineProperty(e, t, {
            ...
            : Object.getOwnPropertyDescriptors
              ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
              : nU(Object(r)).forEach(function (t) {
                  Object.defineProperty(
                    e,
                    t,
                    Object.getOwnPropertyDescriptor(r, t)
      ...
      var nH = { top: 0, left: 0, width: 0, height: 0, active: !1 },
        nV = w(nH);
      function nZ() {
        var e,
          t =
          ...
          s = {
                  ...
                  var r = (function (e, t) {
                    var r = (function e(t, r, n) {
                      ...
                      return i && i.content
                        ? i.content
                            .map(function (r, i) {
                              return e([].concat(tq(t), ["content", i]), r, n);
                            })
                            .filter(function (e) {
                              return Array.isArray(e) && e.length;
                            })[0]
                    ...
                    if (r)
                      return r.reduce(function (e, t) {
                        return (
                          ("content" === t && "content" === e[e.length - 1]) ||
                            e.push(t),
                          e
                        );
                      }, []);
                  })(i.doc, i.doc.nodeAt(t.pmViewDesc.posAtStart));
                  if (!r) return;
                  o([]), o(r), s.deactivate();
                }
              }
            ...
            updatePosition: function (e) {
              ...
              if (
                t &&
                ((t.pmViewDesc.node && "doc" !== t.pmViewDesc.node.type.name) ||
                  t.pmViewDesc.mark)
              ) {
      ...
      var nY = "._kqswstnw{position:absolute}",
        nK = function (e) {
          var t = e.visible,
            r = e.width,
            n = e.height,
          ...
          return s.createElement(
            ...
            s.createElement(L, null, [
              ...
              "._154iidpf{top:0}",
              "._1ltvidpf{left:0}",
              "._bfhk1ghd{background-color:rgba(0,0,255,.3)}",
              "._1pbyhac1{z-index:99999}",
              "._80omtlke{cursor:pointer}",
              "._t9ecwcso{transform:translateX(var(--_1e5hqsa)) translateY(var(--_jp4btk))}",
              "._1e0c1ss5{display:var(--_1oddjb5)}",
              "._1bsb9tg7{width:var(--_1ea5ebz)}",
              "._4t3imry4{height:var(--_roksyz)}",
            ]),
            s.createElement("div", {
              className: P([
                "_kqswstnw _lcxvglyw _154iidpf _1ltvidpf _bfhk1ghd _1pbyhac1 _80omtlke _t9ecwcso _1e0c1ss5 _1bsb9tg7 _4t3imry4",
              ]),
              style: {
                "--_1e5hqsa": $(i, "px"),
                "--_jp4btk": $(o, "px"),
                "--_1oddjb5": $(t ? "block" : "none"),
                "--_1ea5ebz": $(r, "px"),
                "--_roksyz": $(n, "px"),
              },
            })
      ...
      function nX() {
        var e,
          ...
          o = s.useCallback(
            function (e) {
              i.updatePosition(e.target);
            },
            [i]
          ),
          a = s.useCallback(
            function (e) {
              e.preventDefault(), i.select(e.target), t("state");
            },
            [i]
          );
        return (
            ...
            function () {
              if (n.active)
                return (
                  ...
                  document.addEventListener("keydown", i.deactivate),
                  function () {
                    document.removeEventListener("mousemove", o),
                      document.removeEventListener("click", a),
                      document.removeEventListener("keydown", i.deactivate);
                  }
                );
            },
            [o, a, i, n.active]
      ...
      var nQ = function (e) {
        ...
        return s.createElement(
          ...
          s.createElement(L, null, [
            ...
            "._19itglyw{border:none}",
            "._2rko1l7b{border-radius:3px}",
            '._11q71d4i{background:var(--_1rzmv8e) url("data:image/png;base64,")}',
            "._1lrwmp9v{background-size:20px 20px}",
            "._12veglyw{background-repeat:none}",
            "._ouxl1qre{background-position:50% 50%}",
            "._irr34135:hover{background-color:rgba(203,166,247,.8)}",
            "._d0altlke:hover{cursor:pointer}",
          ]),
          s.createElement(
            "button",
            {
              onClick: n,
              className: P([
                "_r06hglyw _kqswstnw _1xi21y44 _154ismyl _1bsb1tcg _4t3i1tcg _19itglyw _2rko1l7b _11q71d4i _1lrwmp9v _12veglyw _ouxl1qre _irr34135 _d0altlke",
              ]),
              style: { "--_1rzmv8e": $(r ? J.main : J.main60) },
            },
            t
          )
        );
      ...
      var n1 = function (e) {
        ...
        return s.createElement(
          ...
          s.createElement(L, null, [
            ...
            "._154ismyl{top:-28px}",
            "._syazu67f{color:#fff}",
            "._bfhk1emw{background-color:rgba(203,166,247,.6)}",
            "._1wyb1crf{font-size:9pt}",
            "._vwz410yn{line-height:25px}",
            "._ca0qidpf{padding-top:0}",
            "._u5f3i2wt{padding-right:6px}",
            "._n3tdidpf{padding-bottom:0}",
            "._19bvi2wt{padding-left:6px}",
          ...
          s.createElement(
            "button",
            {
              onClick: r,
              className: P([
                "_r06hglyw _kqswstnw _1xi2zwfg _154ismyl _syazu67f _bfhk1emw _1wyb1crf _vwz410yn _ca0qidpf _u5f3i2wt _n3tdidpf _19bvi2wt _4t3i1tcg _1lrwmp9v _12veglyw _ouxl1qre _2rko1l7b _19itglyw _irr34135 _d0altlke",
              ]),
            },
            t
          )
      ...
      function n2() {
        var e,
          ...
          n = s.useCallback(
            function () {
              var e = prompt("Enter snapshot name", "" + Date.now());
              e &&
                r &&
                t({
                  type: "save",
        ...
        return s.createElement(n1, { onClick: n }, "Save snapshots");
      }
      function n5(e, t) {
        return (
          (function (e) {
        ...
        return s.createElement(
          ...
          s.createElement(
            "button",
            {
              ...
              onClick: r,
              className: P([
                "_11q7glyw _19itglyw _kqswstnw _1xi2idpf _syaz4yqd _1wybf6fq _d0altlke _irr33ch5 _30l35y2n _nt751r31 _49pcglyw _1hvw1o36",
              ]),
            },
            t
          )
      ...
      function n6(e) {
        var t = e.rollbackHistory,
          ...
          u = s.useCallback(function (e) {
            ...
            document.querySelector("html").style.marginBottom = "".concat(
              t,
              "px"
            );
          }, []),
          ...
          m = s.useCallback(
            function (e) {
              switch (e.index) {
                case "state":
                default:
                  return s.createElement(tK, null);
                case "history":
                  return s.createElement(r$, { rollbackHistory: t });
                case "plugins":
                  return s.createElement(rK, null);
                case "schema":
                  return s.createElement(rH, null);
                case "structure":
                  return s.createElement(nw, null);
                case "snapshots":
                  return s.createElement(nP, null);
              }
            },
            [t]
          ),
            ...
            function () {
              return s.createElement(
                ...
                s.createElement(L, null, [
                  ...
                  "._18m915vq{overflow-y:hidden}",
                  "._bfhk2l5j{background-color:#1e1e2e}",
                  "._ect4ixyu{font-family:Helvetica Neue,Calibri Light,Roboto,sans-serif}",
                  "._1wybw1gv{font-size:13px}",
                ]),
                s.createElement(
                  "div",
                  {
                    ...
                    className: P([
                      "_1bsb1osq _4t3i1osq _1reo15vq _18m915vq _bfhk2l5j _ect4ixyu _1wybw1gv",
                    ]),
                  },
                  s.createElement(n4, { onClick: f }, "\xd7"),
                  s.createElement(nQ, {
                    onClick: d.activate,
                    isActive: p.active,
                  }),
                  s.createElement(n2, null),
                  s.createElement(
                    eD,
                    { onSelect: c, selectedIndex: l },
                    s.createElement(
                      ex,
                      null,
                      s.createElement(eA, { index: "state" }, "State"),
                      s.createElement(eA, { index: "history" }, "History"),
                      s.createElement(eA, { index: "plugins" }, "Plugins"),
                      s.createElement(eA, { index: "schema" }, "Schema"),
                      s.createElement(eA, { index: "structure" }, "Structure"),
                      s.createElement(eA, { index: "snapshots" }, "Snapshots")
                    ),
                    s.createElement(eS, null, m)
                  )
                )
              );
            },
      ...
      function n9(e) {
        var t,
          ...
          h =
            ...
            (function (e, t) {
              if (e) {
                if ("string" == typeof e) return n8(e, t);
                var r = Object.prototype.toString.call(e).slice(8, -1);
                if (
                  ("Object" === r && e.constructor && (r = e.constructor.name),
                  "Map" === r || "Set" === r)
        ...
        s.useEffect(
          function () {
            if (p) {
              var e = f * window.innerHeight;
              document.querySelector("html").style.marginBottom = "".concat(
                e,
                "px"
              );
            } else document.querySelector("html").style.marginBottom = "";
          },
          [f, p]
        ),
          (n = e.diffWorker),
          ...
          (l = n
            ? r
                ...
                .then(r.bind(r, 76748))
                .then(function (e) {
                  return new e.JsonDiffWorker(n);
                })
            : r
                .e(5502)
                .then(r.bind(r, 5502))
                .then(function (e) {
                  return new e.JsonDiffMain();
                })),
          s.useEffect(
            function () {
              var e, t, r;
              a(m.state),
                i(m),
                o({ type: "reset", payload: { state: m.state } }),
                (e = function (e, t, r) {
                  a(r),
                    o({
                      type: "update",
                ...
                (t = (m._props.dispatchTransaction || m.dispatch).bind(m)),
                (r = function (r) {
                  var n = m.state;
                  t(r), e(r, n, m.state);
                }),
                m._props.dispatchTransaction
                  ? (m._props.dispatchTransaction = r)
                  : (m.dispatch = r);
            },
            [m, l]
          );
            ...
            function (e, t) {
              var r = nz.yy,
                ...
                i = r.create({
                  schema: n.schema,
                  plugins: n.plugins,
                  doc: n.schema.nodeFromJSON(n.doc.toJSON()),
                });
              m.updateState(i), m.dom.focus();
              var o = nz.Y1.fromJSON(m.state.doc, n.selection.toJSON()),
                s = m.state.tr
                  .setSelection(o)
                  .setMeta("addToHistory", !1)
                  .setMeta("_skip-dev-tools-history_", !0);
              m.dispatch(s), u(m.state), c(t);
            },
            [m]
          ));
        return p
          ? s.createElement(n6, { rollbackHistory: b })
          : s.createElement(W, { onClick: g });
      }
      var n7 = "__prosemirror-dev-tools__",
        ie = function (e, t) {
          var r,
            n =
              ((r = document.querySelector(".".concat(n7)))
                ? (a.unmountComponentAtNode(r), (r.innerHTML = ""))
                : (((r = document.createElement("div")).className = n7),
          ...
          return (
            a.render(
              s.createElement(n9, {
                editorView: e,
                diffWorker: null == t ? void 0 : t.diffWorker,
              }),
              n
            ),
            function () {
    ...
    12498: function (e, t, r) {
      ...
      function l(e, t, r = !1) {
        for (let n = e; n; n = "start" == t ? n.firstChild : n.lastChild) {
          if (n.isTextblock) return !0;
          if (r && 1 != n.childCount) break;
        }
        return !1;
      }
      function c(e) {
      ...
      function p(e, t, r) {
        let n,
          ...
          p,
          d;
        if (u.type.spec.isolating || h.type.spec.isolating) return !1;
        if (
          ((n = t.nodeBefore),
          (a = t.nodeAfter),
          (c = t.index()),
          n &&
            a &&
            n.type.compatibleContent(a.type) &&
            (!n.content.size && t.parent.canReplace(c - 1, c)
              ? (r &&
                  r(e.tr.delete(t.pos - n.nodeSize, t.pos).scrollIntoView()),
                !0)
              : !!(
                  t.parent.canReplace(c, c + 1) &&
                  (a.isTextblock || (0, i.Mn)(e.doc, t.pos))
                ) &&
                (r &&
                  r(
                    e.tr
          ...
          return !0;
        let f = t.parent.canReplace(t.index(), t.index() + 1);
        if (
          f &&
          (p = (d = u.contentMatchAt(u.childCount)).findWrapping(h.type)) &&
          d.matchType(p[0] || h.type).validEnd
        ) {
          if (r) {
            let n = t.pos + h.nodeSize,
              s = o.HY.empty;
            for (let e = p.length - 1; e >= 0; e--)
              s = o.HY.from(p[e].create(null, s));
            s = o.HY.from(u.copy(s));
            let a = e.tr.step(
                new i.FC(
                  t.pos - 1,
                  n,
              ...
              l = n + 2 * p.length;
            (0, i.Mn)(a.doc, l) && a.join(l), r(a.scrollIntoView());
          }
          return !0;
        }
        let m = s.Y1.findFrom(t, 1),
          g = m && m.$from.blockRange(m.$to),
          b = g && (0, i.k9)(g);
        if (null != b && b >= t.depth)
          return r && r(e.tr.lift(g, b).scrollIntoView()), !0;
        if (f && l(h, "start", !0) && l(u, "end")) {
          let n = u,
            s = [];
          for (; s.push(n), !n.isTextblock; ) n = n.lastChild;
          let a = h,
            l = 1;
          for (; !a.isTextblock; a = a.firstChild) l++;
          if (n.canReplace(n.childCount, n.childCount, a.content)) {
            if (r) {
              let n = o.HY.empty;
              for (let e = s.length - 1; e >= 0; e--)
                n = o.HY.from(s[e].copy(n));
              r(
                e.tr
                  .step(
                    new i.FC(
        ...
        return function (t, r) {
          ...
          return (
            ...
            (r &&
              r(
                t.tr.setSelection(
                  s.Bs.create(t.doc, e < 0 ? i.start(o) : i.end(o))
                )
              ),
            !0)
          );
      ...
      function g(e, t = null) {
        return function (r, n) {
          let { empty: i, $cursor: o, ranges: s } = r.selection;
          if (
            (i && !o) ||
            !(function (e, t, r) {
              for (let n = 0; n < t.length; n++) {
                let { $from: i, $to: o } = t[n],
                  s =
                    0 == i.depth && e.inlineContent && e.type.allowsMarkType(r);
                if (
                  (e.nodesBetween(i.pos, o.pos, (e) => {
                    if (s) return !1;
                    s = e.inlineContent && e.type.allowsMarkType(r);
                  }),
                  s)
                )
                  return !0;
          ...
          if (n) {
            if (o)
              n(
                e.isInSet(r.storedMarks || o.marks())
                  ? r.tr.removeStoredMark(e)
                  : r.tr.addStoredMark(e.create(t))
              );
            else {
              let i = !1,
                o = r.tr;
              for (let t = 0; !i && t < s.length; t++) {
                let { $from: n, $to: o } = s[t];
                i = r.doc.rangeHasMark(n.pos, o.pos, e);
              }
              for (let r = 0; r < s.length; r++) {
                let { $from: n, $to: a } = s[r];
                if (i) o.removeMark(n.pos, a.pos, e);
                else {
                  let r = n.pos,
                    i = a.pos,
                    s = n.nodeAfter,
      ...
      function b(...e) {
        return function (t, r, n) {
          for (let i = 0; i < e.length; i++) if (e[i](t, r, n)) return !0;
          return !1;
        };
      }
      let y = b(
          ...
          (e, t, r) => {
            let n = (function (e, t) {
              ...
              return r &&
                (t ? t.endOfTextblock("backward", e) : !(r.parentOffset > 0))
                ? r
                : null;
            })(e, r);
            if (!n) return !1;
            ...
            if (!a) {
              let r = n.blockRange(),
                o = r && (0, i.k9)(r);
              return (
                null != o && (t && t(e.tr.lift(r, o).scrollIntoView()), !0)
              );
            }
            let u = a.nodeBefore;
            if (!u.type.spec.isolating && p(e, a, t)) return !0;
            if (
              0 == n.parent.content.size &&
              (l(u, "end") || s.qv.isSelectable(u))
            ) {
              let r = (0, i.dR)(e.doc, n.before(), n.after(), o.p2.empty);
              if (r && r.slice.size < r.to - r.from) {
                if (t) {
                  ...
                  n.setSelection(
                    l(u, "end")
                      ? s.Y1.findFrom(
                          n.doc.resolve(n.mapping.map(a.pos, -1)),
                          -1
                        )
                      : s.qv.create(n.doc, a.pos - u.nodeSize)
                  ),
                    t(n.scrollIntoView());
                }
                return !0;
            ...
            return (
              !!u.isAtom &&
              a.depth == n.depth - 1 &&
              (t && t(e.tr.delete(a.pos - u.nodeSize, a.pos).scrollIntoView()),
              !0)
            );
          },
          (e, t, r) => {
            let { $head: n, empty: i } = e.selection,
              o = n;
            if (!i) return !1;
            if (n.parent.isTextblock) {
              if (r ? !r.endOfTextblock("backward", e) : n.parentOffset > 0)
                return !1;
              o = c(n);
            }
            let a = o && o.nodeBefore;
            return (
              !!(a && s.qv.isSelectable(a)) &&
              (t &&
                t(
                  e.tr
                    .setSelection(s.qv.create(e.doc, o.pos - a.nodeSize))
                    .scrollIntoView()
                ),
              !0)
            );
        ...
        v = b(
          ...
          (e, t, r) => {
            ...
            if (
              ...
              if (r && r.slice.size < r.to - r.from) {
                if (t) {
                  ...
                  n.setSelection(
                    l(c, "start")
                      ? s.Y1.findFrom(n.doc.resolve(n.mapping.map(a.pos)), 1)
                      : s.qv.create(n.doc, n.mapping.map(a.pos))
                  ),
                    t(n.scrollIntoView());
                }
                return !0;
            ...
            return (
              !!c.isAtom &&
              a.depth == n.depth - 1 &&
              (t && t(e.tr.delete(a.pos, a.pos + c.nodeSize).scrollIntoView()),
              !0)
            );
          },
          (e, t, r) => {
            ...
            return (
              ...
              (t &&
                t(
                  e.tr.setSelection(s.qv.create(e.doc, o.pos)).scrollIntoView()
                ),
              !0)
            );
          }
        ...
        _ = {
          Enter: b(
            (e, t) => {
              ...
              return (
                !!(r.parent.type.spec.code && r.sameParent(n)) &&
                (t && t(e.tr.insertText("\n").scrollIntoView()), !0)
              );
            },
            (e, t) => {
              ...
              if (
                ...
                return !1;
              let o = h(i.parent.contentMatchAt(i.indexAfter()));
              if (!o || !o.isTextblock) return !1;
              if (t) {
                let r = (
                    !n.parentOffset && i.index() < i.parent.childCount ? n : i
                  ).pos,
                  a = e.tr.insert(r, o.createAndFill());
                a.setSelection(s.Bs.create(a.doc, r + 1)),
                  t(a.scrollIntoView());
              }
              return !0;
            },
            (e, t) => {
              let { $cursor: r } = e.selection;
              if (!r || r.parent.content.size) return !1;
              if (r.depth > 1 && r.after() != r.end(-1)) {
                let n = r.before();
                if ((0, i.Ax)(e.doc, n))
                  return t && t(e.tr.split(n).scrollIntoView()), !0;
              }
              let n = r.blockRange(),
                o = n && (0, i.k9)(n);
              return (
            ...
            (e, t) => {
              ...
              if (e.selection instanceof s.qv && e.selection.node.isBlock)
                return (
                  !!(r.parentOffset && (0, i.Ax)(e.doc, r.pos)) &&
                  (t && t(e.tr.split(r.pos).scrollIntoView()), !0)
                );
              if (!r.parent.isBlock) return !1;
              if (t) {
                let a = o.parentOffset == o.parent.content.size,
                  l = e.tr;
                (e.selection instanceof s.Bs || e.selection instanceof s.C1) &&
                  l.deleteSelection();
                let c =
                    0 == r.depth
                      ? null
                      : h(r.node(-1).contentMatchAt(r.indexAfter(-1))),
                  u = n && n(o.parent, a),
                  p = u ? [u] : a && c ? [{ type: c }] : void 0,
                  d = (0, i.Ax)(l.doc, l.mapping.map(r.pos), 1, p);
                if (
                  (!p &&
                    !d &&
                    (0, i.Ax)(
                    ...
                    (c && (p = [{ type: c }]), (d = !0)),
                  d &&
                    (l.split(l.mapping.map(r.pos), 1, p),
                    !a && !r.parentOffset && r.parent.type != c))
                ) {
                  let e = l.mapping.map(r.before()),
                    t = l.doc.resolve(e);
                  c &&
                    r.node(-1).canReplaceWith(t.index(), t.index() + 1, c) &&
                    l.setNodeMarkup(l.mapping.map(r.before()), c);
                }
                t(l.scrollIntoView());
              }
              return !0;
          ...
          "Mod-Enter": (e, t) => {
            let { $head: r, $anchor: n } = e.selection;
            if (!r.parent.type.spec.code || !r.sameParent(n)) return !1;
            let i = r.node(-1),
              o = r.indexAfter(-1),
              a = h(i.contentMatchAt(o));
            if (!a || !i.canReplaceWith(o, o, a)) return !1;
            if (t) {
              let n = r.after(),
                i = e.tr.replaceWith(n, n, a.createAndFill());
              i.setSelection(s.Y1.near(i.doc.resolve(n), 1)),
                t(i.scrollIntoView());
            }
            return !0;
          },
          ...
          Delete: v,
          "Mod-Delete": v,
          "Mod-a": (e, t) => (t && t(e.tr.setSelection(new s.C1(e.doc))), !0),
        },
        k = {
          "Ctrl-h": _.Backspace,
    ...
    81093: function (e, t, r) {
      ...
      (n.prototype.append = function (e) {
        ...
        (n.prototype.map = function (e, t, r) {
        ...
        (n.from = function (e) {
          return e instanceof n ? e : e && e.length ? new i(e) : n.empty;
        });
      var i = (function (e) {
        function t(t) {
        ...
        return (
          ...
          (t.prototype.forEachInner = function (e, t, r, n) {
            for (var i = t; i < r; i++)
              if (!1 === e(this.values[i], n + i)) return !1;
          }),
          (t.prototype.forEachInvertedInner = function (e, t, r, n) {
            for (var i = t - 1; i >= r; i--)
              if (!1 === e(this.values[i], n + i)) return !1;
          }),
      ...
      var o = (function (e) {
          ...
          return (
            ...
            (t.prototype.forEachInner = function (e, t, r, n) {
              ...
              if (
                (t < i &&
                  !1 === this.left.forEachInner(e, t, Math.min(r, i), n)) ||
                (r > i &&
                  !1 ===
            ...
            (t.prototype.forEachInvertedInner = function (e, t, r, n) {
              ...
              if (
                ...
                (r < i &&
                  !1 ===
                    this.left.forEachInvertedInner(e, Math.min(t, i), r, n))
              )
                return !1;
            }),
      ...
      class l {
        ...
        popEvent(e, t) {
          ...
          t && (n = (r = this.remapping(s, this.items.length)).maps.length);
          let a = e.tr,
            u = [],
            h = [];
          return (
            this.items.forEach(
              (e, t) => {
                if (!e.step) {
                  r || (n = (r = this.remapping(s, t + 1)).maps.length),
                    n--,
                    h.push(e);
                  return;
                }
                if (r) {
                  h.push(new c(e.map));
                  let t = e.step.map(r.slice(n)),
                    i;
                  t &&
                    a.maybeStep(t).doc &&
                    ((i = a.mapping.maps[a.mapping.maps.length - 1]),
                    u.push(new c(i, void 0, void 0, u.length + h.length))),
                    n--,
                    i && r.appendMap(i, n);
                } else a.maybeStep(e.step);
                if (e.selection)
                  return (
                    (i = r ? e.selection.map(r.slice(n)) : e.selection),
                    (o = new l(
                      this.items.slice(0, s).append(h.reverse().concat(u)),
                      this.eventCount - 1
                    )),
                    !1
                  );
        ...
        addTransform(e, t, r, n) {
          var i, o;
          let s,
            a = [],
            u = this.eventCount,
            p = this.items,
            d = !n && p.length ? p.get(p.length - 1) : null;
          for (let r = 0; r < e.steps.length; r++) {
            let i = e.steps[r].invert(e.docs[r]),
              o = new c(e.mapping.maps[r], i, t),
              s;
            (s = d && d.merge(o)) &&
              ((o = s), r ? a.pop() : (p = p.slice(0, p.length - 1))),
              a.push(o),
              t && (u++, (t = void 0)),
              n || (d = o);
          }
        ...
        remapping(e, t) {
          ...
          return (
            this.items.forEach(
              (t, n) => {
                let i =
                  null != t.mirrorOffset && n - t.mirrorOffset >= e
        ...
        addMaps(e) {
          return 0 == this.eventCount
            ? this
            : new l(this.items.append(e.map((e) => new c(e))), this.eventCount);
        }
        rebased(e, t) {
          if (!this.eventCount) return this;
          let r = [],
            n = Math.max(0, this.items.length - t),
            i = e.mapping,
            o = e.steps.length,
            s = this.eventCount;
          ...
          this.items.forEach((t) => {
            ...
            let l = i.maps[n];
            if (t.step) {
              let o = e.steps[n].invert(e.docs[n]),
                u = t.selection && t.selection.map(i.slice(a + 1, n));
              u && s++, r.push(new c(l, o, u));
            } else r.push(new c(l));
          }, n);
          let u = [];
          for (let e = t; e < o; e++) u.push(new c(i.maps[e]));
          let h = new l(this.items.slice(0, n).append(u).append(r), s);
          return (
        ...
        compress(e = this.items.length) {
          ...
          return (
            this.items.forEach(
              (n, s) => {
                if (s >= e) i.push(n), n.selection && o++;
                else if (n.step) {
                  let e = n.step.map(t.slice(r)),
                    s = e && e.getMap();
                  if ((r--, s && t.appendMap(s, r), e)) {
                    let a = n.selection && n.selection.map(t.slice(r));
                    a && o++;
                    let l = new c(s.invert(), e, a),
                      u,
                      h = i.length - 1;
                    (u = i.length && i[h].merge(l)) ? (i[h] = u) : i.push(l);
                  }
                } else n.map && r--;
              },
              this.items.length,
            ...
            new l(n.from(i.reverse()), o)
          );
        }
      }
      l.empty = new l(n.empty, 0);
      class c {
        constructor(e, t, r, n) {
          (this.map = e),
            (this.step = t),
        ...
        merge(e) {
          if (this.step && e.step && !e.selection) {
            ...
            if (t) return new c(t.getMap().invert(), t, this.selection);
          }
        }
      }
      class u {
      ...
      function p(e) {
        let t = [];
        return e.forEach((e, r, n, i) => t.push(n, i)), t;
      }
      function d(e, t) {
        if (!e) return null;
        let r = [];
      ...
      function f(e, t, r, n) {
        let i = b(t),
          ...
          s = (n ? e.undone : e.done).popEvent(t, i);
        if (!s) return;
        let a = s.selection.resolve(s.transform.doc),
          ...
          c = new u(n ? l : s.remaining, n ? s.remaining : l, null, 0, -1);
        r(
          s.transform
            .setSelection(a)
            .setMeta(y, { redo: n, historyState: c })
            .scrollIntoView()
        );
      }
      let m = !1,
      ...
      let y = new a.H$("history"),
        v = new a.H$("closeHistory");
      function _(e = {}) {
        return (
          (e = {
            depth: e.depth || 100,
          ...
          new a.Sy({
            key: y,
            state: {
              init: () => new u(l.empty, l.empty, null, 0, -1),
              apply: (t, r, n) =>
                (function (e, t, r, n) {
                  let i = r.getMeta(y),
                    o;
                  if (i) return i.historyState;
                  r.getMeta(v) && (e = new u(e.done, e.undone, null, 0, -1));
                  let s = r.getMeta("appendedTransaction");
                  if (0 == r.steps.length) return e;
                  if (s && s.getMeta(y))
                    return s.getMeta(y).redo
                      ? new u(
                          e.done.addTransform(r, void 0, n, b(t)),
                          e.undone,
                          p(r.mapping.maps[r.steps.length - 1]),
                          e.prevTime,
                          e.prevComposition
                        )
                      : new u(
                          e.done,
                          e.undone.addTransform(r, void 0, n, b(t)),
                          null,
                          e.prevTime,
                          e.prevComposition
                        );
                  if (
                    ...
                    return (o = r.getMeta("rebased"))
                      ? new u(
                          e.done.rebased(r, o),
                          e.undone.rebased(r, o),
                          d(e.prevRanges, r.mapping),
                          e.prevTime,
                          e.prevComposition
                        )
                      : new u(
                  ...
                  {
                    let i = r.getMeta("composition"),
                      o =
                        0 == e.prevTime ||
                        (!s &&
                          e.prevComposition != i &&
                          (e.prevTime < (r.time || 0) - n.newGroupDelay ||
                            !(function (e, t) {
                              if (!t) return !1;
                              if (!e.docChanged) return !0;
                              let r = !1;
                              return (
                                e.mapping.maps[0].forEach((e, n) => {
            ...
            props: {
              handleDOMEvents: {
                beforeinput(e, t) {
                  let r = t.inputType,
                    n = "historyUndo" == r ? k : "historyRedo" == r ? w : null;
      ...
      let k = (e, t) => {
          let r = y.getState(e);
          return !!r && 0 != r.done.eventCount && (t && f(r, e, t, !1), !0);
        },
        w = (e, t) => {
          let r = y.getState(e);
          return !!r && 0 != r.undone.eventCount && (t && f(r, e, t, !0), !0);
        };
    },
    71307: function (e, t, r) {
      "use strict";
      r.d(t, {
        Hw: function () {
          return s;
              ...
              "string" == typeof t
                ? function (e, r, n, i) {
                    ...
                    if (r[1]) {
                      ...
                      let t = (n += e) - i;
                      t > 0 && ((o = r[0].slice(e - t, e) + o), (n = i));
                    }
                    return e.tr.insertText(o, n, i);
                  }
                : t),
            (this.undoable = !1 !== r.undoable),
      ...
      function s({ rules: e }) {
        let t = new n.Sy({
          state: {
            ...
            apply(e, t) {
              return (
                e.getMeta(this) || (e.selectionSet || e.docChanged ? null : t)
              );
            },
          },
          props: {
            handleTextInput: (r, n, i, o) => a(r, n, i, o, e, t),
            handleDOMEvents: {
              compositionend: (r) => {
                setTimeout(() => {
                  let { $cursor: n } = r.state.selection;
                  n && a(r, n.pos, n.pos, "", e, t);
                });
              },
            },
          },
      ...
      function a(e, t, r, n, i, o) {
        ...
        for (let c = 0; c < i.length; c++) {
          ...
          let h = u.match.exec(l),
            p = h && u.handler(s, h, t - (h[0].length - n.length), r);
          if (p)
            return (
              u.undoable &&
                p.setMeta(o, { transform: p, from: t, to: r, text: n }),
              e.dispatch(p),
              !0
            );
        }
      ...
      function l(e, t, r = null, n) {
        return new o(e, (e, o, s, a) => {
          let l = r instanceof Function ? r(o) : r,
            c = e.tr.delete(s, a),
      ...
      function c(e, t, r = null) {
        return new o(e, (e, n, i, o) => {
          let s = e.doc.resolve(i),
            a = r instanceof Function ? r(n) : r;
    ...
    88488: function (e, t, r) {
      ...
      for (
        ...
        n[48 + a] = n[96 + a] = String(a);
      for (var a = 1; a <= 24; a++) n[a + 111] = "F" + a;
      for (var a = 65; a <= 90; a++)
        (n[a] = String.fromCharCode(a + 32)), (i[a] = String.fromCharCode(a));
      for (var l in n) i.hasOwnProperty(l) || (i[l] = n[l]);
      var c = r(60314);
      let u =
        "undefined" != typeof navigator &&
        /Mac|iP(hone|[oa]d)/.test(navigator.platform);
            ...
            handleKeyDown:
                  ...
                  t[
                    (function (e) {
                      ...
                      for (let e = 0; e < o.length - 1; e++) {
                        ...
                        else if (/^mod$/i.test(s)) u ? (i = !0) : (r = !0);
              ...
              function (e, r) {
                      ...
                      (a =
                        (!(
                          (o &&
                            ...
                            !r.ctrlKey &&
                            !r.altKey) ||
                          (s && r.shiftKey && r.key && 1 == r.key.length) ||
                          "Unidentified" == r.key
                        ) &&
                          r.key) ||
                        (r.shiftKey ? i : n)[r.keyCode] ||
                        r.key ||
                ...
                if (1 == l.length && " " != l) {
                  if (r.shiftKey) {
                    let n = t[h(l, r, !1)];
                    if (n && n(e.state, e.dispatch, e)) return !0;
                  }
                  if (
                    (r.shiftKey ||
                      r.altKey ||
    ...
    55681: function (e, t, r) {
      ...
      let w = {};
      function x(e, t, r) {
        "string" != typeof t && ((r = t), (t = x.defaultChars)),
          void 0 === r && (r = !0);
        let n = (function (e) {
            let t = w[e];
            if (t) return t;
      ...
      (A.prototype.parse = function (e, t) {
        ...
        let a = o.indexOf("#");
        -1 !== a && ((this.hash = o.substr(a)), (o = o.slice(0, a)));
        let l = o.indexOf("?");
        return (
          -1 !== l && ((this.search = o.substr(l)), (o = o.slice(0, l))),
          o && (this.pathname = o),
          I[r] && this.hostname && !this.pathname && (this.pathname = ""),
          this
        );
      }),
        ...
        return function (t, r) {
          ...
          for (; (o = t.indexOf("&", o)) >= 0; ) {
            if (
              ...
              (i = o),
              (o += 1),
              t.charCodeAt(o) === c.NUM)
            ) {
              let e = o + 1,
                s = 10,
                a = t.charCodeAt(e);
              (a | c.To_LOWER_BIT) === c.LOWER_X &&
                ((s = 16), (o += 1), (e += 1));
              do a = t.charCodeAt(++o);
              while (
                (a >= c.ZERO && a <= c.NINE) ||
                (16 === s &&
                  (a | c.To_LOWER_BIT) >= c.LOWER_A &&
                  (a | c.To_LOWER_BIT) <= c.LOWER_F)
              );
              if (e !== o) {
                let a = parseInt(t.substring(e, o), s);
                if (t.charCodeAt(o) === c.SEMI) o += 1;
                else if (r) continue;
                (n += (function (e) {
                  var t;
                  return H(
                    (e >= 55296 && e <= 57343) || e > 1114111
                      ? 65533
                      : null !== (t = W.get(e)) && void 0 !== t
                        ? t
                        : e
                  );
                })(a)),
            ...
            for (
              ...
              !(
                (l = (function (e, t, r, n) {
                  ...
                  return -1;
                })(e, h, l + 1, t.charCodeAt(o))) < 0
              );
              o++, a++
            ) {
              let n = (h = e[l]) & u.VALUE_LENGTH;
              if (n) {
                (r && t.charCodeAt(o) !== c.SEMI) || ((s = l), (a = 0));
                let e = (n >> 14) - 1;
                if (0 === e) break;
                l += e;
              }
            ...
            if (0 !== s) {
              let t = (e[s] & u.VALUE_LENGTH) >> 14;
              (n +=
                1 === t
                  ? String.fromCharCode(e[s] & ~u.VALUE_LENGTH)
                  : 2 === t
                    ? String.fromCharCode(e[s + 1])
                    : String.fromCharCode(e[s + 1], e[s + 2])),
                (i = o - a + 1);
            }
          }
          return n + t.slice(i);
      ...
      ((n = c || (c = {}))[(n.NUM = 35)] = "NUM"),
        ...
        (n[(n.To_LOWER_BIT = 32)] = "To_LOWER_BIT"),
      ...
      let ei = /\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g,
        eo = RegExp(
          ei.source + "|" + /&([a-z#][a-z0-9]{1,31});/gi.source,
          "gi"
        ),
        es = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))$/i;
      function ea(e) {
        return 0 > e.indexOf("\\") ? e : e.replace(ei, "$1");
      }
      function el(e) {
        return 0 > e.indexOf("\\") && 0 > e.indexOf("&")
          ? e
          : e.replace(eo, function (e, t, r) {
              return (
                t ||
                (function (e, t) {
                  if (35 === t.charCodeAt(0) && es.test(t)) {
                    let r =
                      "x" === t[1].toLowerCase()
      ...
      function ed(e) {
        return ec.test(e) ? e.replace(eu, ep) : e;
      }
      let ef = /[.?*+^$[\]\\(){}|-]/g;
      function em(e) {
        return e.replace(ef, "\\$&");
      ...
      function ex(e, t, r) {
        ...
        if (60 === e.charCodeAt(i)) {
          for (i++; i < r && 10 !== (n = e.charCodeAt(i)) && 60 !== n; ) {
            if (62 === n) {
              (o.pos = i + 1), (o.str = el(e.slice(t + 1, i))), (o.ok = !0);
              break;
            }
            if (92 === n && i + 1 < r) {
              i += 2;
        ...
        return (
          t === i ||
            0 !== s ||
            ((o.str = el(e.slice(t, i))), (o.pos = i), (o.ok = !0)),
          o
        );
      }
      function eE(e, t, r, n) {
        ...
        for (; o < r; ) {
          if ((i = e.charCodeAt(o)) === s.marker)
            return (
              (s.pos = o + 1), (s.str += el(e.slice(t, o))), (s.ok = !0), s
            );
          if (40 === i && 41 === s.marker) return s;
          92 === i && o + 1 < r && o++, o++;
        }
        return (s.can_continue = !0), (s.str += el(e.slice(t, o))), s;
      }
      let eC = {};
      function eA() {
        this.rules = ee({}, eC);
      ...
      (eC.code_inline = function (e, t, r, n, i) {
        let o = e[t];
        return "<code" + i.renderAttrs(o) + ">" + ed(o.content) + "</code>";
      }),
        (eC.code_block = function (e, t, r, n, i) {
          let o = e[t];
          return (
            "<pre" +
            i.renderAttrs(o) +
        ...
        (eC.fence = function (e, t, r, n, i) {
          let o;
          let s = e[t],
            a = s.info ? el(s.info).trim() : "",
            l = "",
            c = "";
          if (a) {
            let e = a.split(/(\s+)/g);
          ...
          if (
            0 ===
            (o =
              (r.highlight && r.highlight(s.content, l, c)) ||
              ed(s.content)).indexOf("<pre")
          )
            return o + "\n";
          if (a) {
            ...
            return (
              e < 0
                ...
                : ((t[e] = t[e].slice()), (t[e][1] += " " + r.langPrefix + l)),
...
`;
        ...
        (eC.hardbreak = function (e, t, r) {
          return r.xhtmlOut ? "<br />\n" : "<br>\n";
        }),
        (eC.softbreak = function (e, t, r) {
          return r.breaks ? (r.xhtmlOut ? "<br />\n" : "<br>\n") : "\n";
        }),
        (eC.text = function (e, t) {
          return ed(e[t].content);
        }),
        (eC.html_block = function (e, t) {
          return e[t].content;
        }),
        (eC.html_inline = function (e, t) {
          return e[t].content;
        }),
        (eA.prototype.renderAttrs = function (e) {
          let t, r, n;
          if (!e.attrs) return "";
          for (t = 0, n = "", r = e.attrs.length; t < r; t++)
            n += " " + ed(e.attrs[t][0]) + '="' + ed(e.attrs[t][1]) + '"';
          return n;
        }),
        (eA.prototype.renderToken = function (e, t, r) {
          let n = e[t],
            i = "";
          if (n.hidden) return "";
          n.block && -1 !== n.nesting && t && e[t - 1].hidden && (i += "\n"),
            (i +=
              (-1 === n.nesting ? "</" : "<") + n.tag + this.renderAttrs(n)),
        ...
        (eA.prototype.renderInline = function (e, t, r) {
          let n = "",
            i = this.rules;
        ...
        (eA.prototype.renderInlineAsText = function (e, t, r) {
          let n = "";
        ...
        (eA.prototype.render = function (e, t, r) {
          let n = "",
            i = this.rules;
          for (let o = 0, s = e.length; o < s; o++) {
            let s = e[o].type;
        ...
        (eS.prototype.at = function (e, t, r) {
        ...
        (eS.prototype.before = function (e, t, r, n) {
        ...
        (eS.prototype.after = function (e, t, r, n) {
          let i = this.__find__(e);
          if (-1 === i) throw Error("Parser rule not found: " + e);
        ...
        (eS.prototype.push = function (e, t, r) {
          this.__rules__.push({
            name: e,
            enabled: !0,
            fn: t,
              ...
              for (let i = 0, o = t.length; i < o; i++) {
                ...
                for (let a = o.length - 1; a >= 0; a--) {
                  ...
                  if ("link_close" === l.type) {
                    for (
                      a--;
                      o[a].level !== l.level && "link_open" !== o[a].type;
                    )
                      a--;
                    continue;
                  }
                  ...
                  if (
                    ...
                    for (let t = 0; t < n.length; t++) {
                      ...
                      let a = n[t].text;
                      a = n[t].schema
                        ? "mailto:" !== n[t].schema || /^mailto:/i.test(a)
                      ...
                      if (l > u) {
                        ...
                        (t.content = r.slice(u, l)), (t.level = c), s.push(t);
                      }
                      ...
                      (p.content = a), (p.level = c), s.push(p);
                      let d = new e.Token("link_close", "a", -1);
                      (d.level = --c),
                        (d.markup = "linkify"),
                        (d.info = "auto"),
                        s.push(d),
                    ...
                    if (u < r.length) {
                      let t = new e.Token("text", "", 0);
                      (t.content = r.slice(u)), (t.level = c), s.push(t);
                    }
                    t[i].children = o = et(o, a, s);
                  }
                }
              }
          },
                    ...
                    for (let i = 0; i < e.length; i++) {
                      ...
                      e: for (; l < c; ) {
                        ...
                        let g = ev(f) || ey(String.fromCharCode(f)),
                          b = ev(m) || ey(String.fromCharCode(m)),
                          y = eb(f),
                          v = eb(m);
                        if (
                          (v ? (h = !1) : b && !(y || g) && (h = !1),
                          ...
                          d && (o.content = eB(o.content, u.index, "’"));
                          continue;
                        }
                        if (p)
                          for (r = n.length - 1; r >= 0; r--) {
                            ...
                            if (h.single === d && n[r].level === s) {
                              ...
                              (h = n[r]),
                                ...
                                (o.content = eB(o.content, u.index, p)),
                                (e[h.token].content = eB(
                                  e[h.token].content,
                                  h.pos,
                                  s
                                )),
                                (l += p.length - 1),
                                h.token === i && (l += s.length - 1),
                                (c = (a = o.content).length),
                                (n.length = r);
                              continue e;
                            }
                          }
                        h
                          ...
                          : p && d && (o.content = eB(o.content, u.index, "’"));
                      }
                    }
        ...
        for (; n < r; )
          124 === i &&
            (o
              ...
              : (t.push(a + e.substring(s, n)), (a = ""), (s = n + 1))),
            (o = 92 === i),
            n++,
            (i = e.charCodeAt(n));
      ...
      function eH(e, t) {
        ...
        return i < n && !eg((o = e.src.charCodeAt(i))) ? -1 : i;
      }
      (eP.prototype.process = function (e) {
        let t = this.ruler.getRules("");
        for (let r = 0, n = t.length; r < n; r++) t[r](e);
      }),
        (eP.prototype.State = eO),
        ...
        (e$.prototype.skipSpacesBack = function (e, t) {
          if (e <= t) return e;
          for (; e > t; ) if (!eg(this.src.charCodeAt(--e))) return e + 1;
          return e;
        }),
        ...
        (e$.prototype.skipCharsBack = function (e, t, r) {
          if (e <= r) return e;
          for (; e > r; ) if (t !== this.src.charCodeAt(--e)) return e + 1;
          return e;
        }),
        (e$.prototype.getLines = function (e, t, r, n) {
          if (e >= t) return "";
          let i = Array(t - e);
          for (let o = 0, s = e; s < t; s++, o++) {
            ...
            for (
              ...
              if (eg(e)) 9 === e ? (a += 4 - ((a + this.bsCount[s]) % 4)) : a++;
              else if (c - l < this.tShift[s]) a++;
              else break;
              c++;
            }
            a > r
              ? (i[o] = Array(a - r + 1).join(" ") + this.src.slice(c, e))
              : (i[o] = this.src.slice(c, e));
          }
          return i.join("");
        }),
        (e$.prototype.Token = eD);
      let eV =
        ...
        eX = [
          [
            ...
            function (e, t, r, n) {
              ...
              if ((124 !== a && 45 !== a && 58 !== a) || s >= e.eMarks[o])
                return !1;
              let l = e.src.charCodeAt(s++);
              if (
                (124 !== l && 45 !== l && 58 !== l && !eg(l)) ||
                (45 === a && eg(l))
              )
                return !1;
              for (; s < e.eMarks[o]; ) {
                let t = e.src.charCodeAt(s);
                if (124 !== t && 45 !== t && 58 !== t && !eg(t)) return !1;
                s++;
              }
              let c = eU(e, t + 1),
                u = c.split("|"),
              ...
              if (
                -1 === (c = eU(e, t).trim()).indexOf("|") ||
                e.sCount[t] - e.blkIndent >= 4
              )
                return !1;
              (u = eJ(c)).length && "" === u[0] && u.shift(),
          ...
          [
            ...
            function (e, t, r, n) {
              ...
              for (
                ;
                !(++h >= r) &&
                (!((i = a = e.bMarks[h] + e.tShift[h]) < (o = e.eMarks[h])) ||
              ...
              (l = e.sCount[t]), (e.line = h + (p ? 1 : 0));
              let d = e.push("fence", "code", 0);
              return (
                (d.info = u),
                (d.content = e.getLines(t + 1, h, l, !0)),
                (d.markup = c),
                (d.map = [t, e.line]),
                !0
              );
                ...
                if (62 === e.src.charCodeAt(o++) && !t) {
                  ...
                  32 === e.src.charCodeAt(o)
                    ...
                    : 9 === e.src.charCodeAt(o)
                      ...
                      : (t = !1);
                  let a = n;
                  for (l.push(e.bMarks[i]), e.bMarks[i] = o; o < s; ) {
                    let t = e.src.charCodeAt(o);
                    if (eg(t))
                      9 === t
                        ? (a += 4 - ((a + e.bsCount[i] + (r ? 1 : 0)) % 4))
                        : a++;
                    else break;
                    o++;
                  }
                  (f = o >= s),
                    c.push(e.bsCount[i]),
                    (e.bsCount[i] = e.sCount[i] + 1 + (t ? 1 : 0)),
                    u.push(e.sCount[i]),
                    (e.sCount[i] = a - n),
                    h.push(e.tShift[i]),
            ...
            function (e, t, r, n) {
              ...
              if (
                ...
                if (
                  ...
                  (c = Number(e.src.slice(s, u - 1))),
                  d && 1 !== c)
                )
                  return !1;
              } else {
                if (!((u = eW(e, h)) >= 0)) return !1;
                l = !1;
              }
              if (d && e.skipSpaces(u) >= e.eMarks[h]) return !1;
              if (n) return !0;
              ...
              let b = !1,
                y = e.md.block.ruler.getRules("list"),
                v = e.parentType;
              for (e.parentType = "list"; h < r; ) {
                let t;
                (o = u), (i = e.eMarks[h]);
                let n = e.sCount[h] + u - (e.bMarks[h] + e.tShift[h]),
                  c = n;
                for (; o < i; ) {
                  let t = e.src.charCodeAt(o);
                  if (9 === t) c += 4 - ((c + e.bsCount[h]) % 4);
                  else if (32 === t) c++;
                  else break;
                  o++;
                }
                ...
                let g = [h, 0];
                (a.map = g), l && (a.info = e.src.slice(s, u - 1));
                let v = e.tight,
                  _ = e.tShift[h],
                  k = e.sCount[h],
                  w = e.listIndent;
                if (
                  ...
                  (!e.tight || b) && (p = !1),
                  (b = e.line - h > 1 && e.isEmpty(e.line - 1)),
          ...
          [
            ...
            function (e, t, r, n) {
              ...
              for (o = 1; o < s; o++) {
                ...
                if (10 === e) {
                  let e = l(a);
                  null !== e && ((c += e), (s = c.length), a++);
                } else if (92 === e && ++o < s && 10 === c.charCodeAt(o)) {
                  let e = l(a);
                  null !== e && ((c += e), (s = c.length), a++);
                }
              }
              ...
              let h = e.md.helpers.parseLinkDestination(c, o, s);
              if (!h.ok) return !1;
              ...
              let g = e.md.helpers.parseLinkTitle(c, o, s);
              for (; g.can_continue; ) {
                let t = l(a);
                if (null === t) break;
                (c += t),
              ...
              for (
                o < s && m !== o && g.ok
                  ? ((i = g.str), (o = g.pos))
                  : ((i = ""), (o = d), (a = f));
                o < s && eg(c.charCodeAt(o));
              )
                o++;
              if (o < s && 10 !== c.charCodeAt(o) && i)
                for (i = "", o = d, a = f; o < s && eg(c.charCodeAt(o)); ) o++;
              if (o < s && 10 !== c.charCodeAt(o)) return !1;
              let b = e_(c.slice(1, u));
              return (
                !!b &&
                (!!n ||
                  (void 0 === e.env.references && (e.env.references = {}),
                  void 0 === e.env.references[b] &&
                    (e.env.references[b] = { title: i, href: p }),
                  (e.line = a),
                  !0))
              );
            },
          ...
          [
            ...
            function (e, t, r, n) {
              ...
              let s = e.src.slice(i, o),
                a = 0;
              for (; a < eK.length && !eK[a][0].test(s); a++);
              if (a === eK.length) return !1;
              if (n) return eK[a][2];
              let l = t + 1;
              if (!eK[a][1].test(s)) {
          ...
          [
            ...
            function (e, t, r, n) {
              ...
              let a = 1;
              for (s = e.src.charCodeAt(++i); 35 === s && i < o && a <= 6; )
                a++, (s = e.src.charCodeAt(++i));
              if (a > 6 || (i < o && !eg(s))) return !1;
              if (n) return !0;
              o = e.skipSpacesBack(o, i);
              let l = e.skipCharsBack(o, 35, i);
              l > i && eg(e.src.charCodeAt(l - 1)) && (o = l), (e.line = t + 1);
              let c = e.push("heading_open", "h" + String(a), 1);
              (c.markup = "########".slice(0, a)), (c.map = [t, e.line]);
              let u = e.push("inline", "", 0);
              return (
                (u.content = e.src.slice(i, o).trim()),
                (u.map = [t, e.line]),
                (u.children = []),
          ...
          [
            ...
            function (e, t, r) {
              let n;
              let i = e.md.block.ruler.getRules("paragraph");
              if (e.sCount[t] - e.blkIndent >= 4) return !1;
              let o = e.parentType;
              ...
              e.line = a + 1;
              let c = e.push("heading_open", "h" + String(s), 1);
          ...
          [
            ...
            function (e, t, r) {
              ...
              let s = e.getLines(t, o, e.blkIndent, !1).trim();
              (e.line = o),
      ...
      (eQ.prototype.tokenize = function (e, t, r) {
        ...
        (eQ.prototype.parse = function (e, t, r, n) {
          if (!e) return;
          let i = new this.State(e, t, r, n);
          this.tokenize(i, i.line, i.lineMax);
        }),
        (eQ.prototype.State = e$),
        (e0.prototype.pushPending = function () {
          let e = new eD("text", "", 0);
          return (
        ...
        (e0.prototype.push = function (e, t, r) {
        ...
        (e0.prototype.scanDelims = function (e, t) {
          let r = this.posMax,
          ...
          let s = o - e,
            a = o < r ? this.src.charCodeAt(o) : 32,
        ...
        (e0.prototype.Token = eD);
      let e1 = /(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i,
        e2 = [];
      for (let e = 0; e < 256; e++) e2.push(0);
      function e5(e, t) {
        let r;
        let n = [],
          i = t.length;
      ...
      var e3 = {
        ...
        postProcess: function (e) {
          ...
          e5(e, e.delimiters);
          for (let n = 0; n < r; n++)
            t[n] && t[n].delimiters && e5(e, t[n].delimiters);
        },
      };
      function e4(e, t) {
        let r = t.length;
      ...
      var e6 = {
        ...
        postProcess: function (e) {
          ...
          e4(e, e.delimiters);
          for (let n = 0; n < r; n++)
            t[n] && t[n].delimiters && e4(e, t[n].delimiters);
        },
      };
      let e8 =
          /^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/,
        e9 = /^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/,
        e7 = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,
      ...
      function tt(e) {
        ...
        for (let s = 0; s < r; s++) {
          ...
          let a = t[r.marker][(r.open ? 3 : 0) + (r.length % 3)],
            l = n - o[n] - 1,
            c = l;
          for (; l > a; l -= o[l] + 1) {
            let t = e[l];
      ...
      let tr = [
          ...
          [
            ...
            function (e, t) {
              ...
              for (r++; r < i && eg(e.src.charCodeAt(r)); ) r++;
              return (e.pos = r), !0;
            },
          ],
          [
            ...
            function (e, t) {
              ...
              if (!t) {
                ...
                i < 256 && 0 !== e2[i] ? (t.content = o) : (t.content = s),
                  (t.markup = s),
                  (t.info = "escape");
              }
              return (e.pos = r + 1), !0;
          ...
          [
            ...
            function (e, t) {
              ...
              let l = n;
              for (; -1 !== (r = e.src.indexOf("`", l)); ) {
                for (l = r + 1; l < o && 96 === e.src.charCodeAt(l); ) l++;
                let i = l - r;
                if (i === a) {
                  if (!t) {
          ...
          ["strikethrough", e3.tokenize],
          ["emphasis", e6.tokenize],
          [
            "link",
            function (e, t) {
              let r, n, i, o;
              ...
              let u = e.pos,
                h = e.posMax,
                p = e.pos + 1,
                d = e.md.helpers.parseLinkLabel(e, e.pos, !0);
              if (d < 0) return !1;
              let f = d + 1;
              if (f < h && 40 === e.src.charCodeAt(f)) {
                for (
                  c = !1, f++;
                  f < h && (eg((r = e.src.charCodeAt(f))) || 10 === r);
                  f++
                );
                if (f >= h) return !1;
                if (
                ...
                (f >= h || 41 !== e.src.charCodeAt(f)) && (c = !0), f++;
              }
              if (c) {
                if (void 0 === e.env.references) return !1;
                if (
                  (f < h && 91 === e.src.charCodeAt(f)
                    ? ((l = f + 1),
          ...
          [
            ...
            function (e, t) {
              ...
              if (f < 0) return !1;
              if ((o = f + 1) < p && 40 === e.src.charCodeAt(o)) {
                for (
                  o++;
                  o < p && (eg((r = e.src.charCodeAt(o))) || 10 === r);
                  o++
                );
                if (o >= p) return !1;
                for (
                  c = o,
                    (a = e.md.helpers.parseLinkDestination(e.src, o, e.posMax))
                      .ok &&
                      ((u = e.md.normalizeLink(a.str)),
                      e.md.validateLink(u) ? (o = a.pos) : (u = "")),
                    c = o;
                  o < p && (eg((r = e.src.charCodeAt(o))) || 10 === r);
                  o++
                );
                if (
                  ((a = e.md.helpers.parseLinkTitle(e.src, o, e.posMax)),
                  o < p && c !== o && a.ok)
                )
                  for (
                    l = a.str, o = a.pos;
        ...
        tn = [
          [
            ...
            function (e) {
              ...
              tt(e.delimiters);
              for (let e = 0; e < r; e++)
                t[e] && t[e].delimiters && tt(t[e].delimiters);
            },
          ],
          ["strikethrough", e3.postProcess],
          ["emphasis", e6.postProcess],
          [
            "fragments_join",
            function (e) {
              let t, r;
      ...
      (ti.prototype.skipToken = function (e) {
        let t = e.pos,
        ...
        (ti.prototype.tokenize = function (e) {
          let t = this.ruler.getRules(""),
            r = t.length,
            n = e.posMax,
            i = e.md.options.maxNesting;
        ...
        (ti.prototype.parse = function (e, t, r, n) {
          let i = new this.State(e, t, r, n);
          this.tokenize(i);
        ...
        (ti.prototype.State = e0);
      let tc = { fuzzyLink: !0, fuzzyEmail: !0, fuzzyIP: !1 },
        tu = {
          "http:": {
      ...
      function td(e) {
        ...
        (e.__compiled__ = {}),
          Object.keys(e.__schemas__).forEach(function (t) {
            ...
            if (((e.__compiled__[t] = n), "[object Object]" === ts(r))) {
              if ("[object RegExp]" === ts(r.validate)) {
                var s;
                n.validate =
                  ((s = r.validate),
                  function (e, t) {
                    let r = e.slice(t);
                    return s.test(r) ? r.match(s)[0].length : 0;
                  });
              } else ta(r.validate) ? (n.validate = r.validate) : o(t, r);
              ta(r.normalize)
          ...
          (e.__compiled__[""] = { validate: null, normalize: tp() });
        let s = Object.keys(e.__compiled__)
          .filter(function (t) {
      ...
      function tg(e, t) {
        if (!(this instanceof tg)) return new tg(e, t);
        !t &&
          Object.keys(e || {}).reduce(function (e, t) {
            return e || tc.hasOwnProperty(t);
          }, !1) &&
          ((t = e), (e = {})),
          (this.__opts__ = to({}, tc, t)),
          (this.__index__ = -1),
          (this.__last_index__ = -1),
          (this.__schema__ = ""),
          (this.__text_cache__ = ""),
          (this.__schemas__ = to({}, tu, e)),
          (this.__compiled__ = {}),
          (this.__tlds__ = th),
      ...
      (tg.prototype.add = function (e, t) {
        return (this.__schemas__[e] = t), td(this), this;
      }),
        (tg.prototype.set = function (e) {
          return (this.__opts__ = to(this.__opts__, e)), this;
        }),
        (tg.prototype.test = function (e) {
          let t, r, n, i, o, s, a, l;
        ...
        (tg.prototype.pretest = function (e) {
          return this.re.pretest.test(e);
        }),
        (tg.prototype.testSchemaAt = function (e, t, r) {
          return this.__compiled__[t.toLowerCase()]
            ? this.__compiled__[t.toLowerCase()].validate(e, r, this)
            : 0;
        }),
        (tg.prototype.match = function (e) {
          let t = [],
            r = 0;
          this.__index__ >= 0 &&
            this.__text_cache__ === e &&
            (t.push(tm(this, r)), (r = this.__last_index__));
          let n = r ? e.slice(r) : e;
          for (; this.test(n); )
            t.push(tm(this, r)),
        ...
        (tg.prototype.matchAtStart = function (e) {
          if (((this.__text_cache__ = e), (this.__index__ = -1), !e.length))
            return null;
        ...
        (tg.prototype.tlds = function (e, t) {
          return (
        ...
        (tg.prototype.normalize = function (e) {
          e.schema || (e.url = "http://" + e.url),
            "mailto:" !== e.schema ||
              /^mailto:/i.test(e.url) ||
              (e.url = "mailto:" + e.url);
        }),
        (tg.prototype.onCompile = function () {});
      let tb = /^xn--/,
        ty = /[^\0-\x7F]/,
        tv = /[\x2E\u3002\uFF0E\uFF61]/g,
        t_ = {
      ...
      let tA = function (e, t) {
        ...
        tS = function (e, t, r) {
          let n = 0;
          for (e = r ? tk(e / 700) : e >> 1, e += tk(e / t); e > 455; n += 36)
            e = tk(e / 35);
          return tk(n + (36 * e) / (e + 38));
        },
        tD = function (e) {
          let t = [],
            r = e.length,
          ...
          s < 0 && (s = 0);
          for (let r = 0; r < s; ++r)
            e.charCodeAt(r) >= 128 && tx("not-basic"), t.push(e.charCodeAt(r));
          for (let l = s > 0 ? s + 1 : 0; l < r; ) {
            let s = n;
            for (let t = 1, i = 36; ; i += 36) {
              var a;
              l >= r && tx("invalid-input");
              let s =
                (a = e.charCodeAt(l++)) >= 48 && a < 58
                  ...
                  : a >= 65 && a < 91
                    ...
                    : a >= 97 && a < 123
                      ? a - 97
                      : 36;
              s >= 36 && tx("invalid-input"),
                s > tk((2147483647 - n) / t) && tx("overflow"),
                (n += s * t);
              let c = i <= o ? 1 : i >= o + 26 ? 26 : i - o;
              if (s < c) break;
              let u = 36 - c;
              t > tk(2147483647 / u) && tx("overflow"), (t *= u);
            }
            let c = t.length + 1;
            (o = tS(n - s, c, 0 == s)),
              tk(n / c) > 2147483647 - i && tx("overflow"),
              (i += tk(n / c)),
              (n %= c),
              t.splice(n++, 0, i);
          }
        ...
        tO = function (e) {
          ...
          for (s && t.push("-"); a < r; ) {
            ...
            let l = a + 1;
            for (let c of (r - n > tk((2147483647 - i) / l) && tx("overflow"),
            (i += (r - n) * l),
            (n = r),
            e))
              if ((c < n && ++i > 2147483647 && tx("overflow"), c === n)) {
                let e = i;
                for (let r = 36; ; r += 36) {
                  ...
                  let i = e - n,
                    s = 36 - n;
                  t.push(tw(tA(n + (i % s), 0))), (e = tk(i / s));
                }
                t.push(tw(tA(e, 0))), (o = tS(i, l, a === s)), (i = 0), ++a;
              }
            ++i, ++n;
          }
          return t.join("");
      ...
      var tM = {
        version: "2.3.1",
        ucs2: { decode: tC, encode: (e) => String.fromCodePoint(...e) },
        decode: tD,
        encode: tO,
        toASCII: function (e) {
          return tE(e, function (e) {
            return ty.test(e) ? "xn--" + tO(e) : e;
          });
        },
        toUnicode: function (e) {
          return tE(e, function (e) {
            return tb.test(e) ? tD(e.slice(4).toLowerCase()) : e;
          });
        },
      };
      let tF = {
        ...
        tT = /^(vbscript|javascript|file|data):/,
        tz = /^data:image\/(gif|png|jpeg|webp);/;
      function tj(e) {
        let t = e.trim().toLowerCase();
        return !tT.test(t) || tz.test(t);
      }
      let tI = ["http:", "https:", "mailto:"];
      function tN(e) {
        let t = N(e, !0);
        if (t.hostname && (!t.protocol || tI.indexOf(t.protocol) >= 0))
          try {
            t.hostname = tM.toASCII(t.hostname);
          } catch (e) {}
        return E(C(t));
      }
      function tR(e) {
        ...
        if (t.hostname && (!t.protocol || tI.indexOf(t.protocol) >= 0))
          try {
            t.hostname = tM.toUnicode(t.hostname);
          } catch (e) {}
        return k(C(t), k.defaultChars + "%");
      }
      function tq(e, t) {
        if (!(this instanceof tq)) return new tq(e, t);
        t || K(e) || ((t = e || {}), (e = "default")),
          (this.inline = new ti()),
          (this.block = new eQ()),
          (this.core = new eP()),
          (this.renderer = new eA()),
          (this.linkify = new tg()),
          (this.validateLink = tj),
          (this.normalizeLink = tN),
          (this.normalizeLinkText = tR),
          (this.utils = g),
          (this.helpers = ee({}, b)),
          (this.options = {}),
          this.configure(e),
      ...
      (tq.prototype.set = function (e) {
        return ee(this.options, e), this;
      }),
        (tq.prototype.configure = function (e) {
          let t = this;
          if (K(e)) {
            let t = e;
            if (!(e = tF[t]))
        ...
        (tq.prototype.enable = function (e, t) {
          let r = [];
          Array.isArray(e) || (e = [e]),
        ...
        (tq.prototype.disable = function (e, t) {
          let r = [];
          Array.isArray(e) || (e = [e]),
            ["core", "block", "inline"].forEach(function (t) {
      ...
      class tL {
        ...
        addText(e) {
          ...
          n &&
          (o = (function (e, t) {
            if (e.isText && t.isText && y.vc.sameSet(e.marks, t.marks))
        ...
        addNode(e, t, r) {
          let n = this.top(),
            i = e.createAndFill(t, r, n ? n.marks : []);
          return i ? (this.push(i), i) : null;
        }
        openNode(e, t) {
          this.stack.push({ type: e, attrs: t, content: [], marks: y.vc.none });
        }
        closeNode() {
            ...
            (this.tokenHandlers = (function (e, t) {
              ...
              for (let n in t) {
                ...
                if (i.block) {
                  ...
                  t$(i, n)
                    ? (r[n] = (e, r, n, o) => {
                        e.openNode(t, tP(i, r, n, o)),
                          e.addText(tU(r.content)),
                          e.closeNode();
                      })
                    : ((r[n + "_open"] = (e, r, n, o) =>
                        e.openNode(t, tP(i, r, n, o))),
                  ...
                  r[n] = (e, r, n, o) => e.addNode(t, tP(i, r, n, o));
                } else if (i.mark) {
                  let t = e.marks[i.mark];
                  t$(i, n)
                    ? (r[n] = (e, r, n, o) => {
                        e.openMark(t.create(tP(i, r, n, o))),
                          e.addText(tU(r.content)),
                          e.closeMark(t);
                      })
                    : ((r[n + "_open"] = (e, r, n, o) =>
                        e.openMark(t.create(tP(i, r, n, o)))),
                      (r[n + "_close"] = (e) => e.closeMark(t)));
                } else if (i.ignore)
                  t$(i, n)
                    ? (r[n] = tJ)
                    : ((r[n + "_open"] = tJ), (r[n + "_close"] = tJ));
                else
                  throw RangeError(
              ...
              return (
                (r.text = (e, t) => e.addText(t.content)),
                (r.inline = (e, t) => e.parseTokens(t.children)),
                (r.softbreak = r.softbreak || ((e) => e.addText(" "))),
                r
              );
            })(e, r));
        }
        parse(e, t = {}) {
          let r = new tL(this.schema, this.tokenHandlers),
            n;
      ...
      let tV = new tW(tB, tq("commonmark", { html: !1 }), {
        blockquote: { block: "blockquote" },
        paragraph: { block: "paragraph" },
        list_item: { block: "list_item" },
        bullet_list: {
          block: "bullet_list",
          getAttrs: (e, t, r) => ({ tight: tH(t, r) }),
        },
        ordered_list: {
          block: "ordered_list",
          getAttrs: (e, t, r) => ({
      ...
      class tZ {
        ...
        serialize(e, t = {}) {
          ...
          let r = new tK(this.nodes, this.marks, t);
      ...
      let tG = new tZ(
        {
          ...
          code_block(e, t) {
            let r = t.textContent.match(/`{3,}/gm),
              n = r ? r.sort().slice(-1)[0] + "`" : "```";
            e.write(n + (t.attrs.params || "") + "\n"),
          ...
          ordered_list(e, t) {
            let r = t.attrs.order || 1,
              n = String(r + t.childCount - 1).length,
              i = e.repeat(" ", n + 2);
            e.renderList(t, i, (t) => {
              let i = String(r + t);
              return e.repeat(" ", n - i.length) + i + ". ";
            });
          },
          list_item(e, t) {
            e.renderContent(t);
          ...
          hard_break(e, t, r, n) {
            for (let i = n + 1; i < r.childCount; i++)
              if (r.child(i).type != t.type) {
                e.write("\\\n");
                return;
              }
          },
        ...
        },
        {
          ...
          link: {
            open: (e, t, r, n) => (
              (e.inAutolink = (function (e, t, r) {
                if (e.attrs.title || !/^\w+:/.test(e.attrs.href)) return !1;
                let n = t.child(r);
                return (
                  !!n.isText &&
                  n.text == e.attrs.href &&
                  n.marks[n.marks.length - 1] == e &&
                  (r == t.childCount - 1 || !e.isInSet(t.child(r + 1).marks))
                );
              })(t, r, n)),
              e.inAutolink ? "<" : "["
            ),
          ...
          code: {
            open: (e, t, r, n) => tY(r.child(n), -1),
            close: (e, t, r, n) => tY(r.child(n - 1), 1),
            escape: !1,
          },
        }
      );
      function tY(e, t) {
        let r = /`+/g,
          ...
          i = 0;
        if (e.isText)
          for (; (n = r.exec(e.text)); ) i = Math.max(i, n[0].length);
        let o = i > 0 && t > 0 ? " `" : "`";
        for (let e = 0; e < i; e++) o += "`";
        return i > 0 && t < 0 && (o += " "), o;
      }
      class tK {
        ...
        text(e, t = !0) {
          ...
          for (let e = 0; e < r.length; e++)
            this.write(),
              ...
              (this.out += t ? this.esc(r[e], this.atBlockStart) : r[e]),
              e != r.length - 1 && (this.out += "\n");
        }
        render(e, t, r) {
          ...
          let r = [],
            ...
            i = (t, i, o) => {
              ...
              t &&
                ...
                (s = s.filter((t) => {
                  if (o + 1 == e.childCount) return !1;
                  let r = e.child(o + 1);
                  return t.isInSet(r.marks) && (!r.isText || /\S/.test(r.text));
                }));
              let a = n;
              if (
                ((n = ""),
                t &&
                  t.isText &&
                  s.some((e) => {
                    let t = this.marks[e.type.name];
                    return t && t.expelEnclosingWhitespace && !e.isInSet(r);
                  }))
              ) {
                let [e, n, i] = /^(\s*)(.*)$/m.exec(t.text);
                !n || ((a += n), (t = i ? t.withText(i) : null) || (s = r));
              }
              if (
                t &&
                t.isText &&
                s.some((t) => {
                  ...
                  return (
                    r &&
                    r.expelEnclosingWhitespace &&
                    (o == e.childCount - 1 || !t.isInSet(e.child(o + 1).marks))
                  );
                })
              ) {
                let [e, i, o] = /^(.*?)(\s*)$/m.exec(t.text);
                !o || ((n = o), (t = i ? t.withText(i) : null) || (s = r));
              }
              let l = s.length ? s[s.length - 1] : null,
                c = l && !1 === this.marks[l.type.name].escape,
                u = s.length - (c ? 1 : 0);
              t: for (let e = 0; e < u; e++) {
                let t = s[e];
                if (!this.marks[t.type.name].mixable) break;
                  ...
                  if (t.eq(i)) {
                    e > n
                      ? (s = s
                          ...
                          .concat(t)
                          .concat(s.slice(n, e))
                          .concat(s.slice(e + 1, u)))
                      : n > e &&
                        (s = s
                          .slice(0, e)
                          .concat(s.slice(e + 1, n))
                          .concat(t)
                          .concat(s.slice(n, u)));
                    continue t;
                  }
              ...
              let h = 0;
              for (; h < Math.min(r.length, u) && s[h].eq(r[h]); ) ++h;
              for (; h < r.length; )
                this.text(this.markString(r.pop(), !1, e, o), !1);
              if ((a && this.text(a), t)) {
                for (; r.length < u; ) {
                  let t = s[r.length];
                  r.push(t),
                    this.text(this.markString(t, !0, e, o), !1),
                    (this.atBlockStart = !1);
                }
                c && t.isText
                  ? this.text(
                      this.markString(l, !0, e, o) +
                        t.text +
                        this.markString(l, !1, e, o + 1),
                      !1
                    )
                  : this.render(t, e, o),
                  (this.atBlockStart = !1);
        ...
        renderList(e, t, r) {
          ...
          (this.inTightList = n),
            e.forEach((i, o, s) => {
              s && n && this.flushClose(1),
                this.wrapBlock(t, r(s), e, () => this.render(i, e, s));
            }),
            (this.inTightList = i);
        }
        esc(e, t = !1) {
        ...
        markString(e, t, r, n) {
          let i = this.marks[e.type.name],
            o = t ? i.open : i.close;
          return "string" == typeof o ? o : o(this, e, r, n);
        }
    ...
    79134: function (e, t, r) {
        ...
        (n.prototype = {
          ...
          update: function (e, t, r) {
            var i = r && r != e ? this.remove(r) : this,
              ...
              s = i.content.slice();
            return (
              -1 == o ? s.push(r || e, t) : ((s[o + 1] = t), r && (s[o] = r)),
              new n(s)
            );
          },
          remove: function (e) {
          ...
          addBefore: function (e, t, r) {
            var i = this.remove(t),
              o = i.content.slice(),
              s = i.find(e);
            return o.splice(-1 == s ? o.length : s, 0, t, r), new n(o);
          },
          forEach: function (e) {
            for (var t = 0; t < this.content.length; t += 2)
          ...
          prepend: function (e) {
            return (e = n.from(e)).size
              ? new n(e.content.concat(this.subtract(e).content))
              : this;
          },
          append: function (e) {
            return (e = n.from(e)).size
              ? new n(this.subtract(e).content.concat(e.content))
              : this;
          },
          subtract: function (e) {
            var t = this;
      ...
      class i {
        ...
        nodesBetween(e, t, r, n = 0, i) {
          for (let o = 0, s = 0; s < t; o++) {
            let a = this.content[o],
              l = s + a.nodeSize;
            if (l > e && !1 !== r(a, n + s, i || null, o) && a.content.size) {
              let i = s + 1;
              a.nodesBetween(
                Math.max(0, e - i),
        ...
        append(e) {
          ...
          for (
            t.isText &&
            t.sameMarkup(r) &&
            ((n[n.length - 1] = t.withText(t.text + r.text)), (o = 1));
            o < e.content.length;
            o++
          )
            n.push(e.content[o]);
        ...
        replaceChild(e, t) {
          ...
          if (r == t) return this;
          let n = this.content.slice(),
            o = this.size + t.nodeSize - r.nodeSize;
          return (n[e] = t), new i(n, o);
        }
        addToStart(e) {
        ...
        findDiffStart(e, t = 0) {
          return (function e(t, r, n) {
            for (let i = 0; ; i++) {
              if (i == t.childCount || i == r.childCount)
              ...
              if (o.content.size || s.content.size) {
                let t = e(o.content, s.content, n + 1);
                if (null != t) return t;
              }
              n += o.nodeSize;
            }
        ...
        findDiffEnd(e, t = this.size, r = e.size) {
          return (function e(t, r, n, i) {
            for (let o = t.childCount, s = r.childCount; ; ) {
              if (0 == o || 0 == s) return o == s ? null : { a: n, b: i };
              let a = t.child(--o),
                l = r.child(--s),
                c = a.nodeSize;
              if (a == l) {
              ...
              if (!a.sameMarkup(l)) return { a: n, b: i };
              ...
              if (a.content.size || l.content.size) {
                let t = e(a.content, l.content, n - 1, i - 1);
                if (t) return t;
              }
              (n -= c), (i -= c);
            }
        ...
        findIndex(e, t = -1) {
          ...
          for (let r = 0, n = 0; ; r++) {
            let i = n + this.child(r).nodeSize;
            if (i >= e) {
              if (i == e || t > 0) return s(r + 1, i);
              return s(r, n);
            }
            n = i;
          }
      ...
      function a(e, t) {
        ...
        if (r) {
          ...
          for (let r = 0; r < e.length; r++) if (!a(e[r], t[r])) return !1;
        } else {
          for (let r in e) if (!(r in t) || !a(e[r], t[r])) return !1;
      ...
      class l {
        ...
        addToSet(e) {
          ...
          for (let n = 0; n < e.length; n++) {
            ...
            if (this.type.excludes(i.type)) t || (t = e.slice(0, n));
            else {
      ...
      class u {
        ...
        insertAt(e, t) {
          let r = (function e(t, r, n, i) {
            let { index: o, offset: s } = t.findIndex(r),
              a = t.maybeChild(o);
            if (s == r || a.isText)
              return i && !i.canReplace(o, o, n)
                ? null
                : t.cut(0, r).append(n).append(t.cut(r));
            let l = e(a.content, r - s - 1, n);
        ...
        removeBetween(e, t) {
          return new u(
            (function e(t, r, n) {
              let { index: i, offset: o } = t.findIndex(r),
                s = t.maybeChild(i),
              ...
              return t.replaceChild(
                i,
                s.copy(e(s.content, r - o - 1, n - o - 1))
              );
        ...
        static fromJSON(e, t) {
          ...
          return new u(i.fromJSON(e, t.content), r, n);
        }
      ...
      function f(e, t, r, n) {
        let i = (t || e).node(r),
          o = 0,
          s = t ? t.index(r) : i.childCount;
        e &&
          ((o = e.index(r)),
          e.depth > r ? o++ : e.textOffset && (d(e.nodeAfter, n), o++));
        for (let e = o; e < s; e++) d(i.child(e), n);
        t && t.depth == r && t.textOffset && d(t.nodeBefore, n);
      }
      function m(e, t) {
      ...
      function g(e, t, r) {
        ...
        return (
          f(null, e, r, n),
          e.depth > r && d(m(p(e, t, r + 1), g(e, t, r + 1)), n),
          f(t, null, r, n),
          new i(n)
        );
      }
        ...
        static resolve(e, t) {
          ...
          for (let t = e; ; ) {
            let { index: e, offset: o } = t.content.findIndex(i),
              s = i - o;
            if ((r.push(t, e, n + o), !s || (t = t.child(e)).isText)) break;
            (i = s - 1), (n += o + 1);
          }
          return new b(t, r, i);
        }
      ...
      class x {
        ...
        copy(e = null) {
          return e == this.content
            ? this
            : new x(this.type, this.attrs, e, this.marks);
        }
        mark(e) {
          return e == this.marks
            ? this
            : new x(this.type, this.attrs, this.content, e);
        }
        ...
        slice(e, t = this.content.size, r = !1) {
          ...
          let n = this.resolve(e),
            ...
            s = n.start(o);
          return new u(
            n.node(o).content.cut(n.pos - s, i.pos - s),
            n.depth - o,
            i.depth - o
          );
        }
        replace(e, t, r) {
          return (function (e, t, r) {
            ...
            return (function e(t, r, n, o) {
              let s = t.index(o),
                a = t.node(o);
              if (s == r.index(o) && o < t.depth - n.openStart) {
                let i = e(t, r, n, o + 1);
                return a.copy(a.content.replaceChild(s, i));
              }
              if (!n.content.size) return m(a, g(t, r, o));
              if (n.openStart || n.openEnd || t.depth != o || r.depth != o) {
                let { start: e, end: s } = (function (e, t) {
                ...
                return m(
                  ...
                  (function e(t, r, n, o, s) {
                    let a = t.depth > s && p(t, r, s + 1),
                      l = o.depth > s && p(n, o, s + 1),
                      c = [];
                    return (
                      f(null, t, s, c),
                      a && l && r.index(s) == n.index(s)
                        ? (h(a, l), d(m(a, e(t, r, n, o, s + 1)), c))
                        : (a && d(m(a, g(t, r, s + 1)), c),
                          f(r, n, s, c),
                          l && d(m(l, g(n, o, s + 1)), c)),
                      f(o, null, s, c),
        ...
        resolve(e) {
          return b.resolveCached(this, e);
        }
        resolveNoCache(e) {
          return b.resolve(this, e);
        }
        rangeHasMark(e, t, r) {
          let n = !1;
          return (
        ...
        canReplace(e, t, r = i.empty, n = 0, o = r.childCount) {
          let s = this.contentMatchAt(e).matchFragment(r, n, o),
      ...
      class E extends x {
        ...
        toString() {
          return this.type.spec.toDebugString
            ...
            : C(this.marks, JSON.stringify(this.text));
        }
        get textContent() {
          return this.text;
        }
        ...
        mark(e) {
          return e == this.marks
            ? this
            : new E(this.type, this.attrs, this.text, e);
        }
        withText(e) {
          return e == this.text
            ? this
      ...
      class A {
        ...
        static parse(e, t) {
          ...
          let s =
                ...
                i(
                  (function e(t, o) {
                    ...
                    if ("seq" == t.type)
                      for (let n = 0; ; n++) {
                        let s = e(t.exprs[n], o);
                        if (n == t.exprs.length - 1) return s;
                        i(s, (o = r()));
                      }
                    else if ("star" == t.type) {
                      let s = r();
                      return n(o, s), i(e(t.expr, s), s), [n(s)];
                    } else if ("plus" == t.type) {
                      let s = r();
                      return i(e(t.expr, o), s), i(e(t.expr, s), s), [n(s)];
                    } else if ("opt" == t.type)
                      return [n(o)].concat(e(t.expr, o));
                      ...
                      if (-1 == t.max) i(e(t.expr, s), s);
                      else
                        for (let o = t.min; o < t.max; o++) {
                          let o = r();
                          n(s, o), i(e(t.expr, s), o), (s = o);
                        }
                      return [n(s)];
                    } else if ("name" == t.type) return [n(o, void 0, t.value)];
            ...
            (function e(t) {
              ...
              let o = (n[t.join(",")] = new A(t.indexOf(r.length - 1) > -1));
              for (let t = 0; t < i.length; t++) {
                let r = i[t][1].sort(O);
                o.next.push({ type: i[t][0], next: n[r.join(",")] || e(r) });
              }
              return o;
            })(M(r, 0)));
          return (
            (function (e, t) {
              for (let r = 0, n = [e]; r < n.length; r++) {
                ...
                for (let t = 0; t < e.next.length; t++) {
                  let { type: r, next: s } = e.next[t];
                  o.push(r.name),
                    i && !(r.isText || r.hasRequiredAttrs()) && (i = !1),
        ...
        matchFragment(e, t = 0, r = e.childCount) {
          let n = this;
          for (let i = t; n && i < r; i++) n = n.matchType(e.child(i).type);
          return n;
        }
        get inlineContent() {
        ...
        fillBefore(e, t = !1, r = 0) {
          ...
          return (function o(s, a) {
            ...
            for (let e = 0; e < s.next.length; e++) {
              let { type: t, next: r } = s.next[e];
              if (!(t.isText || t.hasRequiredAttrs()) && -1 == n.indexOf(r)) {
                n.push(r);
                let e = o(r, a.concat(t));
                if (e) return e;
              }
            }
            return null;
      ...
      function T(e, t) {
        ...
        for (let n in e) {
          ...
          if (void 0 === i) {
            ...
            else throw RangeError("No value supplied for attribute " + n);
          }
          r[n] = i;
        }
        return r;
      ...
      function z(e) {
        let t = Object.create(null);
        if (e) for (let r in e) t[r] = new I(e[r]);
        return t;
      }
      class j {
        constructor(e, t, r) {
          (this.name = e),
            ...
            (this.defaultAttrs = F(this.attrs)),
        ...
        get isLeaf() {
          return this.contentMatch == A.empty;
        }
        get isAtom() {
        ...
        create(e = null, t, r) {
          ...
          return new x(this, this.computeAttrs(e), i.from(t), l.setFrom(r));
        }
        createChecked(e = null, t, r) {
          return (
            (t = i.from(t)),
            this.checkContent(t),
            new x(this, this.computeAttrs(e), t, l.setFrom(r))
          );
        }
        createAndFill(e = null, t, r) {
          ...
          let n = this.contentMatch.matchFragment(t),
            o = n && n.fillBefore(i.empty, !0);
          return o ? new x(this, e, t.append(o), l.setFrom(r)) : null;
        }
        validContent(e) {
        ...
        static compile(e, t) {
          let r = Object.create(null);
          e.forEach((e, n) => (r[e] = new j(e, t, n)));
          let n = t.spec.topNode || "doc";
          if (!r[n])
            throw RangeError(
              "Schema is missing its top node type ('" + n + "')"
            );
      ...
      class N {
        ...
        create(e = null) {
          return !e && this.instance
            ? this.instance
            : new l(this, T(this.attrs, e));
        }
        static compile(e, t) {
          let r = Object.create(null),
            n = 0;
          return e.forEach((e, i) => (r[e] = new N(e, n++, t, i))), r;
        }
        removeFromSet(e) {
      ...
      class R {
        constructor(e) {
          ...
          (t.nodes = n.from(e.nodes)),
            (t.marks = n.from(e.marks || {})),
          ...
          for (let e in this.nodes) {
            ...
            let t = this.nodes[e],
              n = t.spec.content || "",
              i = t.spec.marks;
            (t.contentMatch = r[n] || (r[n] = A.parse(n, this.nodes))),
          ...
          for (let e in this.marks) {
            let t = this.marks[e],
              r = t.spec.excludes;
            t.excluded = null == r ? [t] : "" == r ? [] : q(this, r.split(" "));
          }
        ...
        node(e, t = null, r, n) {
          ...
          return e.createChecked(t, r, n);
        }
        text(e, t) {
          let r = this.nodes.text;
          return new E(r, r.defaultAttrs, e, l.setFrom(t));
        }
        mark(e, t) {
        ...
        for (let n = 0; n < t.length; n++) {
          ...
          if (o) r.push(o);
            ...
            for (let t in e.marks) {
              let n = e.marks[t];
              ("_" == i ||
                (n.spec.group && n.spec.group.split(" ").indexOf(i) > -1)) &&
                r.push((s = n));
            }
          if (!s) throw SyntaxError("Unknown mark type: '" + t[n] + "'");
        }
        return r;
      }
      class B {
        constructor(e, t) {
          (this.schema = e),
            ...
            (this.normalizeLists = !this.tags.some((t) => {
              ...
              let r = e.nodes[t.node];
              return r.contentMatch.matchType(r);
            }));
        }
        parse(e, t = {}) {
          let r = new W(this, t, !1);
          return r.addAll(e, t.from, t.to), r.finish();
        }
        parseSlice(e, t = {}) {
          let r = new W(this, t, !0);
          return r.addAll(e, t.from, t.to), u.maxOpen(r.finish());
        }
        matchTag(e, t, r) {
          for (
            ...
            if (
              ...
              (
                ...
                (void 0 === r.namespace || e.namespaceURI == r.namespace) &&
                (!r.context || t.matchesContext(r.context)))
            ) {
              if (r.getAttrs) {
                let t = r.getAttrs(e);
                if (!1 === t) continue;
        ...
        matchStyle(e, t, r, n) {
          for (
            let i = n ? this.styles.indexOf(n) + 1 : 0;
        ...
        static schemaRules(e) {
          let t = [];
          function r(e) {
            let r = null == e.priority ? 50 : e.priority,
              n = 0;
            for (; n < t.length; n++) {
              let e = t[n];
              if ((null == e.priority ? 50 : e.priority) < r) break;
            }
            t.splice(n, 0, e);
          }
          for (let t in e.marks) {
            let n = e.marks[t].spec.parseDOM;
            n &&
              n.forEach((e) => {
                r((e = H(e))),
          ...
          for (let t in e.nodes) {
            let n = e.nodes[t].spec.parseDOM;
            n &&
              n.forEach((e) => {
                r((e = H(e))), e.node || e.ignore || e.mark || (e.node = t);
              });
          }
          return t;
        }
        static fromSchema(e) {
          return (
            e.cached.domParser ||
            (e.cached.domParser = new B(e, B.schemaRules(e)))
          );
        }
      }
      let L = {
      ...
      class J {
          ...
          if (!this.match) {
            ...
            if (t) this.match = this.type.contentMatch.matchFragment(t);
              ...
              let t = this.type.contentMatch,
                r;
              return (r = t.findWrapping(e.type))
                ? ((this.match = t), r)
                : null;
            }
          }
        ...
        applyPending(e) {
          for (let t = 0, r = this.pendingMarks; t < r.length; t++) {
            let n = r[t];
            (this.type
              ? this.type.allowsMarkType(n.type)
              : (function (e, t) {
                  let r = t.schema.nodes;
                  for (let n in r) {
                    let i = r[n];
                    ...
                    let o = [],
                      s = (e) => {
                        o.push(e);
                        for (let r = 0; r < e.edgeCount; r++) {
                          let { type: n, next: i } = e.edge(r);
                          if (n == t || (0 > o.indexOf(i) && s(i))) return !0;
                        }
                      };
                    if (s(i.contentMatch)) return !0;
                  }
                })(n.type, e)) &&
              !n.isInSet(this.activeMarks) &&
              ((this.activeMarks = n.addToSet(this.activeMarks)),
              (this.pendingMarks = n.removeFromSet(this.pendingMarks)));
          }
        }
        inlineContext(e) {
          return this.type
            ...
            : this.content.length
              ...
              : e.parentNode &&
                !L.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
        }
      }
      class W {
        constructor(e, t, r) {
          ...
          let n = t.topNode,
            i,
            o = U(null, t.preserveWhitespace, 0) | (r ? 4 : 0);
          (i = n
            ? new J(
                n.type,
                n.attrs,
                ...
                l.none,
                !0,
                t.topMatch || n.type.contentMatch,
                o
              )
            : r
              ? new J(null, null, l.none, l.none, !0, null, o)
              : new J(e.schema.topNodeType, null, l.none, l.none, !0, null, o)),
            (this.nodes = [i]),
          ...
          let n = this.readStyles(
            (function (e) {
              let t = /\s*([\w-]+)\s*:\s*([^;]+)/g,
                r,
                n = [];
              for (; (r = t.exec(e)); ) n.push(r[1], r[2].trim());
              return n;
            })(r)
          );
          if (!n) return;
        ...
        addTextNode(e) {
          ...
          if (
            ...
            if (1 & r.options)
              ...
              let n = r.content[r.content.length - 1],
                i = e.previousSibling;
              (!n ||
                (i && "BR" == i.nodeName) ||
                (n.isText && /[ \t\r\n\u000c]$/.test(n.text))) &&
        ...
        addElement(e, t) {
          ...
          $.hasOwnProperty(r) &&
            ...
            (function (e) {
              for (let t = e.firstChild, r = null; t; t = t.nextSibling) {
                let e = 1 == t.nodeType ? t.nodeName.toLowerCase() : null;
                e && $.hasOwnProperty(e) && r
                  ? (r.appendChild(t), (t = r))
                  : "li" == e
                    ? (r = t)
                    : e && (r = null);
          ...
          if (i ? i.ignore : P.hasOwnProperty(r))
        ...
        readStyles(e) {
          ...
          for (let n = 0; n < e.length; n += 2)
            for (let i; ; ) {
              let o = this.parser.matchStyle(e[n], e[n + 1], this, i);
              if (!o) break;
        ...
        addElementByRule(e, t, r) {
          ...
          t.node
            ? (i = this.parser.schema.nodes[t.node]).isLeaf
              ...
              : (n = this.enter(i, t.attrs || null, t.preserveWhitespace))
        ...
        addAll(e, t, r) {
          ...
          for (
            ...
            this.findAtPoint(e, n), this.addDOM(i);
        ...
        insertNode(e) {
          ...
          if (this.findPlace(e)) {
            ...
            for (let n = 0; n < e.marks.length; n++)
              (!t.type || t.type.allowsMarkType(e.marks[n].type)) &&
                (r = e.marks[n].addToSet(r));
            return t.content.push(e.mark(r)), !0;
          }
          return !1;
        }
        enter(e, t, r) {
          let n = this.findPlace(e.create(t));
          return n && this.enterInner(e, t, !0, r), n;
        }
        enterInner(e, t = null, r = !1, n) {
          this.closeExtra();
          let i = this.top;
          i.applyPending(e), (i.match = i.match && i.match.matchType(e));
          let o = U(e, n, i.options);
          4 & i.options && 0 == i.content.length && (o |= 4),
            this.nodes.push(
              new J(e, t, i.activeMarks, i.pendingMarks, r, null, o)
            ),
            this.open++;
        }
        closeExtra(e = !1) {
        ...
        get currentPos() {
          ...
          for (let t = this.open; t >= 0; t--) {
            ...
            for (let t = r.length - 1; t >= 0; t--) e += r[t].nodeSize;
            t && e++;
          }
          return e;
        }
        ...
        findAround(e, t, r) {
          if (e != t && this.find)
            for (let n = 0; n < this.find.length; n++)
              null == this.find[n].pos &&
                1 == e.nodeType &&
                e.contains(this.find[n].node) &&
                t.compareDocumentPosition(this.find[n].node) & (r ? 2 : 4) &&
        ...
        matchesContext(e) {
          ...
          let t = e.split("/"),
            ...
            n = !this.isOpen && (!r || r.parent.type == this.nodes[0].type),
            i = -(r ? r.depth + 1 : 0) + (n ? 0 : 1),
            o = (e, s) => {
              for (; e >= 0; e--) {
                let a = t[e];
                if ("" == a) {
        ...
        addPendingMark(e) {
          let t = (function (e, t) {
            for (let r = 0; r < t.length; r++) if (e.eq(t[r])) return t[r];
        ...
        removePendingMark(e, t) {
          for (let r = this.open; r >= 0; r--) {
            let n = this.nodes[r];
            if (n.pendingMarks.lastIndexOf(e) > -1)
              n.pendingMarks = e.removeFromSet(n.pendingMarks);
            else {
              n.activeMarks = e.removeFromSet(n.activeMarks);
              let t = n.popFromStashMark(e);
              t &&
                n.type &&
                n.type.allowsMarkType(t.type) &&
                (n.activeMarks = t.addToSet(n.activeMarks));
            }
            if (n == t) break;
          }
        }
      ...
      class V {
        ...
        serializeFragment(e, t = {}, r) {
          r || (r = G(t).createDocumentFragment());
          let n = r,
            i = [];
          return (
            e.forEach((e) => {
              if (i.length || e.marks.length) {
                let r = 0,
                  o = 0;
                for (; r < i.length && o < e.marks.length; ) {
                  let t = e.marks[o];
                  if (!this.marks[t.type.name]) {
                    o++;
                    continue;
                  }
                  if (!t.eq(i[r][0]) || !1 === t.type.spec.spanning) break;
                  r++, o++;
                }
                for (; r < i.length; ) n = i.pop()[1];
                for (; o < e.marks.length; ) {
                  let r = e.marks[o++],
                    s = this.serializeMark(r, e.isInline, t);
                  s &&
                    (i.push([r, n]),
                    n.appendChild(s.dom),
                    (n = s.contentDOM || s.dom));
                }
              }
              n.appendChild(this.serializeNodeInner(e, t));
            }),
            r
          );
        }
        serializeNodeInner(e, t) {
          let { dom: r, contentDOM: n } = V.renderSpec(
            G(t),
          ...
          if (n) {
            ...
            this.serializeFragment(e.content, t, n);
          }
          return r;
        }
        serializeNode(e, t = {}) {
          ...
          for (let n = e.marks.length - 1; n >= 0; n--) {
            let i = this.serializeMark(e.marks[n], e.isInline, t);
        ...
        serializeMark(e, t, r = {}) {
          ...
          return n && V.renderSpec(G(r), n(e, t));
        }
        static renderSpec(e, t, r = null) {
          ...
          let s = r ? e.createElementNS(r, i) : e.createElement(i),
            a = t[1],
            l = 1;
          if (
            a &&
          ...
          for (let i = l; i < t.length; i++) {
            ...
            {
              let { dom: t, contentDOM: i } = V.renderSpec(e, o, r);
              if ((s.appendChild(t), i)) {
                if (n) throw RangeError("Multiple content holes");
                n = i;
              }
            }
          }
          return { dom: s, contentDOM: n };
        }
        static fromSchema(e) {
          return (
            e.cached.domSerializer ||
            (e.cached.domSerializer = new V(
    ...
    60314: function (e, t, r) {
      ...
      class s {
        constructor(e, t, r) {
          (this.$anchor = e),
            (this.$head = t),
            (this.ranges = r || [new a(e.min(t), e.max(t))]);
        }
        get anchor() {
        ...
        replace(e, t = n.p2.empty) {
          let r = t.content.lastChild,
            i = null;
          for (let e = 0; e < t.openEnd; e++) (i = r), (r = r.lastChild);
          let o = e.steps.length,
            s = this.ranges;
          for (let a = 0; a < s.length; a++) {
            let { $from: l, $to: c } = s[a],
              u = e.mapping.slice(o);
            e.replaceRange(u.map(l.pos), u.map(c.pos), a ? n.p2.empty : t),
              0 == a && b(e, o, (r ? r.isInline : i && i.isTextblock) ? -1 : 1);
          }
        }
        replaceWith(e, t) {
          ...
          for (let i = 0; i < n.length; i++) {
            ...
            i
              ? e.deleteRange(l, c)
              : (e.replaceRangeWith(l, c, t), b(e, r, t.isInline ? -1 : 1));
          }
        }
        static findFrom(e, t, r = !1) {
          let n = e.parent.inlineContent
            ? new u(e)
            : g(e.node(0), e.parent, e.pos, e.index(), t, r);
          if (n) return n;
          for (let n = e.depth - 1; n >= 0; n--) {
            let i =
              t < 0
                ? g(e.node(0), e.node(n), e.before(n + 1), e.index(n), t, r)
                : g(e.node(0), e.node(n), e.after(n + 1), e.index(n) + 1, t, r);
            if (i) return i;
          }
          return null;
        }
      ...
      class u extends s {
        ...
        map(e, t) {
          ...
          return new u(n.parent.inlineContent ? n : r, r);
        }
        replace(e, t = n.p2.empty) {
          if ((super.replace(e, t), t == n.p2.empty)) {
        ...
        static between(e, t, r) {
          ...
          if (((!r || n) && (r = n >= 0 ? 1 : -1), !t.parent.inlineContent)) {
            let e = s.findFrom(t, r, !0) || s.findFrom(t, -r, !0);
            if (!e) return s.near(t, r);
            t = e.$head;
          }
          return (
            e.parent.inlineContent ||
      ...
      class h {
        ...
        map(e) {
          return new h(e.map(this.anchor), e.map(this.head));
        }
        resolve(e) {
      ...
      class p extends s {
        ...
        map(e, t) {
          let { deleted: r, pos: n } = t.mapResult(this.anchor),
            i = e.resolve(n);
          return r ? s.near(i) : new p(i);
        }
        content() {
          return new n.p2(n.HY.from(this.node), 0, 0);
        }
        eq(e) {
      ...
      class d {
        ...
        map(e) {
          ...
          return t ? new h(r, r) : new d(r);
        }
        resolve(e) {
          let t = e.resolve(this.anchor),
            r = t.nodeAfter;
          return r && p.isSelectable(r) ? new p(t) : s.near(t);
        }
      }
      class f extends s {
        constructor(e) {
      ...
      function g(e, t, r, n, i, o = !1) {
        if (t.inlineContent) return u.create(e, r);
        for (
          let s = n - (i > 0 ? 0 : 1);
          ...
          let n = t.child(s);
          if (n.isAtom) {
            if (!o && p.isSelectable(n))
              return p.create(e, r - (i < 0 ? n.nodeSize : 0));
          } else {
            let t = g(e, n, r + i, i < 0 ? n.childCount : 0, i, o);
            if (t) return t;
          }
          r += n.nodeSize * i;
        }
      ...
      function b(e, t, r) {
        ...
        (a instanceof i.Pu || a instanceof i.FC) &&
          (e.mapping.maps[o].forEach((e, t, r, i) => {
            null == n && (n = i);
          }),
          e.setSelection(s.near(e.doc.resolve(n), r)));
      }
      class y extends i.wx {
        ...
        ensureMarks(e) {
          return (
            n.vc.sameSet(this.storedMarks || this.selection.$from.marks(), e) ||
            ...
            t &&
              (e = e.mark(
                this.storedMarks ||
                  (r.empty
                    ? r.$from.marks()
                    : r.$from.marksAcross(r.$to) || n.vc.none)
              )),
        ...
        insertText(e, t, r) {
          ...
          if (null == t)
            return e
              ? this.replaceSelectionWith(n.text(e), !0)
              : this.deleteSelection();
          {
            if ((null == r && (r = t), (r = null == r ? t : r), !e))
              return this.deleteRange(t, r);
            let i = this.storedMarks;
            if (!i) {
              let e = this.doc.resolve(t);
              i = r == t ? e.marks() : e.marksAcross(this.doc.resolve(r));
            }
            return (
              this.replaceRangeWith(t, r, n.text(e, i)),
      ...
      class _ {
        constructor(e, t, r) {
          (this.name = e),
            (this.init = v(t.init, r)),
            (this.apply = v(t.apply, r));
        }
      }
      let k = [
        new _("doc", {
            ...
            t &&
              t.forEach((e) => {
                ...
                this.plugins.push(e),
                  ...
                  e.spec.state &&
                    this.fields.push(new _(e.key, e.spec.state, e));
              });
        }
      }
      class x {
            ...
            for (let o = 0; o < this.config.plugins.length; o++) {
              ...
              if (s.spec.appendTransaction) {
                let a = n ? n[o].n : 0,
                  ...
                  c =
                    a < t.length &&
                    s.spec.appendTransaction.call(s, a ? t.slice(a) : t, l, r);
                if (c && r.filterTransaction(c, o)) {
                  if ((c.setMeta("appendedTransaction", e), !n)) {
                    n = [];
        ...
        reconfigure(e) {
          ...
          for (let t = 0; t < r.length; t++) {
            let i = r[t].name;
            n[i] = this.hasOwnProperty(i) ? this[i] : r[t].init(e, n);
          }
          return n;
        }
        toJSON(e) {
          ...
          if (
            ...
            for (let r in e) {
              ...
              let n = e[r],
                i = n.spec.state;
              i && i.toJSON && (t[r] = i.toJSON.call(n, this[n.key]));
            }
          return t;
        }
        static fromJSON(e, t, r) {
          ...
          return (
            i.fields.forEach((i) => {
              if ("doc" == i.name) o.doc = n.NB.fromJSON(e.schema, t.doc);
                ...
                if (r)
                  for (let n in r) {
                    ...
                    if (
                      ...
                      o[i.name] = a.fromJSON.call(s, e, t[n], o);
                      return;
                    }
                  }
                o[i.name] = i.init(e, o);
              ...
              (function e(t, r, n) {
                for (let i in t) {
                  ...
                  o instanceof Function
                    ? (o = o.bind(r))
                    : "handleDOMEvents" == i && (o = e(o, r, {})),
                    (n[i] = o);
                }
                return n;
              })(e.props, this, this.props),
            (this.key = e.key ? e.key.key : A("plugin"));
        }
        getState(e) {
          return e[this.key];
        }
    ...
    27748: function (e, t, r) {
      ...
      class o {
        constructor(e, t = !1) {
          if (((this.ranges = e), (this.inverted = t), !e.length && o.empty))
            return o.empty;
        }
        recover(e) {
          let t = 0,
        ...
        _map(e, t, r) {
          ...
          for (let a = 0; a < this.ranges.length; a += 3) {
            ...
            let c = this.ranges[a + o],
              ...
              h = l + c;
            if (e <= h) {
              let o = c ? (e == l ? -1 : e == h ? 1 : t) : t,
                s = l + n + (o < 0 ? 0 : u);
              if (r) return s;
              let p = e == (t < 0 ? l : h) ? null : a / 3 + (e - l) * 65536,
                d = e == l ? 2 : e == h ? 1 : 4;
              return (t < 0 ? e != l : e != h) && (d |= 8), new i(s, d, p);
            }
            n += u - c;
          }
          return r ? e + n : new i(e + n, 0, null);
        }
        touches(e, t) {
          let r = 0,
            n = 65535 & t,
          ...
          for (let t = 0; t < this.ranges.length; t += 3) {
            let s = this.ranges[t] - (this.inverted ? r : 0);
            if (s > e) break;
            let a = this.ranges[t + i];
            if (e <= s + a && t == 3 * n) return !0;
            r += this.ranges[t + o] - a;
          }
          return !1;
        }
        ...
        static offset(e) {
          return 0 == e ? o.empty : new o(e < 0 ? [0, -e, 0] : [0, 0, e]);
        }
      }
      o.empty = new o([]);
      class s {
        constructor(e = [], t, r = 0, n = e.length) {
          (this.maps = e), (this.mirror = t), (this.from = r), (this.to = n);
        }
        slice(e = 0, t = this.maps.length) {
          return new s(this.maps, this.mirror, e, t);
        }
        copy() {
          return new s(
            this.maps.slice(),
        ...
        appendMapping(e) {
          for (let t = 0, r = this.maps.length; t < e.maps.length; t++) {
            let n = e.getMirror(t);
            this.appendMap(e.maps[t], null != n && n < t ? r + n : void 0);
          }
        }
        getMirror(e) {
          if (this.mirror) {
        ...
        _map(e, t, r) {
          ...
          for (let r = this.from; r < this.to; r++) {
            let i = this.maps[r].mapResult(e, t);
            if (null != i.recover) {
              let t = this.getMirror(r);
              if (null != t && t > r && t < this.to) {
                (r = t), (e = this.maps[t].recover(i.recover));
                continue;
              }
            }
            (n |= i.delInfo), (e = i.pos);
          }
          return r ? e : new i(e, n, null);
        }
      }
      ...
      class c {
        ...
        static fromReplace(e, t, r, i) {
          try {
            return c.ok(e.replace(t, r, i));
          } catch (e) {
            if (e instanceof n.e4) return c.fail(e.message);
            throw e;
          }
        }
      }
      function u(e, t, r) {
        ...
        for (let n = 0; n < e.childCount; n++) {
          let o = e.child(n);
          o.content.size && (o = o.copy(u(o.content, t, o))),
            o.isInline && (o = t(o, r, n)),
            i.push(o);
        }
        return n.HY.fromArray(i);
      }
      class h extends l {
        constructor(e, t, r) {
        ...
        apply(e) {
          ...
          return c.fromReplace(e, this.from, this.to, o);
        }
        invert() {
      ...
      class d extends l {
        ...
        apply(e) {
          ...
          return c.fromReplace(
            ...
            this.pos,
            this.pos + 1,
            new n.p2(n.HY.from(r), 0, t.isLeaf ? 0 : 1)
          );
        }
        invert(e) {
          let t = e.nodeAt(this.pos);
          if (t) {
            ...
            if (e.length == t.marks.length) {
              for (let r = 0; r < t.marks.length; r++)
                if (!t.marks[r].isInSet(e)) return new d(this.pos, t.marks[r]);
        ...
        map(e) {
          ...
          return t.deletedAfter ? null : new d(t.pos, this.mark);
        }
        toJSON() {
          return {
        ...
        static fromJSON(e, t) {
          ...
          return new d(t.pos, e.markFromJSON(t.mark));
        }
      }
      ...
      class m extends l {
        ...
        map(e) {
          ...
          return t.deletedAcross && r.deletedAcross
            ? null
            : new m(t.pos, Math.max(t.pos, r.pos), this.slice);
        }
        merge(e) {
        ...
        static fromJSON(e, t) {
          ...
          return new m(t.from, t.to, n.p2.fromJSON(e, t.slice), !!t.structure);
        }
      }
      l.jsonID("replace", m);
      class g extends l {
        constructor(e, t, r, n, i, o, s = !1) {
          super(),
            (this.from = e),
            (this.to = t),
            (this.gapFrom = r),
        ...
        apply(e) {
          ...
          return r
            ? c.fromReplace(e, this.from, this.to, r)
        ...
        map(e) {
          let t = e.mapResult(this.from, 1),
            r = e.mapResult(this.to, -1),
            n = e.map(this.gapFrom, -1),
            i = e.map(this.gapTo, 1);
          return (t.deletedAcross && r.deletedAcross) || n < t.pos || i > r.pos
            ? null
            : new g(
                t.pos,
                r.pos,
      ...
      function y(e) {
        ...
        for (let r = e.depth; ; --r) {
          let n = e.$from.node(r),
            i = e.$from.index(r),
            o = e.$to.indexAfter(r);
          if (r < e.depth && n.canReplace(i, o, t)) return r;
          if (
            0 == r ||
            n.type.spec.isolating ||
            !(
              (0 == i || n.canReplace(i, n.childCount)) &&
              (o == n.childCount || n.canReplace(0, o))
            )
          )
            break;
        }
      ...
      function v(e, t, r = null, n = e) {
        let i = (function (e, t) {
            let { parent: r, startIndex: n, endIndex: i } = e,
              o = r.contentMatchAt(n).findWrapping(t);
            if (!o) return null;
            let s = o.length ? o[0] : t;
            return r.canReplaceWith(n, i, s) ? o : null;
          })(e, t),
          o =
            i &&
            (function (e, t) {
              ...
              for (let e = n; a && e < i; e++) a = a.matchType(r.child(e).type);
              return a && a.validEnd ? s : null;
            })(n, t);
        return o
          ? i.map(_).concat({ type: t, attrs: r }).concat(o.map(_))
          : null;
      }
      function _(e) {
      ...
      function k(e, t, r = 1, n) {
        ...
        if (
          ...
          return !1;
        for (let e = i.depth - 1, t = r - 2; e > o; e--, t--) {
          let r = i.node(e),
            o = i.index(e);
          if (r.type.spec.isolating) return !1;
          let s = r.content.cutByIndex(o, r.childCount),
            a = n && n[t + 1];
          a && (s = s.replaceChild(0, a.type.create(a.attrs)));
          let l = (n && n[t]) || r;
          if (!r.canReplace(o + 1, r.childCount) || !l.type.validContent(s))
            return !1;
        }
      ...
      function w(e, t) {
        ...
        return (
          (r = i.nodeBefore),
          (n = i.nodeAfter),
          !!(r && n && !r.isLeaf && r.canAppend(n)) &&
            i.parent.canReplace(o, o + 1)
        );
      }
      function x(e, t, r) {
        let n = e.resolve(t);
        ...
        let i = r.content;
        for (let e = 0; e < r.openStart; e++) i = i.firstChild.content;
        for (let e = 1; e <= (0 == r.openStart && r.size ? 2 : 1); e++)
          for (let t = n.depth; t >= 0; t--) {
            let r =
                t == n.depth
                  ? 0
                  : n.pos <= (n.start(t + 1) + n.end(t + 1)) / 2
                    ? -1
                    : 1,
              o = n.index(t) + (r > 0 ? 1 : 0),
              s = n.node(t),
              a = !1;
            if (1 == e) a = s.canReplace(o, o, i);
            else {
              let e = s.contentMatchAt(o).findWrapping(i.firstChild.type);
              a = e && s.canReplaceWith(o, o, e[0]);
            }
            if (a)
              return 0 == r ? n.pos : r < 0 ? n.before(t + 1) : n.after(t + 1);
          }
        return null;
      }
      function E(e, t, r = t, i = n.p2.empty) {
        if (t == r && !i.size) return null;
        let o = e.resolve(t),
          s = e.resolve(r);
        return C(o, s, i) ? new m(t, r, i) : new A(o, s, i).fit();
      }
      function C(e, t, r) {
        return (
          !r.openStart &&
      ...
      class A {
        constructor(e, t, r) {
          (this.$from = e),
            ...
            (this.unplaced = r),
            (this.frontier = []),
            (this.placed = n.HY.empty);
          for (let t = 0; t <= e.depth; t++) {
            let r = e.node(t);
            this.frontier.push({
              type: r.type,
              match: r.contentMatchAt(e.indexAfter(t)),
            });
          }
          for (let t = e.depth; t > 0; t--)
            this.placed = n.HY.from(e.node(t).copy(this.placed));
        }
        get depth() {
        ...
        findFittable() {
          ...
          for (
            let t = this.unplaced.content, r = 0, n = this.unplaced.openEnd;
            r < e;
            r++
          ) {
            let i = t.firstChild;
            if (
              (t.childCount > 1 && (n = 0), i.type.spec.isolating && n <= r)
            ) {
              e = r;
              break;
            }
          ...
          for (let t = 1; t <= 2; t++)
            for (let r = 1 == t ? e : this.unplaced.openStart; r >= 0; r--) {
              let e = null,
                i = (
                  r
                    ? (e = O(this.unplaced.content, r - 1).firstChild).content
              ...
              for (let o = this.depth; o >= 0; o--) {
                ...
                if (2 == t && i && (l = a.findWrapping(i.type)))
                  return {
                    sliceDepth: r,
                    frontierDepth: o,
                    parent: e,
        ...
        dropNode() {
          ...
          if (i.childCount <= 1 && t > 0) {
            ...
            this.unplaced = new n.p2(S(e, t - 1, 1), t - 1, o ? t - 1 : r);
          } else this.unplaced = new n.p2(S(e, t, 1), t, r);
        }
        placeNodes({
          sliceDepth: e,
          frontierDepth: t,
                ...
                (function e(t, r, i) {
                  ...
                  return (
                    r > 1 &&
                      (o = o.replaceChild(
                        0,
                        e(o.firstChild, r - 1, 1 == o.childCount ? i - 1 : 0)
                      )),
                    r > 0 &&
          ...
          f || (d = -1),
            (this.placed = D(this.placed, t, n.HY.from(u))),
          ...
          this.unplaced = f
            ...
            : new n.p2(S(s.content, e, c), s.openStart, s.openEnd);
        }
        mustMoveInline() {
          ...
          let { depth: r } = this.$to,
            n = this.$to.after(r);
          for (; r > 1 && n == this.$to.end(--r); ) ++n;
          return n;
        }
        findCloseLevel(e) {
          r: for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
            let { match: r, type: n } = this.frontier[t],
              i = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)),
              o = M(e, t, n, r, i);
            if (o) {
              for (let r = t - 1; r >= 0; r--) {
                let { match: t, type: n } = this.frontier[r],
                  i = M(e, r, n, t, !0);
                if (!i || i.childCount) continue r;
              }
              return {
                depth: t,
                fit: o,
        ...
        close(e) {
          ...
          t.fit.childCount && (this.placed = D(this.placed, t.depth, t.fit)),
            (e = t.move);
          for (let r = t.depth + 1; r <= e.depth; r++) {
            let t = e.node(r),
              n = t.type.contentMatch.fillBefore(t.content, !0, e.index(r));
            this.openFrontierNode(t.type, t.attrs, n);
          }
          return e;
        }
        openFrontierNode(e, t = null, r) {
          ...
          (i.match = i.match.matchType(e)),
            (this.placed = D(
              this.placed,
              this.depth,
              n.HY.from(e.create(t, r))
            )),
            this.frontier.push({ type: e, match: e.contentMatch });
        }
        closeFrontierNode() {
          let e = this.frontier.pop().match.fillBefore(n.HY.empty, !0);
          e.childCount &&
            (this.placed = D(this.placed, this.frontier.length, e));
        }
      }
      function S(e, t, r) {
        return 0 == t
          ? e.cutByIndex(r, e.childCount)
          : e.replaceChild(
              0,
              e.firstChild.copy(S(e.firstChild.content, t - 1, r))
            );
      }
      function D(e, t, r) {
        return 0 == t
          ...
          : e.replaceChild(
              e.childCount - 1,
              e.lastChild.copy(D(e.lastChild.content, t - 1, r))
            );
      }
      function O(e, t) {
        for (let r = 0; r < t; r++) e = e.firstChild.content;
        return e;
      }
      function M(e, t, r, n, i) {
        let o = e.node(t),
          s = i ? e.indexAfter(t) : e.index(t);
        if (s == o.childCount && !r.compatibleContent(o.type)) return null;
        let a = n.fillBefore(o.content, !0, s);
        return a &&
          !(function (e, t, r) {
            for (let n = r; n < t.childCount; n++)
              if (!e.allowsMarks(t.child(n).marks)) return !0;
            return !1;
          })(r, o.content, s)
          ? a
          : null;
      ...
      class T extends l {
        ...
        apply(e) {
          ...
          return c.fromReplace(
            ...
            this.pos,
            this.pos + 1,
            new n.p2(n.HY.from(i), 0, t.isLeaf ? 0 : 1)
          );
        }
        getMap() {
          return o.empty;
      ...
      class I {
        ...
        replace(e, t = e, r = n.p2.empty) {
          let i = E(this.doc, e, t, r);
          return i && this.step(i), this;
        }
        replaceWith(e, t, r) {
          return this.replace(e, t, new n.p2(n.HY.from(r), 0, 0));
        }
        delete(e, t) {
          return this.replace(e, t, n.p2.empty);
        }
        insert(e, t) {
        ...
        replaceRange(e, t, r) {
          return (
            !(function (e, t, r, i) {
              if (!i.size) return e.deleteRange(t, r);
              let o = e.doc.resolve(t),
                s = e.doc.resolve(r);
              if (C(o, s, i)) return e.step(new m(t, r, i));
              let a = F(o, e.doc.resolve(r));
              0 == a[a.length - 1] && a.pop();
              let l = -(o.depth + 1);
              a.unshift(l);
              for (let e = o.depth, t = o.pos - 1; e > 0; e--, t--) {
                let r = o.node(e).type.spec;
                if (r.defining || r.definingAsContext || r.isolating) break;
                a.indexOf(e) > -1
                  ? (l = e)
                  : o.before(e) == t && a.splice(1, 0, -e);
              }
              let c = a.indexOf(l),
                u = [],
                h = i.openStart;
              for (let e = i.content, t = 0; ; t++) {
                let r = e.firstChild;
                if ((u.push(r), t == i.openStart)) break;
                e = r.content;
              }
              for (let e = h - 1; e >= 0; e--) {
                var p;
                let t = u[e],
                  r = (p = t.type).spec.defining || p.spec.definingForContent;
                if (r && !t.sameMarkup(o.node(Math.abs(l) - 1))) h = e;
                else if (r || !t.type.isTextblock) break;
              }
              for (let t = i.openStart; t >= 0; t--) {
                let l = (t + h + 1) % (i.openStart + 1),
                  p = u[l];
                if (p)
                        ...
                        new n.p2(
                          (function e(t, r, i, o, s) {
                            if (r < i) {
                              ...
                              t = t.replaceChild(
                                0,
                                n.copy(e(n.content, r + 1, i, o, n))
                              );
                            }
                            if (r > o) {
                              let e = s.contentMatchAt(0),
                                r = e.fillBefore(t).append(t);
                              t = r.append(
                                e.matchFragment(r).fillBefore(n.HY.empty, !0)
                              );
                            }
                            return t;
              ...
              for (
                let n = a.length - 1;
                n >= 0 && (e.replace(t, r, i), !(e.steps.length > d));
                n--
              ) {
                let e = a[n];
                e < 0 || ((t = o.before(e)), (r = s.after(e)));
              }
            })(this, e, t, r),
            this
          );
                ...
                let n = (function (e, t, r) {
                  ...
                  if (0 == n.parentOffset)
                    for (let e = n.depth - 1; e >= 0; e--) {
                      let t = n.index(e);
                      if (n.node(e).canReplaceWith(t, t, r))
                        return n.before(e + 1);
                      if (t > 0) return null;
                    }
                  if (n.parentOffset == n.parent.content.size)
                    for (let e = n.depth - 1; e >= 0; e--) {
                      ...
                      if (n.node(e).canReplaceWith(t, t, r))
                        return n.after(e + 1);
                      if (t < n.node(e).childCount) break;
                    }
                  return null;
                })(e.doc, t, i.type);
                null != n && (t = r = n);
              }
              e.replaceRange(t, r, new n.p2(n.HY.from(i), 0, 0));
            })(this, e, t, r),
            this
          );
        }
          ...
          return (
            !(function (e, t, r) {
              ...
              for (let t = 0; t < o.length; t++) {
                let r = o[t],
                  s = t == o.length - 1;
                if ((s && 0 == r) || n.node(r).type.contentMatch.validEnd)
                  return e.delete(n.start(r), i.end(r));
                if (
                  r > 0 &&
                  (s ||
                    n
                      .node(r - 1)
                      .canReplace(n.index(r - 1), i.indexAfter(r - 1)))
                )
                  return e.delete(n.before(r), i.after(r));
              }
              for (let o = 1; o <= n.depth && o <= i.depth; o++)
                if (
                  t - n.start(o) == n.depth - o &&
                  r > n.end(o) &&
                  i.end(o) - r != i.depth - o
                )
                  return e.delete(n.before(o), r);
              e.delete(t, r);
            })(this, e, t),
            this
          );
          ...
          return (
            !(function (e, t, r) {
              let { $from: i, $to: o, depth: s } = t,
                ...
                h = n.HY.empty,
                p = 0;
              for (let e = s, t = !1; e > r; e--)
                t || i.index(e) > 0
                  ? ((t = !0), (h = n.HY.from(i.node(e).copy(h))), p++)
                  : c--;
              let d = n.HY.empty,
                f = 0;
              for (let e = s, t = !1; e > r; e--)
                t || o.after(e + 1) < o.end(e)
                  ? ((t = !0), (d = n.HY.from(o.node(e).copy(d))), f++)
                  : u++;
              e.step(
                new g(c, u, a, l, new n.p2(h.append(d), p, f), h.size - p, !0)
              );
            })(this, e, t),
            this
          );
        ...
        join(e, t = 1) {
          return (
            !(function (e, t, r) {
              let i = new m(t - r, t + r, n.p2.empty, !0);
              e.step(i);
            })(this, e, t),
            this
          );
          ...
          return (
            !(function (e, t, r) {
              ...
              for (let e = r.length - 1; e >= 0; e--) {
                if (i.size) {
                  let t = r[e].type.contentMatch.matchFragment(i);
                  if (!t || !t.validEnd)
                    throw RangeError(
                      "Wrapper type given to Transform.wrap does not form valid content of its parent wrapper"
                    );
                }
                i = n.HY.from(r[e].type.create(r[e].attrs, i));
              }
              let o = t.start,
                s = t.end;
              e.step(new g(o, s, o, s, new n.p2(i, 0, 0), r.length, !0));
            })(this, e, t),
            this
          );
        }
            ...
            !(function (e, t, r, i, o) {
              ...
              e.doc.nodesBetween(t, r, (t, r) => {
                ...
                if (
                  ...
                  !t.hasMarkup(i, o) &&
                  ((a = e.doc),
                  (l = e.mapping.slice(s).map(r)),
                  (u = (c = a.resolve(l)).index()),
                  c.parent.canReplaceWith(u, u + 1, i))
                ) {
                  e.clearIncompatible(e.mapping.slice(s).map(r, 1), i);
                  let a = e.mapping.slice(s),
                    l = a.map(r, 1),
                    c = a.map(r + t.nodeSize, 1);
                  return (
                    e.step(
                      new g(
                        l,
                        ...
                        l + 1,
                        c - 1,
                        new n.p2(n.HY.from(i.create(o, null, t.marks)), 0, 0),
                        1,
                        !0
                      )
                    ),
        ...
        setNodeMarkup(e, t, r = null, i) {
          return (
            !(function (e, t, r, i, o) {
              ...
              r || (r = s.type);
              let a = r.create(i, null, o || s.marks);
              if (s.isLeaf) return e.replaceWith(t, t + s.nodeSize, a);
              if (!r.validContent(s.content))
                throw RangeError("Invalid content for node type " + r.name);
              e.step(
                new g(
                  t,
                  t + s.nodeSize,
        ...
        removeNodeMark(e, t) {
          if (!(t instanceof n.vc)) {
            let r = this.doc.nodeAt(e);
            if (!r) throw RangeError("No node at position " + e);
            if (!(t = t.isInSet(r.marks))) return this;
          }
          ...
          return (
            !(function (e, t, r = 1, i) {
              let o = e.doc.resolve(t),
                ...
                a = n.HY.empty;
              for (
                let e = o.depth, t = o.depth - r, l = r - 1;
                e > t;
                e--, l--
              ) {
                s = n.HY.from(o.node(e).copy(s));
                let t = i && i[l];
                a = n.HY.from(
                  t ? t.type.create(t.attrs, a) : o.node(e).copy(a)
                );
              }
              e.step(new m(t, t, new n.p2(s.append(a), r, r), !0));
            })(this, e, t, r),
            this
          );
        }
        addMark(e, t, r) {
          ...
          return (
            ...
            (s = []),
            (a = []),
            n.doc.nodesBetween(e, t, (n, l, c) => {
              if (!n.isInline) return;
              let u = n.marks;
              if (!r.isInSet(u) && c.type.allowsMarkType(r.type)) {
                let c = Math.max(l, e),
                  d = Math.min(l + n.nodeSize, t),
                  f = r.addToSet(u);
                for (let e = 0; e < u.length; e++)
                  u[e].isInSet(f) ||
                    (i && i.to == c && i.mark.eq(u[e])
                      ? (i.to = d)
                      : s.push((i = new p(c, d, u[e]))));
                o && o.to == c ? (o.to = d) : a.push((o = new h(c, d, r)));
              }
            }),
            s.forEach((e) => n.step(e)),
            a.forEach((e) => n.step(e)),
            this
          );
        }
        removeMark(e, t, r) {
          ...
          return (
            ...
            i.doc.nodesBetween(e, t, (i, a) => {
              ...
              s++;
              let l = null;
              if (r instanceof n.ZU) {
                let e = i.marks,
                  t;
                for (; (t = r.isInSet(e)); )
                  (l || (l = [])).push(t), (e = t.removeFromSet(e));
              } else r ? r.isInSet(i.marks) && (l = [r]) : (l = i.marks);
              if (l && l.length) {
                let r = Math.min(a + i.nodeSize, t);
                for (let t = 0; t < l.length; t++) {
                  let n = l[t],
                    i;
                  for (let e = 0; e < o.length; e++) {
                    let t = o[e];
                    t.step == s - 1 && n.eq(o[e].style) && (i = t);
                  }
                  i
                    ? ((i.to = r), (i.step = s))
                    : o.push({
            ...
            o.forEach((e) => i.step(new p(e.from, e.to, e.style))),
            this
          );
        }
        clearIncompatible(e, t, r) {
          return (
            !(function (e, t, r, i = r.contentMatch) {
              ...
              for (let t = 0; t < o.childCount; t++) {
                ...
                if (u) {
                  ...
                  for (let t = 0; t < l.marks.length; t++)
                    r.allowsMarkType(l.marks[t].type) ||
                      e.step(new p(a, c, l.marks[t]));
                  if (l.isText && !r.spec.code) {
                    let e,
                      t = /\r?\n|\r/g,
                      i;
                    for (; (e = t.exec(l.text)); )
                      i ||
                        (i = new n.p2(
                          n.HY.from(
                            r.schema.text(" ", r.allowedMarks(l.marks))
                          ),
                          0,
                          0
                        )),
                        s.push(
                          new m(a + e.index, a + e.index + e[0].length, i)
                        );
                  }
                } else s.push(new m(a, c, n.p2.empty));
                a = c;
              }
              if (!i.validEnd) {
                let t = i.fillBefore(n.HY.empty, !0);
                e.replace(a, a, new n.p2(t, 0, 0));
              }
...
//# sourceMappingURL=9923.43491b4f823b2efd.js.map
